...
export class AthenaView extends Construct {
  constructor(scope: Construct, id: string, props: AthenaViewProps) {
    ...
    const iamResources = [
      cdk.Arn.format(
        { service: "athena", resource: "workgroup", resourceName: "*" },
        cdk.Stack.of(this),
      ),
      cdk.Arn.format(
        { service: "glue", resource: "catalog" },
        cdk.Stack.of(this),
      ),
      cdk.Arn.format(
        {
      ...
      cdk.Arn.format(
        { service: "glue", resource: "table", resourceName: viewName },
        cdk.Stack.of(this),
      ),
    ];
    ...
    tables.forEach((table) =>
      iamResources.push(
        cdk.Arn.format(
          { service: "glue", resource: "table", resourceName: table },
          cdk.Stack.of(this),
        ),
      ),
    );
