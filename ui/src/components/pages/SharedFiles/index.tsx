  ...
  const columnDefinitions = [
    {
      cell: (file: SharedFile) => {
        const handleDownloadClick = async (
          event: CustomEvent<{ href: string | undefined }>
        ) => {
          try {
            ...
            // const downloadUrl = `/download/${file.fileId}?lat=${position.coords.latitude}&lng=${position.coords.longitude}`;
