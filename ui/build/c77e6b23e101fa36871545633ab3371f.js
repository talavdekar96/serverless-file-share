ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./html").Mode,
        a = e("./soy_template_highlight_rules").SoyTemplateHighlightRules,
        i = function () {
          r.call(this), (this.HighlightRules = a);
        };
      o.inherits(i, r),
        function () {
          (this.lineCommentStart = "//"),
  ...
  ace.require(["ace/mode/soy_template"], function (e) {
