ace.define(
  ...
  function (e, t, o) {
    ...
    i.inherits(n, r),
      (n.getTagRule = function (e) {
        return {
          token: "comment.doc.tag.storage.type",
          regex: "\\b(?:TODO|FIXME|XXX|HACK)\\b",
        };
      }),
      (n.getStartRule = function (e) {
        return { token: "comment.doc", regex: "\\/\\*(?=\\*)", next: e };
      }),
      (n.getEndRule = function (e) {
        return { token: "comment.doc", regex: "\\*\\/", next: e };
      }),
      (t.DocCommentHighlightRules = n);
  }
),
  ace.define(
    ...
    function (e, t, o) {
          ...
          var e = this.createKeywordMapper(
            {
              ...
              "constant.numeric": "One|Ones|Zero",
              "keyword.operator":
              ...
              "invalid.deprecated": "Memory24|Processor",
            },
            "identifier"
          );
          (this.$rules = {
      ...
      i.inherits(a, n), (t.ASLHighlightRules = a);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, o) {
      ...
      var i = e("../lib/oop"),
        r = e("./text").Mode,
        n = e("./asl_highlight_rules").ASLHighlightRules,
  ...
  ace.require(["ace/mode/asl"], function (e) {
