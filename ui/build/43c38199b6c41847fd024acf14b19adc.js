ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      i.inherits(a, o), (t.CSharpHighlightRules = a);
    }
  ),
  ace.define(
      ...
      i.inherits(a, o),
        function () {
          (this.usingRe = /^\s*using \S/),
            ...
            (this.getFoldWidget = function (e, t, n) {
              var i = this.getFoldWidgetBase(e, t, n);
              if (!i) {
                var r = e.getLine(n);
                if (/^\s*#region\b/.test(r)) return "start";
                var o = this.usingRe;
                if (o.test(r)) {
                  var a = e.getLine(n - 1),
                    s = e.getLine(n + 1);
                  if (!o.test(a) && o.test(s)) return "start";
                }
              }
              return i;
            }),
            (this.getFoldWidgetRange = function (e, t, n) {
              var i = this.getFoldWidgetRangeBase(e, t, n);
              if (i) return i;
              var r = e.getLine(n);
              return this.usingRe.test(r)
                ? this.getUsingStatementBlock(e, r, n)
                : /^\s*#region\b/.test(r)
                ? this.getRegionBlock(e, r, n)
                : void 0;
            }),
            (this.getUsingStatementBlock = function (e, t, n) {
              for (
                var i = t.match(this.usingRe)[0].length - 1,
                  o = e.getLength(),
                  a = n,
                  s = n;
                ++n < o;
                ...
                if (((t = e.getLine(n)), !/^\s*$/.test(t))) {
                  if (!this.usingRe.test(t)) break;
                  s = n;
                }
              if (s > a) {
                var g = e.getLine(s).length;
                return new r(a, i, s, g);
              }
            }),
  ...
  ace.require(["ace/mode/csharp"], function (e) {
