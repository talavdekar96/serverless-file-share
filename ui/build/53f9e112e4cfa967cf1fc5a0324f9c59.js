ace.define(
    ...
    function (e, t, n) {
        ...
        i = function () {
          this.$rules = {
            start: [
              ...
              {
                token: "keyword.operator",
                regex: "\\b(?:gt|gte|lt|lte|as|in|using)\\b",
              },
              {
      ...
      var s = function () {
        ...
        this.embedRules(
          ...
          this.addRules({
            "ftl-dcomment": [
              { token: "comment", regex: "--\x3e", next: "pop" },
              { defaultToken: "comment" },
            ],
          }),
          this.normalizeRules();
      };
      r.inherits(s, o), (t.FtlHighlightRules = s);
    }
  ),
  ace.define(
    "ace/mode/ftl",
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./ftl_highlight_rules").FtlHighlightRules,
        i = function () {
  ...
  ace.require(["ace/mode/ftl"], function (e) {
