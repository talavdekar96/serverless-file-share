ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var o = e("../lib/oop"),
        r = e("../mode/html_highlight_rules").HtmlHighlightRules;
      function a(e) {
        return {
          token: e.token + ".start",
          regex: e.start,
      ...
      o.inherits(i, r), (t.VisualforceHighlightRules = i);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./html").Mode,
        a = e("./visualforce_highlight_rules").VisualforceHighlightRules,
        i = e("./behaviour/xml").XmlBehaviour,
        s = e("./folding/html").FoldMode;
      function l() {
        r.call(this),
          (this.HighlightRules = a),
      ...
      o.inherits(l, r),
        (l.prototype.emmetConfig = { profile: "xhtml" }),
        (t.Mode = l);
    }
  ),
  ace.require(["ace/mode/visualforce"], function (e) {
