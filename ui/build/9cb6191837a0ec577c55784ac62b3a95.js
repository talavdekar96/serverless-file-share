ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, i, n) {
              ...
              if (this.startRegionRe.test(s))
                return this.getCommentRegionBlock(e, s, i);
              if ((o = s.match(this.foldingStartMarker))) {
                var r = o.index;
                if (o[1]) return this.openingBracketBlock(e, o[1], i, r);
                var a = e.getCommentFoldRange(i, r + o[0].length, 1);
                return (
                  a &&
                    !a.isMultiLine() &&
                    (n
              ...
              if ("markbegin" !== t && (o = s.match(this.foldingStopMarker))) {
                r = o.index + o[0].length;
                return o[1]
                  ? this.closingBracketBlock(e, o[1], i, r)
            ...
            (this.getSectionRange = function (e, t) {
              for (
                ...
                if (-1 !== g) {
                  if (n > g) break;
                  var m = this.getFoldWidgetRange(e, "all", t);
                  if (m) {
                    if (m.start.row <= s) break;
                    if (m.isMultiLine()) t = m.end.row;
                    else if (n == g) break;
                  }
                  a = t;
                }
              }
              return new o(s, r, a, e.getLine(a).length);
            }),
            (this.getCommentRegionBlock = function (e, t, i) {
              ...
              if (i > r) return new o(r, n, i, t.length);
            });
        }.call(r.prototype);
    }
  ),
  ...
  ace.require(["ace/mode/mips"], function (e) {
