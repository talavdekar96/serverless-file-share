ace.define(
  ...
  ace.define(
    ...
    function (o, c, n) {
      (c.isDark = !0),
        (c.cssClass = "ace-cloud9-night-low-color"),
        (c.cssText = o("./cloud9_night_low_color-css")),
        o("../lib/dom").importCssString(c.cssText, c.cssClass);
    }
  ),
  ace.require(["ace/theme/cloud9_night_low_color"], function (o) {
