ace.define(
        ...
        function () {
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              return !o && this.startRegionRe.test(a) ? "start" : o;
            }),
            (this.getFoldWidgetRange = function (e, t, n, a) {
              var o,
                i = e.getLine(n);
              ...
              if ((o = i.match(this.foldingStartMarker))) {
                var r = o.index;
                if (o[1]) return this.openingBracketBlock(e, o[1], n, r);
                var s = e.getCommentFoldRange(n, r + o[0].length, 1);
                return (
                  s &&
                    !s.isMultiLine() &&
                    (a
              ...
              if ("markbegin" !== t && (o = i.match(this.foldingStopMarker))) {
                ...
                return o[1]
                  ? this.closingBracketBlock(e, o[1], n, r)
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new o(i, r, s, e.getLine(s).length);
            }),
            (this.getCommentRegionBlock = function (e, t, n) {
              ...
              if (n > r) return new o(r, a, n, t.length);
            });
        }.call(r.prototype);
    }
  ),
      ...
      (function () {
        (this.checkOutdent = function (e, t) {
          ...
          (this.autoOutdent = function (e, t) {
            ...
            var r = this.$getIndent(e.getLine(i.row));
            e.replace(new a(t, 0, t, o - 1), r);
          }),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var a = e("../lib/oop"),
        o = e("./text").Mode,
        i = e("./vala_highlight_rules").ValaHighlightRules,
          ...
          (this.lineCommentStart = "//"),
            ...
            (this.getNextLineIndent = function (e, t, n) {
              var a = this.$getIndent(t),
                ...
                i = o.tokens,
                r = o.state;
              if (i.length && "comment" == i[i.length - 1].type) return a;
              if ("start" == e || "no_regex" == e)
                (s = t.match(/^.*(?:\bcase\b.*:|[\{\(\[])\s*$/)) && (a += n);
              else if ("doc-start" == e) {
  ...
  ace.require(["ace/mode/vala"], function (e) {
