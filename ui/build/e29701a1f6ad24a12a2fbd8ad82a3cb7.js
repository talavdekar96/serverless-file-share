ace.define(
    ...
    var o = e("../lib/oop"),
      ...
      r = function () {
        ...
        for (var o in this.$rules)
          for (var i = this.$rules[o], r = i.length; r--; ) {
            var l = i[r];
            if (l.include || "string" == typeof l) {
              var a = [r, 1].concat(this.$rules[l.include || l]);
              l.noEscape &&
                (a = a.filter(function (e) {
                  return !e.next;
                })),
                i.splice.apply(i, a);
            } else l.token in n && (l.token = n[l.token]);
          }
      };
    o.inherits(r, i), (t.AsciidocHighlightRules = r);
  }
),
  ace.define(
          ...
          (this.foldingStartMarker =
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              return this.foldingStartMarker.test(o)
                ? "=" == o[0]
                  ? this.singleLineHeadingRe.test(o)
                    ? "start"
                    : e.getLine(n - 1).length != e.getLine(n).length
                    ? ""
                    : "start"
                  : "dissallowDelimitedBlock" == e.bgTokenizer.getState(n)
                  ? "end"
                  : "start"
                : "";
            }),
            (this.getFoldWidgetRange = function (e, t, n) {
              ...
              if (o.match(this.foldingStartMarker)) {
                var g,
                  c = ["=", "-", "~", "^", "+"],
                  k = "markup.heading",
                  d = this.singleLineHeadingRe;
                if (h(n) == k) {
                  for (var x = m(); ++n < l; ) {
                    if (h(n) == k) if (m() <= x) break;
                  }
                  if (
                    (s =
                      g && g.value.match(this.singleLineHeadingRe)
                        ? n - 1
                        : n - 2) > a
                  )
                    for (; s > a && (!h(s) || "[" == g.value[0]); ) s--;
                  if (s > a) {
                    var u = e.getLine(s).length;
                    return new r(a, i, s, u);
                  }
                } else {
                  if ("dissallowDelimitedBlock" == e.bgTokenizer.getState(n)) {
                    for (
                      ;
                      n-- > 0 &&
                      -1 != e.bgTokenizer.getState(n).lastIndexOf("Block");

                    );
                    if ((s = n + 1) < a) {
                      u = e.getLine(n).length;
                      return new r(s, 5, a, i - 5);
                    }
                  } else {
                    for (
                      ;
              ...
              function m() {
                var t = g.value.match(d);
                if (t) return t[0].length;
                var o = c.indexOf(g.value[0]) + 1;
                return 1 == o && e.getLine(n - 1).length != e.getLine(n).length
                  ? 1 / 0
                  : o;
              }
            });
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        i = e("./text").Mode,
        r = e("./asciidoc_highlight_rules").AsciidocHighlightRules,
        l = e("./folding/asciidoc").FoldMode,
        a = function () {
          (this.HighlightRules = r), (this.foldingRules = new l());
        };
      o.inherits(a, i),
        function () {
          (this.type = "text"),
  ...
  ace.require(["ace/mode/asciidoc"], function (e) {
