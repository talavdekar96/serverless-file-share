ace.define(
  ...
  function (e, t, o) {
    ...
    i.inherits(n, r), (t.PowershellHighlightRules = n);
  }
),
  ace.define(
      ...
      (function () {
        (this.checkOutdent = function (e, t) {
          ...
          (this.autoOutdent = function (e, t) {
            ...
            if (!o) return 0;
            var r = o[1].length,
              n = e.findMatchingBracket({ row: t, column: r });
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, t, o) {
              ...
              if (
                ...
                return "";
              var r = this._getFoldWidgetBase(e, t, o);
            ...
            (this.getFoldWidgetRange = function (e, t, o, i) {
              ...
              if ((r = n.match(this.foldingStartMarker))) {
                var a = r.index;
              ...
              if ("markbegin" !== t && (r = n.match(this.foldingStopMarker))) {
                a = r.index + r[0].length;
                return r[1]
                  ? this.closingBracketBlock(e, r[1], o, a)
            ...
            (this.getSectionRange = function (e, t) {
              for (
                ...
                var l = (o = e.getLine(t)).search(/\S/);
                if (-1 !== l) {
                  if (i > l) break;
                  var S = this.getFoldWidgetRange(e, "all", t);
                  if (S) {
                    if (S.start.row <= n) break;
                    if (S.isMultiLine()) t = S.end.row;
                    else if (i == l) break;
                  }
                  s = t;
                }
              }
              return new r(n, a, s, e.getLine(s).length);
            }),
            (this.getCommentRegionBlock = function (e, t, o) {
              ...
              if (o > a) return new r(a, i, o, t.length);
            });
        }.call(a.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, o) {
      ...
      var i = e("../lib/oop"),
        r = e("./text").Mode,
        n = e("./powershell_highlight_rules").PowershellHighlightRules,
  ...
  ace.require(["ace/mode/powershell"], function (e) {
