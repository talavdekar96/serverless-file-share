ace.define(
    ...
    r.inherits(a, o),
      function () {
        (this.pushRule = function (e) {
          ...
          return {
            regex: e.regex,
            onMatch: function (t, n, r, o) {
              if ((0 === r.length && r.push(n), Array.isArray(e.next)))
                for (var a = 0; a < e.next.length; a++) r.push(e.next[a]);
              else r.push(e.next);
      ...
      (t.CsoundPreprocessorHighlightRules = a);
  }
),
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(a, o), (t.CsoundScoreHighlightRules = a);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(a, o), (t.LuaHighlightRules = a);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
        ...
        a = function () {
          ...
          (this.$rules = {
            start: [
              ...
              { token: "string", regex: o + '"{3}', next: "rfqqstring3" },
              { token: "string", regex: o + '"(?=.)', next: "rfqqstring" },
              { token: "string", regex: o + "'{3}", next: "rfqstring3" },
              { token: "string", regex: o + "'(?=.)", next: "rfqstring" },
              {
                token: "keyword.operator",
                regex:
                  "\\+|\\-|\\*|\\*\\*|\\/|\\/\\/|%|@|<<|>>|&|\\||\\^|~|<|>|<=|=>|==|!=|<>|=",
            ...
            constants: [
              { token: "constant.numeric", regex: "(?:" + l + "|\\d+)[jJ]\\b" },
              { token: "constant.numeric", regex: l },
              { token: "constant.numeric", regex: a + "[lL]\\b" },
      ...
      r.inherits(a, o), (t.PythonHighlightRules = a);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/lang"),
        ...
        l = e("./python_highlight_rules").PythonHighlightRules,
        c = function (e) {
          a.call(this, e);
          var t = [
              "ATSadd",
          ...
          o.splice(1, 0, {
            ...
            o.push(
              ...
              { token: "support.variable.csound", regex: /\bp\d+\b/ },
              {
                ...
                onMatch: function (e, r, o, a) {
                  var i,
                    s = e.split(this.splitRegex),
                    l = s[1];
                  return (
                    t.hasOwnProperty(l)
                      ? (i = "support.function.csound")
                      : n.hasOwnProperty(l) &&
                        (i = "invalid.deprecated.csound"),
                    i
                      ? s[2]
                        ? [
                            { type: i, value: l },
          ...
          this.addRules({
            ...
            "Csound score opcode": [
              this.comments,
              {
                token: "punctuation.definition.string.begin.csound",
                regex: /{{/,
                next: c.embeddedRulePrefix + "start",
              },
              this.popRule({ token: "empty", regex: /$/ }),
            ],
            "Python opcode": [
          ...
          this.embedRules(c.getRules(), c.embeddedRulePrefix, u),
            this.embedRules(l, "python-", u),
            this.embedRules(s, "lua-", u),
            this.normalizeRules();
        };
      o.inherits(c, a), (t.CsoundOrchestraHighlightRules = c);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(g, o), (t.CssHighlightRules = g);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        a = e("./csound_score_highlight_rules").CsoundScoreHighlightRules,
        i = e("./html_highlight_rules").HtmlHighlightRules,
        s = e("./text_highlight_rules").TextHighlightRules,
        l = function () {
          var e = new o("csound-"),
            t = new a("csound-score-");
          (this.$rules = {
            start: [
              {
                token: [
      ...
      r.inherits(l, s), (t.CsoundDocumentHighlightRules = l);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./csound_document_highlight_rules").CsoundDocumentHighlightRules,
        i = function () {
  ...
  ace.require(["ace/mode/csound_document"], function (e) {
