ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      o.inherits(i, r),
        ...
        (t.JsDocCommentHighlightRules = i);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      o.inherits(s, i), (t.JavaScriptHighlightRules = s);
    }
  ),
  ace.define(
      ...
      var o = e("../lib/oop"),
        ...
        c = function e() {
          s.call(this),
            ...
            this.embedTagRules(i, "css-", "style"),
            this.embedTagRules(new a({ jsx: !1 }).getRules(), "js-", "script"),
            this.constructor === e && this.normalizeRules();
        };
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        ...
        i = e("./elixir_highlight_rules").ElixirHighlightRules,
        a = function () {
          r.call(this);
          var e = [
      ...
      o.inherits(a, r), (t.HtmlElixirHighlightRules = a);
    }
  ),
  ace.define(
      ...
      (function () {
        (this.completionsDefined = !1),
          ...
          (this.getCompletions = function (e, t, n, o) {
            if (
              ...
              var r = t.getLine(n.row).substr(0, n.column),
                i = /\([^)]*$/.test(r);
              return (
                i && (r = r.substr(r.lastIndexOf("(") + 1)),
                /:[^;]+$/.test(r)
                  ? (/([\w\-]+):[^:]*$/.test(r),
                    this.getPropertyValueCompletions(e, t, n, o))
                  : this.getPropertyCompletions(e, t, n, o, i)
              );
            }
            return [];
          }),
          (this.getPropertyCompletions = function (e, t, n, r, i) {
            return (
              (i = i || !1),
          ...
          (this.getPropertyValueCompletions = function (e, t, n, r) {
            ...
            var s = [];
            return (
              a in o && "object" === typeof o[a] && (s = Object.keys(o[a])),
              s.map(function (e) {
                return {
                  caption: e,
                  snippet: e,
          ...
          this.inherit(r),
            ...
            this.add("semicolon", "insertion", function (e, t, n, o, r) {
              if (";" === r && n.selection.isEmpty()) {
                ...
                if (
                  ";" === o.doc.getLine(i.row).substring(i.column, i.column + 1)
                )
                  return { text: "", selection: [1, 1] };
              }
            }),
            this.add("!important", "insertion", function (e, t, n, o, r) {
              if ("!" === r && n.selection.isEmpty()) {
                var i = n.getCursorPosition(),
                  a = o.doc.getLine(i.row);
                if (/^\s*(;|}|$)/.test(a.substring(i.column)))
                  return { text: "!important", selection: [10, 10] };
              }
            });
        };
      o.inherits(a, r), (t.CssBehaviour = a);
    }
  ),
  ace.define(
    "ace/mode/css",
        ...
        this.add("string_dquotes", "insertion", function (e, t, n, o, r) {
          if ('"' == r || "'" == r) {
            ...
            var c = n.getCursorPosition(),
              ...
              d = new i(o, c.row, c.column),
              g = d.getCurrentToken();
            if (u == s && (a(g, "attribute-value") || a(g, "string")))
              return { text: "", selection: [1, 1] };
            if ((g || (g = d.stepBackward()), !g)) return;
            for (; a(g, "tag-whitespace") || a(g, "whitespace"); )
              g = d.stepBackward();
            var p = !u || u.match(/\s/);
            if (
              (a(g, "attribute-equals") && (p || ">" == u)) ||
              (a(g, "decl-attribute-equals") && (p || "?" == u))
            )
          ...
          this.add("string_dquotes", "deletion", function (e, t, n, o, r) {
            ...
            if (
              ...
              o.doc
                .getLine(r.start.row)
                .substring(r.start.column + 1, r.start.column + 2) == i
            )
              return r.end.column++, r;
          }),
          this.add("autoclosing", "insertion", function (e, t, n, o, r) {
            if (">" == r) {
              ...
              if (a(c, "attribute-value")) {
                ...
                if (s.column == u) {
                  var d = l.stepForward();
                  if (d && a(d, "attribute-value")) return;
                  l.stepBackward();
                }
              }
        ...
        (this.getFoldWidget = function (e, t, n) {
          ...
          (this._getFirstTagInLine = function (e, t) {
            for (
              ...
              if (l(i, "tag-open")) {
                if (
                  ((o.end.column = o.start.column + i.value.length),
                  (o.closing = l(i, "end-tag-open")),
                  !(i = n[++r]))
                )
                  return null;
                for (
                  o.tagName = i.value, o.end.column += i.value.length, r++;
                  r < n.length;
                  r++
                )
                  if (
                    ((i = n[r]),
                    (o.end.column += i.value.length),
                    l(i, "tag-close"))
                  ) {
                    o.selfClosing = "/>" == i.value;
                    break;
                  }
                return o;
              }
              if (l(i, "tag-close"))
                return (o.selfClosing = "/>" == i.value), o;
              o.start.column += i.value.length;
            }
            return null;
          }),
          (this._findEndTagInLine = function (e, t, n, o) {
            for (var r = e.getTokens(t), i = 0, a = 0; a < r.length; a++) {
              var s = r[a];
              if (
                !((i += s.value.length) < o) &&
                l(s, "end-tag-open") &&
    ...
    function (e, t, n) {
      ...
      var o = e("../../lib/oop"),
        ...
        s = (t.FoldMode = function (e, t) {
          r.call(this, new i(e, t), { "js-": new a(), "css-": new a() });
        });
      o.inherits(s, r);
    }
  ),
      ...
      (function () {
        (this.getCompletions = function (e, t, n, o) {
          ...
          (this.getAttributeCompletions = function (e, t, n, o) {
            ...
            var s = r;
            return (
              a in i && (s = s.concat(Object.keys(i[a]))),
              s.map(function (e) {
                return {
                  caption: e,
                  snippet: e + '="$0"',
      ...
      var o = e("../lib/oop"),
        ...
        h = function (e) {
          (this.fragmentContext = e && e.fragmentContext),
            ...
            this.createModeDelegates({ "js-": a, "css-": s }),
            (this.foldingRules = new u(this.voidElements, r.arrayToMap(m)));
        };
      o.inherits(h, i),
        function () {
      ...
      o.inherits(a, r),
        function () {
          (this.getFoldWidgetRange = function (e, t, n) {
            ...
            if (-1 != s && "#" == a[s]) {
              for (
                var l = a.length, c = e.getLength(), u = n, d = n;
                ++n < c;

              ) {
                var g = (a = e.getLine(n)).search(r);
                if (-1 != g) {
                  if ("#" != a[g]) break;
                  d = n;
                }
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              return (
                (e.foldWidgets[n - 1] = -1 != s && s < r ? "start" : ""),
                r < l ? "start" : ""
              );
            });
        }.call(a.prototype);
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var o = e("../lib/oop"),
        r = e("./html_elixir_highlight_rules").HtmlElixirHighlightRules,
        i = e("./html").Mode,
        a = e("./javascript").Mode,
        s = e("./css").Mode,
        l = e("./elixir").Mode,
        c = function () {
          i.call(this),
            ...
            this.createModeDelegates({ "js-": a, "css-": s, "elixir-": l });
        };
      o.inherits(c, i),
        function () {
  ...
  ace.require(["ace/mode/html_elixir"], function (e) {
