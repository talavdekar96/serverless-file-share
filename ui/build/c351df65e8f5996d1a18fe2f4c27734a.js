ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(m, o), (t.CssHighlightRules = m);
    }
  ),
  ace.define(
              ...
              if (c && -1 !== c.type.indexOf("tag-close")) {
                ...
                if (this.voidElements && !this.voidElements[u]) {
                  var d = r.getTokenAt(i.row, i.column + 1),
                    m = ((s = r.getLine(g)), this.$getIndent(s)),
                    p = m + r.getTabString();
                  return d && "</" === d.value
                    ? {
                        text: "\n" + p + "\n" + m,
      ...
      r.inherits(h, a),
        function () {
          (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
            (this.voidElements = o.arrayToMap(m)),
            (this.getNextLineIndent = function (e, t, n) {
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(a, o), (t.TexHighlightRules = a);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      var r = e("../lib/oop"),
        o = e("../lib/lang"),
        a = e("./text_highlight_rules").TextHighlightRules,
        i = e("./tex_highlight_rules").TexHighlightRules,
        s = function () {
          var e = o.arrayToMap(
          ...
          for (
            var n = new i("comment").getRules(), r = 0;
            r < n.start.length;
            r++
          )
      ...
      r.inherits(s, a), (t.RHighlightRules = s);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var r = e("../lib/oop"),
        o = e("./r_highlight_rules").RHighlightRules,
      ...
      r.inherits(s, i), (t.RHtmlHighlightRules = s);
    }
  ),
  ace.define(
    "ace/mode/rhtml",
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./html").Mode,
        a = e("./rhtml_highlight_rules").RHtmlHighlightRules,
        i = function (e, t) {
          o.call(this), (this.$session = t), (this.HighlightRules = a);
        };
      r.inherits(i, o),
        function () {
  ...
  ace.require(["ace/mode/rhtml"], function (e) {
