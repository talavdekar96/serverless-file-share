ace.define(
      ...
      o.inherits(a, r),
        function () {
          (this.getFoldWidgetRange = function (e, t, n) {
            ...
            if (-1 != s && "#" == a[s]) {
              for (
                var g = a.length, c = e.getLength(), l = n, u = n;
                ++n < c;

              ) {
                var d = (a = e.getLine(n)).search(r);
                if (-1 != d) {
                  if ("#" != a[d]) break;
                  u = n;
                }
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              if (-1 == r)
                return (
                  (e.foldWidgets[n - 1] = -1 != s && s < g ? "start" : ""), ""
                );
              if (-1 == s) {
                if (r == g && "#" == o[r] && "#" == i[r])
                  return (
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./text").Mode,
        i = e("./logiql_highlight_rules").LogiQLHighlightRules,
          ...
          (this.lineCommentStart = "//"),
            ...
            (this.getNextLineIndent = function (e, t, n) {
              var o = this.$getIndent(t),
                ...
                i = r.tokens,
                a = r.state;
              if (/comment|string/.test(a)) return o;
              if (i.length && "comment.single" == i[i.length - 1].type)
                return o;
              t.match();
            ...
            (this.autoOutdent = function (e, t, n) {
              if (!this.$outdent.autoOutdent(t, n)) {
                ...
                if (!r || !n || !i) return 0;
                t.getLine(n + 1);
                var a = this.getMatching(t, { row: n, column: i });
            ...
            (this.getMatching = function (e, t, n) {
              void 0 == t && (t = e.selection.lead),
                "object" == typeof t && ((n = t.column), (t = t.row));
              var o,
                r = e.getTokenAt(t, n),
                i = "keyword.start",
                a = "keyword.end";
              if (r) {
                if (r.type == i) {
                  (c = new s(e, t, n)).step = c.stepForward;
                } else {
                  if (r.type != a) return;
                  var c;
                  (c = new s(e, t, n)).step = c.stepBackward;
                }
                for (; (o = c.step()) && o.type != i && o.type != a; );
                if (o && o.type != r.type) {
                  var l = c.getCurrentTokenColumn();
                  t = c.getCurrentTokenRow();
                  return new g(t, l, t, l + o.value.length);
                }
              }
            }),
  ...
  ace.require(["ace/mode/logiql"], function (e) {
