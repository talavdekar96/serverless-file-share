ace.define(
  ...
  function (e, t, r) {
    "use strict";
    var o = e("../lib/oop"),
      n = (e("../lib/lang"), e("./text_highlight_rules").TextHighlightRules),
      i = (t.supportType =
    ...
    o.inherits(p, n), (t.CssHighlightRules = p);
  }
),
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../lib/oop"),
        ...
        s = function () {
          var e = n.arrayToMap(a.supportType.split("|")),
            t = n.arrayToMap(
            ...
            r = n.arrayToMap(a.supportConstant.split("|")),
            o = n.arrayToMap(a.supportConstantColor.split("|")),
            i = n.arrayToMap(
              ...
              },
              {
                token: function (n) {
                  return e.hasOwnProperty(n.toLowerCase())
                    ...
                    : t.hasOwnProperty(n)
                    ? "support.function"
                    : o.hasOwnProperty(n.toLowerCase())
                    ? "support.constant.color"
                    : s.hasOwnProperty(n.toLowerCase())
                    ? "variable.language"
                    : "text";
                },
                regex: "\\-?[@a-z_][@a-z0-9_\\-]*",
      ...
      o.inherits(s, i), (t.ScssHighlightRules = s);
    }
  ),
  ace.define(
      ...
      (function () {
        (this.checkOutdent = function (e, t) {
          ...
          (this.autoOutdent = function (e, t) {
            ...
            if (!r) return 0;
            var n = r[1].length,
              i = e.findMatchingBracket({ row: t, column: n });
            if (!i || i.row == t) return 0;
            var a = this.$getIndent(e.getLine(i.row));
            e.replace(new o(t, 0, t, n - 1), a);
          }),
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../../lib/oop"),
        ...
        a = function () {
          this.inherit(n),
            this.add("colon", "insertion", function (e, t, r, o, n) {
              if (":" === n && r.selection.isEmpty()) {
            ...
            this.add("colon", "deletion", function (e, t, r, o, n) {
              var a = o.doc.getTextRange(n);
              if (!n.isMultiLine() && ":" === a) {
                var s = r.getCursorPosition(),
                ...
                if (
                  ...
                  if (
                    ...
                    o.doc
                      .getLine(n.start.row)
                      .substring(n.end.column, n.end.column + 1)
                  )
                    return n.end.column++, n;
              }
            }),
            this.add("semicolon", "insertion", function (e, t, r, o, n) {
              if (";" === n && r.selection.isEmpty()) {
                var i = r.getCursorPosition();
                if (
            ...
            this.add("!important", "insertion", function (e, t, r, o, n) {
              if ("!" === n && r.selection.isEmpty()) {
                var i = r.getCursorPosition(),
      ...
      o.inherits(a, n), (t.CssBehaviour = a);
    }
  ),
  ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, r, o) {
              ...
              if ((n = i.match(this.foldingStartMarker))) {
                var a = n.index;
                if (n[1]) return this.openingBracketBlock(e, n[1], r, a);
                var s = e.getCommentFoldRange(r, a + n[0].length, 1);
                return (
                  s &&
                    !s.isMultiLine() &&
                    (o
              ...
              if ("markbegin" !== t && (n = i.match(this.foldingStopMarker))) {
                ...
                return n[1]
                  ? this.closingBracketBlock(e, n[1], r, a)
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new n(i, a, s, e.getLine(s).length);
            }),
            (this.getCommentRegionBlock = function (e, t, r) {
              ...
              if (r > a) return new n(a, o, r, t.length);
            });
        }.call(a.prototype);
    }
  ),
    ...
    function (e, t, r) {
      ...
      (function () {
        (this.completionsDefined = !1),
            ...
            if (document) {
              ...
              for (var t in e)
                if ("string" === typeof e[t]) {
                  ...
                  o.hasOwnProperty(r) || (o[r] = 1);
                }
            }
            this.completionsDefined = !0;
          }),
          (this.getCompletions = function (e, t, r, o) {
            if (
              (this.completionsDefined || this.defineCompletions(),
              "ruleset" === e || "ace/mode/scss" == t.$mode.$id)
            ) {
              var n = t.getLine(r.row).substr(0, r.column),
                i = /\([^)]*$/.test(n);
              return (
                i && (n = n.substr(n.lastIndexOf("(") + 1)),
                /:[^;]+$/.test(n)
                  ? (/([\w\-]+):[^:]*$/.test(n),
                    this.getPropertyValueCompletions(e, t, r, o))
                  : this.getPropertyCompletions(e, t, r, o, i)
              );
            }
            return [];
          }),
          (this.getPropertyCompletions = function (e, t, r, n, i) {
            return (
              (i = i || !1),
          ...
          (this.getPropertyValueCompletions = function (e, t, r, n) {
            var i = t.getLine(r.row).substr(0, r.column),
              a = (/([\w\-]+):[^:]*$/.exec(i) || {})[1];
            if (!a) return [];
            var s = [];
            return (
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../lib/oop"),
        n = e("./text").Mode,
        i = e("./scss_highlight_rules").ScssHighlightRules,
          ...
          (this.lineCommentStart = "//"),
            ...
            (this.getNextLineIndent = function (e, t, r) {
              var o = this.$getIndent(t),
                n = this.getTokenizer().getLineTokens(t, e).tokens;
              return (
                (n.length && "comment" == n[n.length - 1].type) ||
                  (t.match(/^.*\{\s*$/) && (o += r)),
                o
              );
            }),
            ...
            (this.getCompletions = function (e, t, r, o) {
              return this.$completer.getCompletions(e, t, r, o);
            }),
  ...
  ace.require(["ace/mode/scss"], function (e) {
