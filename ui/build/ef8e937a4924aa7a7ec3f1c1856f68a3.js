ace.define(
  ...
  function (e, t, o) {
    ...
    (a.metaData = {
      ...
      i.inherits(a, n),
      (t.ActionScriptHighlightRules = a);
  }
),
  ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, o, i) {
              ...
              if ((n = a.match(this.foldingStartMarker))) {
                var r = n.index;
                if (n[1]) return this.openingBracketBlock(e, n[1], o, r);
                var l = e.getCommentFoldRange(o, r + n[0].length, 1);
                return (
                  l &&
                    !l.isMultiLine() &&
                    (i
              ...
              if ("markbegin" !== t && (n = a.match(this.foldingStopMarker))) {
                ...
                return n[1]
                  ? this.closingBracketBlock(e, n[1], o, r)
                  : e.getCommentFoldRange(o, r, -1);
              }
            }),
            (this.getSectionRange = function (e, t) {
              ...
              return new n(a, r, l, e.getLine(l).length);
            }),
            (this.getCommentRegionBlock = function (e, t, o) {
              for (
                ...
                t = e.getLine(o);
                var d = l.exec(t);
                if (d && (d[1] ? s-- : s++, !s)) break;
              }
              if (o > r) return new n(r, i, o, t.length);
            });
        }.call(r.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, o) {
      ...
      var i = e("../lib/oop"),
        n = e("./text").Mode,
        a = e("./actionscript_highlight_rules").ActionScriptHighlightRules,
  ...
  ace.require(["ace/mode/actionscript"], function (e) {
