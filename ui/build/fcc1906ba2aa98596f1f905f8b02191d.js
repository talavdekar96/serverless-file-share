ace.define(
  ...
  function (e, t, n) {
        ...
        var e = this.createKeywordMapper(
          {
            ...
            "support.function": "empty|size|new",
          },
          "identifier"
        );
        (this.$rules = {
          start: [
            ...
            { token: ["comment", "text"], regex: "(#pragma)(\\s.*$)" },
            { token: "string", regex: '["](?:(?:\\\\.)|(?:[^"\\\\]))*?["]' },
            { token: "string", regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']" },
            {
              token: "string",
            ...
            { token: "constant.language.boolean", regex: "(?:true|false)\\b" },
            {
              ...
              push: [
                ...
                { token: "string.regexp", regex: "$|/", next: "pop" },
    ...
    o.inherits(r, i), (t.JexlHighlightRules = r);
  }
),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var o = e("../lib/oop"),
        i = e("./jexl_highlight_rules").JexlHighlightRules,
        r = e("./text").Mode,
  ...
  ace.require(["ace/mode/jexl"], function (e) {
