ace.define(
  ...
  ace.define(
    ...
    function (r, o, n) {
      (o.isDark = !0),
        (o.cssClass = "ace-tomorrow-night-bright"),
        (o.cssText = r("./tomorrow_night_bright-css")),
        r("../lib/dom").importCssString(o.cssText, o.cssClass, !1);
    }
  ),
  ace.require(["ace/theme/tomorrow_night_bright"], function (r) {
