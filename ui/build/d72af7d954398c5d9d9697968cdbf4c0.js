ace.define(
  ...
  function (e, t, r) {
      ...
      i = function () {
        ...
        this.$rules = {
          start: [
            ...
            { token: "constant.numeric", regex: t + "[lL]\\b" },
    ...
    o.inherits(i, a), (t.MushCodeRules = i);
  }
),
  ace.define(
      ...
      o.inherits(i, a),
        function () {
          this.getFoldWidgetRange = function (e, t, r) {
            var o = e.getLine(r).match(this.foldingStartMarker);
            if (o)
              return o[1]
                ? this.openingBracketBlock(e, o[1], r, o.index)
                : o[2]
                ? this.indentationBlock(e, r, o.index + o[2].length)
                : this.indentationBlock(e, r);
          };
        }.call(i.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../lib/oop"),
        a = e("./text").Mode,
        i = e("./mushcode_highlight_rules").MushCodeRules,
        n = e("./folding/pythonic").FoldMode,
        s = e("../range").Range,
        l = function () {
      ...
      o.inherits(l, a),
        function () {
          this.getNextLineIndent = function (e, t, r) {
            ...
            "start" == e && t.match(/^.*[\{\(\[:]\s*$/) && (o += r);
            return o;
          };
          var e = { pass: 1, return: 1, raise: 1, break: 1, continue: 1 };
          (this.checkOutdent = function (t, r, o) {
            if ("\r\n" !== o && "\r" !== o && "\n" !== o) return !1;
            var a = this.getTokenizer().getLineTokens(r.trim(), t).tokens;
            if (!a) return !1;
            do {
              var i = a.pop();
            } while (
              i &&
              ("comment" == i.type ||
                ("text" == i.type && i.value.match(/^\s+$/)))
            );
            return !!i && "keyword" == i.type && e[i.value];
          }),
            (this.autoOutdent = function (e, t, r) {
              r += 1;
              var o = this.$getIndent(t.getLine(r)),
                a = t.getTabString();
              o.slice(-a.length) == a &&
                t.remove(new s(r, o.length - a.length, r, o.length));
            }),
  ...
  ace.require(["ace/mode/mushcode"], function (e) {
