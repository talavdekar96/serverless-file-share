ace.define(
  ...
  ace.define(
    ...
    function (E, e, T) {
      "use strict";
      var R = E("../lib/oop"),
        t = E("./doc_comment_highlight_rules").DocCommentHighlightRules,
        ...
        S = function () {
          ...
          (A +=
            ...
            (A += "|LOOP|HASH|MERGE|REMOTE"),
            (A += "|TRY|CATCH|THROW"),
            (A = (A = (A = (A += "|TYPE").split("|")).filter(function (
              R,
              t,
              A
            ) {
          ...
          for (
            ...
            I.push("SET TRANSACTION ISOLATION LEVEL " + O[N]);
          this.$rules = {
            start: [
              {
                token: "string.start",
              ...
              { token: S, regex: "@{0,2}[a-zA-Z_$][a-zA-Z0-9_$]*\\b(?!])" },
              {
          ...
          for (N = 0; N < I.length; N++)
            this.$rules.start.unshift({ token: "set.statement", regex: I[N] });
          this.embedRules(t, "doc-", [t.getEndRule("start")]),
            this.normalizeRules();
          var _ = [],
            s = function (E, e) {
              E.forEach(function (E) {
                _.push({ name: E, value: E, score: 0, meta: e });
              });
            };
          s(R.split("|"), "procedure"),
            s(E.split("|"), "operator"),
        ...
        function () {
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (E, e, T, R) {
              ...
              if ((t = A.match(this.foldingStartMarker))) {
                var S = t.index;
                if (t[1]) return this.openingBracketBlock(E, t[1], T, S);
                var I = E.getCommentFoldRange(T, S + t[0].length, 1);
                return (
                  I &&
                    !I.isMultiLine() &&
                    (R
              ...
              if ("markbegin" !== e && (t = A.match(this.foldingStopMarker))) {
                S = t.index + t[0].length;
                return t[1]
                  ? this.closingBracketBlock(E, t[1], T, S)
                  : E.getCommentFoldRange(T, S, -1);
              }
            }),
            ...
            (this.getCommentRegionBlock = function (E, e, T) {
              ...
              if (T > S) return new t(S, R, T, e.length);
            });
        }.call(S.prototype);
    }
  ),
          ...
          (this.foldingStartMarker = /(\bCASE\b|\bBEGIN\b)|^\s*(\/\*)/i),
            ...
            (this.getFoldWidgetRange = function (E, e, T, R) {
              ...
              if (this.startRegionRe.test(t))
                return this.getCommentRegionBlock(E, t, T);
            ...
            (this.getBeginEndBlock = function (E, e, T, R) {
              for (
                var A,
                  S = { row: e, column: T + R.length },
                  I = E.getLength(),
                  O = 1,
                  N = /(\bCASE\b|\bBEGIN\b)|(\bEND\b)/i;
                ++e < I;
              ...
              if (e > S.row) return new t(S.row, S.column, e, A.length);
            });
        }.call(S.prototype);
    }
  ),
  ace.define(
    ...
    function (E, e, T) {
      ...
      var R = E("../lib/oop"),
        t = E("./text").Mode,
        A = E("./sqlserver_highlight_rules").SqlHighlightRules,
  ...
  ace.require(["ace/mode/sqlserver"], function (E) {
