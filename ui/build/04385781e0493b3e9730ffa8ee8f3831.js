ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
              ...
              },
              {
                token: function (i) {
                  return "this" == i
                    ...
                    : "function" == i
                    ? "storage.type"
                    : e.hasOwnProperty(i) || n.hasOwnProperty(i)
                    ? "keyword"
                    : t.hasOwnProperty(i)
                    ? "constant.language"
                    : /^_?[A-Z][a-zA-Z0-9_]*$/.test(i)
      ...
      i.inherits(s, a), (t.JsxHighlightRules = s);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var i = e("../lib/oop"),
        o = e("./text").Mode,
        r = e("./jsx_highlight_rules").JsxHighlightRules,
  ...
  ace.require(["ace/mode/jsx"], function (e) {
