ace.define(
  ...
  ace.define(
    ...
    function (e, t, r) {
      "use strict";
      var i = e("../lib/oop"),
        s = (e("../lib/lang"), e("./text_highlight_rules").TextHighlightRules),
        a = (t.supportType =
        ...
        n = (t.supportFunction = "rgb|rgba|url|attr|counter|counters"),
        o = (t.supportConstant =
      ...
      i.inherits(g, s), (t.CssHighlightRules = g);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, r) {
      "use strict";
      var i = e("../lib/oop"),
        s = e("./jsdoc_comment_highlight_rules").JsDocCommentHighlightRules,
        a = e("./text_highlight_rules").TextHighlightRules,
        n = "[a-zA-Z\\$_\xa1-\uffff][a-zA-Z\\d\\$_\xa1-\uffff]*",
        o = function (e) {
      ...
      function _() {
          ...
          t = {
            onMatch: function (e, t, r) {
              ...
              return (
                1 == i
                  ? (t != this.nextState
                      ? r.unshift(this.next, this.nextState, 0)
                      : r.unshift(this.next),
                    r[2]++)
                  : 2 == i &&
                    t == this.nextState &&
                    (r[1]--, (!r[1] || r[1] < 0) && (r.shift(), r.shift())),
                [
                  {
                    type:
        ...
        var r = { regex: "{", token: "paren.quasi.start", push: "start" };
        (this.$rules.jsx = [
          r,
          t,
          { include: "reference" },
          ...
          (this.$rules.jsxAttributes = [
            {
              ...
              onMatch: function (e, t, r) {
                return (
                  t == r[0] && r.shift(),
                  2 == e.length &&
                    (r[0] == this.nextState && r[1]--,
                    (!r[1] || r[1] < 0) && r.splice(0, 2)),
                  (this.next = r[0] || "start"),
      ...
      i.inherits(o, a), (t.JavaScriptHighlightRules = o);
    }
  ),
  ace.define(
    ...
    function (e, t, r) {
      ...
      var i = e("../lib/oop"),
        s = e("./text_highlight_rules").TextHighlightRules,
        a = function e(t) {
          var r = "[_:a-zA-Z\xc0-\uffff][-_:.a-zA-Z0-9\xc0-\uffff]*";
          (this.$rules = {
            start: [
              {
            ...
            attributes: [
              { token: "entity.other.attribute-name.xml", regex: r },
              { token: "keyword.operator.attribute-equals.xml", regex: "=" },
      ...
      (function () {
        this.embedTagRules = function (e, t, r) {
          this.$rules.tag.unshift({
            token: [
              "meta.tag.punctuation.tag-open.xml",
              "meta.tag." + r + ".tag-name.xml",
            ],
            regex: "(<)(" + r + "(?=\\s|>|$))",
            next: [
              { include: "attributes" },
      ...
      var i = e("../lib/oop"),
        ...
        l = function e() {
          o.call(this),
            ...
            this.embedTagRules(new n({ jsx: !1 }).getRules(), "js-", "script"),
            this.constructor === e && this.normalizeRules();
        };
      i.inherits(l, o), (t.HtmlHighlightRules = l);
    }
  ),
  ace.define(
    ...
    function (e, t, r) {
        ...
        _ = function () {
          var e = a,
            ...
            o =
              ...
              s.arrayToMap("cfunction|old_function".split("|")),
              s.arrayToMap([]));
          (this.$rules = {
            start: [
              { token: "comment", regex: /(?:#|\/\/)(?:[^?]|\?[^>])*/ },
      ...
      i.inherits(l, o),
        (t.PhpHighlightRules = l),
        (t.PhpLangHighlightRules = _);
    }
  ),
  ace.define(
    ...
    function (e, t, r) {
      ...
      i.inherits(a, s), (t.PHPLaravelBladeHighlightRules = a);
    }
  ),
  ace.define(
      ...
      (function () {
        (this.checkOutdent = function (e, t) {
          ...
          (this.autoOutdent = function (e, t) {
            ...
            var n = this.$getIndent(e.getLine(a.row));
            e.replace(new i(t, 0, t, s - 1), n);
          }),
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var a = function () {};
      (function () {
        (this.getCompletions = function (e, t, r, i) {
          var s = t.getTokenAt(r.row, r.column);
          if (!s) return [];
          if ("support.php_tag" === s.type && "<?" === s.value)
            return this.getTagCompletions(e, t, r, i);
          if ("identifier" === s.type) {
            if (s.index > 0)
              if ("support.php_tag" === t.getTokenAt(r.row, s.start).type)
                return this.getTagCompletions(e, t, r, i);
            return this.getFunctionCompletions(e, t, r, i);
          }
          if (
            (function (e, t) {
            ...
            return this.getVariableCompletions(e, t, r, i);
          var a = t.getLine(r.row).substr(0, r.column);
          return "string" === s.type && /(\$[\w]*)\[["']([^'"]*)$/i.test(a)
            ? this.getArrayKeyCompletions(e, t, r, i)
            : [];
        }),
          (this.getTagCompletions = function (e, t, r, i) {
            return [
              { caption: "php", value: "php", meta: "php tag", score: 1e6 },
              { caption: "=", value: "=", meta: "php tag", score: 1e6 },
            ];
          }),
          (this.getFunctionCompletions = function (e, t, r, s) {
          ...
          (this.getVariableCompletions = function (e, t, r, i) {
            return Object.keys(s).map(function (e) {
              return { caption: e, value: e, meta: "php variable", score: 1e6 };
            });
          }),
          (this.getArrayKeyCompletions = function (e, t, r, i) {
            var a = t
              .getLine(r.row)
              .substr(0, r.column)
              .match(/(\$[\w]*)\[["']([^'"]*)$/i)[1];
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, r, i) {
              ...
              if (this.startRegionRe.test(a))
                return this.getCommentRegionBlock(e, a, r);
              if ((s = a.match(this.foldingStartMarker))) {
                var n = s.index;
                if (s[1]) return this.openingBracketBlock(e, s[1], r, n);
                var o = e.getCommentFoldRange(r, n + s[0].length, 1);
                return (
                  o &&
                    !o.isMultiLine() &&
                    (i
                      ? (o = this.getSectionRange(e, r))
                      : "all" != t && (o = null)),
                  o
                );
              }
              if ("markbegin" !== t && (s = a.match(this.foldingStopMarker))) {
            ...
            (this.getSectionRange = function (e, t) {
              for (
                ...
                var l = (r = e.getLine(t)).search(/\S/);
                if (-1 !== l) {
                  if (i > l) break;
                  var c = this.getFoldWidgetRange(e, "all", t);
                  if (c) {
                    if (c.start.row <= a) break;
              ...
              return new s(a, n, o, e.getLine(o).length);
            }),
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var i = e("../lib/oop"),
        ...
        n = e("./matching_brace_outdent").MatchingBraceOutdent,
        o = e("../worker/worker_client").WorkerClient,
        _ = e("./behaviour/cstyle").CstyleBehaviour,
        l = e("./folding/cstyle").FoldMode,
        c = function () {
          (this.HighlightRules = a),
            (this.$outdent = new n()),
            (this.$behaviour = new _()),
          ...
          (this.lineCommentStart = "//"),
            ...
            (this.getNextLineIndent = function (e, t, r) {
              var i = this.$getIndent(t),
                ...
                a = s.tokens,
                n = s.state;
              if (a.length && "comment" == a[a.length - 1].type) return i;
              if ("start" == e || "no_regex" == e)
                (o = t.match(/^.*(?:\bcase\b.*:|[\{\(\[])\s*$/)) && (i += r);
              else if ("doc-start" == e) {
                if ("start" == n || "no_regex" == n) return "";
                var o;
                (o = t.match(/^\s*(\/?)\*/)) &&
                  (o[1] && (i += " "), (i += "* "));
              }
        ...
        (this.completionsDefined = !1),
          ...
          (this.getCompletions = function (e, t, r, i) {
            if (
              ...
              var s = t.getLine(r.row).substr(0, r.column),
                a = /\([^)]*$/.test(s);
              return (
                a && (s = s.substr(s.lastIndexOf("(") + 1)),
                /:[^;]+$/.test(s)
                  ? (/([\w\-]+):[^:]*$/.test(s),
                    this.getPropertyValueCompletions(e, t, r, i))
                  : this.getPropertyCompletions(e, t, r, i, a)
              );
            }
            return [];
          }),
          (this.getPropertyCompletions = function (e, t, r, s, a) {
            return (
              (a = a || !1),
          ...
          (this.getPropertyValueCompletions = function (e, t, r, s) {
            var a = t.getLine(r.row).substr(0, r.column),
              n = (/([\w\-]+):[^:]*$/.exec(a) || {})[1];
            if (!n) return [];
            var o = [];
            return (
              n in i && "object" === typeof i[n] && (o = Object.keys(i[n])),
              o.map(function (e) {
                return {
                  caption: e,
                  snippet: e,
  ...
  ace.define(
    ...
    function (e, t, r) {
      "use strict";
      var i = e("../../lib/oop"),
        s = (e("../behaviour").Behaviour, e("./cstyle").CstyleBehaviour),
        a = e("../../token_iterator").TokenIterator,
        n = function () {
          this.inherit(s),
            this.add("colon", "insertion", function (e, t, r, i, s) {
              if (":" === s && r.selection.isEmpty()) {
                var n = r.getCursorPosition(),
                  o = new a(i, n.row, n.column),
                  _ = o.getCurrentToken();
                if (
                  (_ && _.value.match(/\s+/) && (_ = o.stepBackward()),
                  _ && "support.type" === _.type)
                ) {
                  var l = i.doc.getLine(n.row);
                  if (":" === l.substring(n.column, n.column + 1))
                    return { text: "", selection: [1, 1] };
                  if (/^(\s+[^;]|\s*$)/.test(l.substring(n.column)))
                    return { text: ":;", selection: [1, 1] };
                }
              }
            }),
            this.add("colon", "deletion", function (e, t, r, i, s) {
              var n = i.doc.getTextRange(s);
              if (!s.isMultiLine() && ":" === n) {
                var o = r.getCursorPosition(),
                  _ = new a(i, o.row, o.column),
                  l = _.getCurrentToken();
                if (
                  (l && l.value.match(/\s+/) && (l = _.stepBackward()),
                  ...
                  if (
                    ...
                    i.doc
                      .getLine(s.start.row)
                      .substring(s.end.column, s.end.column + 1)
                  )
                    return s.end.column++, s;
              }
            }),
            this.add("semicolon", "insertion", function (e, t, r, i, s) {
              if (";" === s && r.selection.isEmpty()) {
                var a = r.getCursorPosition();
                if (
                  ";" === i.doc.getLine(a.row).substring(a.column, a.column + 1)
                )
                  return { text: "", selection: [1, 1] };
              }
            }),
            this.add("!important", "insertion", function (e, t, r, i, s) {
              if ("!" === s && r.selection.isEmpty()) {
                var a = r.getCursorPosition(),
                  n = i.doc.getLine(a.row);
                if (/^\s*(;|}|$)/.test(n.substring(a.column)))
                  return { text: "!important", selection: [10, 10] };
              }
            });
        };
      i.inherits(n, s), (t.CssBehaviour = n);
    }
  ),
  ace.define(
    "ace/mode/css",
    ...
    function (e, t, r) {
      ...
      var i = e("../lib/oop"),
        ...
        n = e("./matching_brace_outdent").MatchingBraceOutdent,
        o = e("../worker/worker_client").WorkerClient,
        _ = e("./css_completions").CssCompletions,
        ...
        function () {
          (this.foldingRules = "cStyle"),
            ...
            (this.getNextLineIndent = function (e, t, r) {
              ...
              return (
                (s.length && "comment" == s[s.length - 1].type) ||
                  (t.match(/^.*\{\s*$/) && (i += r)),
                i
              );
            }),
            ...
            (this.getCompletions = function (e, t, r, i) {
              return this.$completer.getCompletions(e, t, r, i);
            }),
            (this.createWorker = function (e) {
              var t = new o(["ace"], "ace/mode/css_worker", "Worker");
              return (
                t.attachToDocument(e.getDocument()),
                t.on("annotate", function (t) {
                  e.setAnnotations(t.data);
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = function () {
        this.add("string_dquotes", "insertion", function (e, t, r, i, s) {
          if ('"' == s || "'" == s) {
            var o = s,
              _ = i.doc.getTextRange(r.getSelectionRange());
            if (
              "" !== _ &&
              "'" !== _ &&
              '"' != _ &&
              ...
              return { text: o + _ + o, selection: !1 };
            var l = r.getCursorPosition(),
              c = i.doc.getLine(l.row).substring(l.column, l.column + 1),
              d = new a(i, l.row, l.column),
              m = d.getCurrentToken();
            if (c == o && (n(m, "attribute-value") || n(m, "string")))
              return { text: "", selection: [1, 1] };
            if ((m || (m = d.stepBackward()), !m)) return;
            for (; n(m, "tag-whitespace") || n(m, "whitespace"); )
              m = d.stepBackward();
            var g = !c || c.match(/\s/);
            if (
              (n(m, "attribute-equals") && (g || ">" == c)) ||
              (n(m, "decl-attribute-equals") && (g || "?" == c))
            )
              return { text: o + o, selection: [1, 1] };
          }
        }),
          this.add("string_dquotes", "deletion", function (e, t, r, i, s) {
            var a = i.doc.getTextRange(s);
            if (
              !s.isMultiLine() &&
              ('"' == a || "'" == a) &&
              i.doc
                .getLine(s.start.row)
                .substring(s.start.column + 1, s.start.column + 2) == a
            )
              return s.end.column++, s;
          }),
          this.add("autoclosing", "insertion", function (e, t, r, i, s) {
            if (">" == s) {
              var o = r.getSelectionRange().start,
                _ = new a(i, o.row, o.column),
                l = _.getCurrentToken() || _.stepBackward();
              if (
                !l ||
                !(
                  n(l, "tag-name") ||
                  n(l, "tag-whitespace") ||
                  n(l, "attribute-name") ||
                  n(l, "attribute-equals") ||
                  n(l, "attribute-value")
                )
              )
                return;
              if (n(l, "reference.attribute-value")) return;
              if (n(l, "attribute-value")) {
                var c = _.getCurrentTokenColumn() + l.value.length;
                if (o.column < c) return;
                if (o.column == c) {
                  var d = _.stepForward();
                  if (d && n(d, "attribute-value")) return;
                  _.stepBackward();
                }
              }
              if (/^\s*>/.test(i.getLine(o.row).slice(o.column))) return;
              for (; !n(l, "tag-name"); )
                if ("<" == (l = _.stepBackward()).value) {
                  l = _.stepForward();
                  break;
                }
              var m = _.getCurrentTokenRow(),
                g = _.getCurrentTokenColumn();
              if (n(_.stepBackward(), "end-tag-open")) return;
              var u = l.value;
              if (
                (m == o.row && (u = u.substring(0, o.column - g)),
                this.voidElements.hasOwnProperty(u.toLowerCase()))
              )
                return;
              return { text: "></" + u + ">", selection: [1, 1] };
            }
          }),
          this.add("autoindent", "insertion", function (e, t, r, i, s) {
            if ("\n" == s) {
              var n = r.getCursorPosition(),
                o = i.getLine(n.row),
                _ = new a(i, n.row, n.column),
                l = _.getCurrentToken();
              if (l && -1 !== l.type.indexOf("tag-close")) {
                if ("/>" == l.value) return;
                for (; l && -1 === l.type.indexOf("tag-name"); )
                  l = _.stepBackward();
                if (!l) return;
                var c = l.value,
                  d = _.getCurrentTokenRow();
                if (!(l = _.stepBackward()) || -1 !== l.type.indexOf("end-tag"))
                  return;
                if (this.voidElements && !this.voidElements[c]) {
                  var m = i.getTokenAt(n.row, n.column + 1),
                    g = ((o = i.getLine(d)), this.$getIndent(o)),
                    u = g + i.getTabString();
                  return m && "</" === m.value
                    ? {
                        text: "\n" + u + "\n" + g,
                        selection: [1, u.length, 1, u.length],
                      }
                    : { text: "\n" + u };
                }
              }
      ...
      i.inherits(o, s), (t.XmlBehaviour = o);
    }
  ),
  ace.define(
      ...
      i.inherits(a, s),
        function () {
          (this.$getMode = function (e) {
            ...
            (this.$tryMode = function (e, t, r, i) {
              var s = this.$getMode(e);
              return s ? s.getFoldWidget(t, r, i) : "";
            }),
            (this.getFoldWidget = function (e, t, r) {
              return (
                this.$tryMode(e.getState(r - 1), e, t, r) ||
                this.$tryMode(e.getState(r), e, t, r) ||
                this.defaultMode.getFoldWidget(e, t, r)
              );
            }),
            (this.getFoldWidgetRange = function (e, t, r) {
              var i = this.$getMode(e.getState(r - 1));
              return (
                (i && i.getFoldWidget(e, t, r)) ||
                  (i = this.$getMode(e.getState(r))),
                (i && i.getFoldWidget(e, t, r)) || (i = this.defaultMode),
                i.getFoldWidgetRange(e, t, r)
              );
            });
        }.call(a.prototype);
    }
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var i = e("../../lib/oop"),
        s = e("../../range").Range,
        a = e("./fold_mode").FoldMode,
        n = (t.FoldMode = function (e, t) {
          a.call(this),
            (this.voidElements = e || {}),
            (this.optionalEndTags = i.mixin({}, this.voidElements)),
      ...
      (function () {
        (this.getFoldWidget = function (e, t, r) {
          var i = this._getFirstTagInLine(e, r);
          return i
            ? i.closing || (!i.tagName && i.selfClosing)
              ? "markbeginend" === t
                ? "end"
                : ""
              : !i.tagName ||
                i.selfClosing ||
                this.voidElements.hasOwnProperty(i.tagName.toLowerCase()) ||
                this._findEndTagInLine(e, r, i.tagName, i.end.column)
              ? ""
              : "start"
            : this.getCommentFoldWidget(e, r);
        }),
          ...
          (this._getFirstTagInLine = function (e, t) {
            for (
              var r = e.getTokens(t), i = new o(), s = 0;
              s < r.length;
              s++
            ) {
              var a = r[s];
              if (_(a, "tag-open")) {
                if (
                  ((i.end.column = i.start.column + a.value.length),
                  (i.closing = _(a, "end-tag-open")),
                  !(a = r[++s]))
                )
                  return null;
                for (
                  i.tagName = a.value, i.end.column += a.value.length, s++;
                  s < r.length;
                  s++
                )
                  if (
                    ((a = r[s]),
                    (i.end.column += a.value.length),
                    _(a, "tag-close"))
                  ) {
              ...
              if (_(a, "tag-close"))
                return (i.selfClosing = "/>" == a.value), i;
              i.start.column += a.value.length;
            }
            return null;
          }),
          (this._findEndTagInLine = function (e, t, r, i) {
            for (var s = e.getTokens(t), a = 0, n = 0; n < s.length; n++) {
              var o = s[n];
              if (
                !((a += o.value.length) < i) &&
                _(o, "end-tag-open") &&
          ...
          (this.getFoldWidgetRange = function (e, t, r) {
            var i = e.getMatchingTags({ row: r, column: 0 });
            return i
              ? new s(
                  i.openTag.end.row,
                  i.openTag.end.column,
                  i.closeTag.start.row,
                  i.closeTag.start.column
                )
              : this.getCommentFoldWidget(e, r) &&
                  e.getCommentFoldRange(r, e.getLine(r).length);
          });
      }).call(n.prototype);
    }
  ),
    ...
    function (e, t, r) {
      ...
      var i = e("../../lib/oop"),
        ...
        o = (t.FoldMode = function (e, t) {
          s.call(this, new a(e, t), { "js-": new n(), "css-": new n() });
        });
      i.inherits(o, s);
    }
  ),
  ace.define(
    ...
    function (e, t, r) {
      ...
      function _(e, t) {
        for (
          var r = new i(e, t.row, t.column), s = r.getCurrentToken();
          s && !o(s, "tag-name");
      ...
      (function () {
        (this.getCompletions = function (e, t, r, i) {
          var s = t.getTokenAt(r.row, r.column);
          if (!s) return [];
          if (o(s, "tag-name") || o(s, "tag-open") || o(s, "end-tag-open"))
            return this.getTagCompletions(e, t, r, i);
          if (o(s, "tag-whitespace") || o(s, "attribute-name"))
            return this.getAttributeCompletions(e, t, r, i);
          if (o(s, "attribute-value"))
            return this.getAttributeValueCompletions(e, t, r, i);
          var a = t.getLine(r.row).substr(0, r.column);
          return /&[a-z]*$/i.test(a)
            ? this.getHTMLEntityCompletions(e, t, r, i)
            : [];
        }),
          (this.getTagCompletions = function (e, t, r, i) {
          ...
          (this.getAttributeCompletions = function (e, t, r, i) {
            var n = _(t, r);
            if (!n) return [];
            var o = s;
            return (
              n in a && (o = o.concat(Object.keys(a[n]))),
              o.map(function (e) {
                return {
                  caption: e,
                  snippet: e + '="$0"',
          ...
          (this.getAttributeValueCompletions = function (e, t, r, s) {
            var n = _(t, r),
              l = (function (e, t) {
                for (
                  var r = new i(e, t.row, t.column), s = r.getCurrentToken();
                  s && !o(s, "attribute-name");
          ...
          (this.getHTMLEntityCompletions = function (e, t, r, i) {
            return [
              "Aacute;",
              "aacute;",
              "Acirc;",
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var i = e("../lib/oop"),
        ...
        n = e("./javascript").Mode,
        o = e("./css").Mode,
        _ = e("./html_highlight_rules").HtmlHighlightRules,
        ...
        p = function (e) {
          (this.fragmentContext = e && e.fragmentContext),
            (this.HighlightRules = _),
            (this.$behaviour = new l()),
            (this.$completer = new d()),
            this.createModeDelegates({ "js-": n, "css-": o }),
            (this.foldingRules = new c(this.voidElements, s.arrayToMap(u)));
        };
      i.inherits(p, a),
        function () {
          (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
            (this.voidElements = s.arrayToMap(g)),
            (this.getNextLineIndent = function (e, t, r) {
            ...
            (this.createWorker = function (e) {
              if (this.constructor == p) {
                var t = new m(["ace"], "ace/mode/html_worker", "Worker");
                return (
                  t.attachToDocument(e.getDocument()),
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var i = e("../lib/oop"),
        s = e("./text").Mode,
        a = e("./php_highlight_rules").PhpHighlightRules,
        n = e("./php_highlight_rules").PhpLangHighlightRules,
        o = e("./matching_brace_outdent").MatchingBraceOutdent,
        _ = e("../worker/worker_client").WorkerClient,
          ...
          (this.tokenRe = new RegExp("^[" + d.wordChars + "_]+", "g")),
            ...
            (this.getNextLineIndent = function (e, t, r) {
              var i = this.$getIndent(t),
                ...
                n = s.state;
              if (a.length && "comment" == a[a.length - 1].type) return i;
              if ("start" == e) (o = t.match(/^.*[\{\(\[:]\s*$/)) && (i += r);
              else if ("doc-start" == e) {
                if ("doc-start" != n) return "";
                var o;
                (o = t.match(/^\s*(\/?)\*/)) &&
                  (o[1] && (i += " "), (i += "* "));
              }
      ...
      var f = function (e) {
        ...
        m.call(this),
          (this.HighlightRules = a),
          this.createModeDelegates({ "js-": g, "css-": u, "php-": p }),
          (this.foldingRules.subModes["php-"] = new c());
      };
      i.inherits(f, m),
        function () {
          (this.createWorker = function (e) {
            var t = new _(["ace"], "ace/mode/php_worker", "PhpWorker");
            return (
              t.attachToDocument(e.getDocument()),
      ...
      var i = e("../lib/oop"),
        ...
        l = function () {
          a.call(this),
            ...
            this.createModeDelegates({ "js-": n, "css-": o, "html-": _ });
        };
      i.inherits(l, a),
        function () {
  ...
  ace.require(["ace/mode/php_laravel_blade"], function (e) {
