ace.define(
        ...
        a = function () {
          ...
          (this.$rules = {
            start: [
              ...
              { token: "entity.other.attribute-name", regex: "@" + i },
            ...
            "operator-heredoc-string": [
              {
                onMatch: function (e, t, n) {
                  ...
                  var r = { ">": "<", "]": "[", ")": "(", "}": "{" };
                  return (
                    -1 != Object.keys(r).indexOf(e) && (e = r[e]),
                    e != n[1] || (n.shift(), n.shift()),
                    "string"
                  );
                },
                regex: '(?:[\\]\\)}>]+)"',
            ...
            "identifier-heredoc-string": [
              {
                onMatch: function (e, t, n) {
                  return (
                    (e = e.substring(0, e.length - 1)) != n[1] ||
                      (n.shift(), n.shift()),
                    "string"
                  );
                },
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        i = e("./d_highlight_rules").DHighlightRules,
  ...
  ace.require(["ace/mode/d"], function (e) {
