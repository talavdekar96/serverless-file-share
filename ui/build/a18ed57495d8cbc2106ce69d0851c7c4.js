ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../lib/oop"),
        ...
        a = function () {
          var e = this.createKeywordMapper(
            {
              "support.type": i.supportType,
              "support.function": i.supportFunction,
          ...
          this.$rules = {
            start: [
              ...
              { token: "constant.numeric", regex: i.numRe },
              {
                token: "keyword",
                regex:
      ...
      o.inherits(a, n), (t.StylusHighlightRules = a);
    }
  ),
  ace.define(
      ...
      o.inherits(a, n),
        function () {
          (this.getFoldWidgetRange = function (e, t, r) {
            ...
            if (-1 != s && "#" == a[s]) {
              for (
                var l = a.length, d = e.getLength(), u = r, g = r;
                ++r < d;

              ) {
                var c = (a = e.getLine(r)).search(n);
                if (-1 != c) {
                  if ("#" != a[c]) break;
                  g = r;
                }
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../lib/oop"),
        n = e("./text").Mode,
        i = e("./stylus_highlight_rules").StylusHighlightRules,
  ...
  ace.require(["ace/mode/stylus"], function (e) {
