ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
          ...
          var e = this.createKeywordMapper(
            {
              ...
              "constant.language": "ARGV|ENV|INC|SIG",
              "support.function":
      ...
      r.inherits(i, a), (t.PerlHighlightRules = i);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        i = function () {
          ...
          (this.$rules = {
            start: [
              { token: "comment", regex: "#.*$" },
              { token: "string", regex: t + '"{3}', next: "qqstring3" },
              { token: "string", regex: t + '"(?=.)', next: "qqstring" },
              { token: "string", regex: t + "'{3}", next: "qstring3" },
              { token: "string", regex: t + "'(?=.)", next: "qstring" },
              { token: "string", regex: n + '"{3}', next: "rawqqstring3" },
              { token: "string", regex: n + '"(?=.)', next: "rawqqstring" },
              { token: "string", regex: n + "'{3}", next: "rawqstring3" },
              { token: "string", regex: n + "'(?=.)", next: "rawqstring" },
              { token: "string", regex: r + '"{3}', next: "fqqstring3" },
              { token: "string", regex: r + '"(?=.)', next: "fqqstring" },
              { token: "string", regex: r + "'{3}", next: "fqstring3" },
              { token: "string", regex: r + "'(?=.)", next: "fqstring" },
              { token: "string", regex: a + '"{3}', next: "rfqqstring3" },
              { token: "string", regex: a + '"(?=.)', next: "rfqqstring" },
              { token: "string", regex: a + "'{3}", next: "rfqstring3" },
              { token: "string", regex: a + "'(?=.)", next: "rfqstring" },
              {
                token: "keyword.operator",
                regex:
                  "\\+|\\-|\\*|\\*\\*|\\/|\\/\\/|%|@|<<|>>|&|\\||\\^|~|<|>|<=|=>|==|!=|<>|=",
            ...
            constants: [
              ...
              { token: "constant.numeric", regex: i + "[lL]\\b" },
              { token: "constant.numeric", regex: i + "\\b" },
              {
      ...
      r.inherits(i, a), (t.PythonHighlightRules = i);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(i, a), (t.JsonHighlightRules = i);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var r = e("../lib/oop"),
        a = e("./jsdoc_comment_highlight_rules").JsDocCommentHighlightRules,
        ...
        s = function (e) {
          ...
          (this.$rules = {
            ...
            this.embedRules(a, "doc-", [a.getEndRule("no_regex")]),
            this.normalizeRules();
        };
      function _() {
        var e = o.replace("\\d", "\\d\\-"),
      ...
      r.inherits(s, i), (t.JavaScriptHighlightRules = s);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      var r = e("../lib/oop"),
        ...
        _ = e("./json_highlight_rules").JsonHighlightRules,
      ...
      r.inherits(g, i), (t.PgsqlHighlightRules = g);
    }
  ),
  ace.define(
    "ace/mode/pgsql",
    ...
    function (e, t, n) {
      var r = e("../lib/oop"),
        a = e("../mode/text").Mode,
        i = e("./pgsql_highlight_rules").PgsqlHighlightRules,
        o = function () {
          (this.HighlightRules = i), (this.$behaviour = this.$defaultBehaviour);
        };
      r.inherits(o, a),
        function () {
          (this.lineCommentStart = "--"),
            ...
            (this.getNextLineIndent = function (e, t, n) {
              return "start" == e || "keyword.statementEnd" == e
                ? ""
                : this.$getIndent(t);
            }),
  ...
  ace.require(["ace/mode/pgsql"], function (e) {
