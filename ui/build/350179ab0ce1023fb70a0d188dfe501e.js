ace.define(
      ...
      var r = e("../lib/oop"),
        ...
        s = function () {
          ...
          (this.$rules = {
            ...
            qdoc: [{ token: "string", regex: "'''", next: "start" }].concat(t),
            qqdoc: [{ token: "string", regex: '"""', next: "start" }].concat(t),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./c_cpp").Mode,
        i = e("./dart_highlight_rules").DartHighlightRules,
  ...
  ace.require(["ace/mode/dart"], function (e) {
