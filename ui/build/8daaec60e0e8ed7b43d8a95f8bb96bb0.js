ace.define(
  ...
  ace.define(
    ...
    function (e, t, o) {
      ...
      n.inherits(S, r), (t.c_cppHighlightRules = S);
    }
  ),
  ace.define(
    ...
    function (e, t, o) {
      ...
      var n = e("../lib/oop"),
        ...
        a = function () {
          var e =
            ...
            o = t.getRules();
          for (var n in ((this.$keywordList = t.$keywordList),
          (this.$rules = {
            start: [
              { token: "comment", regex: "\\/\\/.*$" },
              i.getStartRule("doc-start"),
              ...
              { token: t.getKeywords(), regex: "[a-zA-Z_$][a-zA-Z0-9_$]*\\b" },
              {
          ...
          o))
            this.$rules[n]
              ? this.$rules[n].push &&
                this.$rules[n].push.apply(this.$rules[n], o[n])
              : (this.$rules[n] = o[n]);
      ...
      n.inherits(a, r), (t.ObjectiveCHighlightRules = a);
    }
  ),
  ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getCommentRegionBlock = function (e, t, o) {
              for (
                ...
                t = e.getLine(o);
                var l = S.exec(t);
                if (l && (l[1] ? N-- : N++, !N)) break;
              }
              if (o > a) return new i(a, n, o, t.length);
            });
        }.call(a.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, o) {
      ...
      var n = e("../lib/oop"),
        i = e("./text").Mode,
        r = e("./objectivec_highlight_rules").ObjectiveCHighlightRules,
  ...
  ace.require(["ace/mode/objectivec"], function (e) {
