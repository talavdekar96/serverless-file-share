ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(u, s), (t.HtmlHighlightRules = u);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
            ...
            t = [
              {
                ...
                onMatch: function (e, t, n, o) {
                  ...
                  if (
                    u &&
                    u[1].length < i.length + 3 &&
                    u[2].length >= s.length &&
                    u[2][0] == s[0]
                  )
                    return n.splice(0, 3), (this.next = n.shift()), this.token;
                  if (((this.next = ""), l && r[l])) {
                    var c = r[l].getTokenizer().getLineTokens(e, a.slice(0));
                    return (n[1] = c.state), c.tokens;
                  }
                  return this.token;
                },
              },
      ...
      o.inherits(u, i), (t.MarkdownHighlightRules = u);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r,
        ...
        c = e("./javascript_highlight_rules").JavaScriptHighlightRules,
        g = e("./css_highlight_rules").CssHighlightRules,
        d = e("./markdown_highlight_rules").MarkdownHighlightRules,
        p = e("./html_highlight_rules").HtmlHighlightRules,
        m = "constant.language",
        x = "support.variable.class",
        h = "keyword.operator",
        f = "markup.italic",
        k = "paren.lparen",
        b = "paren.rparen";
      function y() {
        this.$rules = {
          start: [
            ...
            v.string('"'),
            v.string("'"),
            v.syntax(/(markdown|md)\b/, "md-multiline", "multiline"),
            v.syntax(/html\b/, "html-multiline", "multiline"),
            v.syntax(/(slot|event)\b/, "js-block", "block"),
            v.syntax(/style\b/, "css-block", "block"),
            v.syntax(/var\b/, "js-statement", "attr"),
            v.tag(),
            w(k, "[[({>]"),
            w(b, "[\\])};]", "start"),
            { caseInsensitive: !0 },
        ...
        function n(t, n, r, o, a) {
          ...
          0 === s.length && (s = null),
            /block|multiline/.test(n) &&
              ((i = n + "end"), (e.$rules[i] = [w("empty", "", "start")])),
            e.embedRules(t, n, [w(a || b, r, i)], s, null == s);
        }
        t("interpolation", /\]/, b + "." + f),
          t("statement", /\)|}|;/),
          t("block", /\}/),
      ...
      var v = {
        ...
        interpolation: function () {
          return [
            w("keyword.control.markup.italic", /\s*\w*\s*:/),
          ...
          return {
            ...
            onMatch: function (e) {
              return void 0 !== o[e]
                ...
                : void 0 !== r[e]
                ? "support.function"
                : void 0 !== i[e.toLowerCase()]
                ? "keyword.support.constant.language"
                : "support.function.markup.bold";
            },
            regex: /([@\w\-_:+]+)|((^|\s)(?=\s*(\.|#)))/,
            push: [
              v.tagHead(/\./),
        ...
        attribute: function () {
          return w(
            function (e) {
              return /^x\-/.test(e) ? x + ".markup.bold" : x;
            },
            /[\w_-]+/,
            [
              w(h, /\s*=\s*/, [
      ...
      function w(e, t, n) {
        ...
        return (
          4 === arguments.length
            ...
            ? (o = n)
            : (r = n),
          "function" === typeof e && ((a = e), (e = "empty")),
          { token: e, regex: t, push: r, next: o, onMatch: a }
        );
      }
    }
  ),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./mask_highlight_rules").MaskHighlightRules,
  ...
  ace.require(["ace/mode/mask"], function (e) {
