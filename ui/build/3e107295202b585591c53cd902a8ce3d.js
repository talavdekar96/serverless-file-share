ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(a, i), (t.c_cppHighlightRules = a);
    }
  ),
  ace.define(
        ...
        function () {
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new o(i, s, a, e.getLine(a).length);
            }),
            (this.getCommentRegionBlock = function (e, t, n) {
              ...
              if (n > s) return new o(s, r, n, t.length);
            });
        }.call(s.prototype);
    }
  ),
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        i = function () {
          ...
          (this.$rules = new o().$rules),
            this.$rules.start.forEach(function (t) {
              "function" == typeof t.token && (t.token = e);
            });
        };
      r.inherits(i, o), (t.glslHighlightRules = i);
    }
  ),
  ace.define(
    "ace/mode/glsl",
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./c_cpp").Mode,
        i = e("./glsl_highlight_rules").glslHighlightRules,
        s = e("./matching_brace_outdent").MatchingBraceOutdent,
        a = e("./folding/cstyle").FoldMode,
        c = function () {
          (this.HighlightRules = i),
  ...
  ace.require(["ace/mode/glsl"], function (e) {
