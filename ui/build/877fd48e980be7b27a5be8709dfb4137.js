ace.define(
  ...
  function (e, t, n) {
      ...
      o = function () {
        ...
        this.$rules = {
          start: [
            ...
            { token: "constant.numeric", regex: "(?:" + o + "|\\d+)[jJ]\\b" },
            { token: "constant.numeric", regex: o },
            { token: "constant.numeric", regex: n + "[lL]\\b" },
            { token: "constant.numeric", regex: n + "\\b" },
            {
              token: "keyword",
              regex:
    ...
    r.inherits(o, i), (t.FortranHighlightRules = o);
  }
),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        i = e("./text").Mode,
        o = e("./fortran_highlight_rules").FortranHighlightRules,
          ...
          (this.checkOutdent = function (t, n, r) {
            ...
            (this.autoOutdent = function (e, t, n) {
              ...
              var r = this.$getIndent(t.getLine(n)),
                i = t.getTabString();
              r.slice(-i.length) == i &&
                t.remove(new s(n, r.length - i.length, n, r.length));
            }),
  ...
  ace.require(["ace/mode/fortran"], function (e) {
