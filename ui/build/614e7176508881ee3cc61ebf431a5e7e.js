ace.define(
  ...
  function (e, t, n) {
    ...
    var o = e("../lib/oop"),
      ...
      s = function (e) {
        (this.embeddedRulePrefix = void 0 === e ? "" : e),
    ...
    o.inherits(s, r),
      function () {
        (this.pushRule = function (e) {
          ...
          return {
            regex: e.regex,
            onMatch: function (t, n, o, r) {
              if ((0 === o.length && o.push(n), Array.isArray(e.next)))
                for (var s = 0; s < e.next.length; s++) o.push(e.next[s]);
              else o.push(e.next);
              return (this.next = o[o.length - 1]), e.token;
            },
            get next() {
              ...
              e.next && (e.next = this.embeddedRulePrefix + e.next),
              {
                ...
                onMatch: function (t, n, o, r) {
                  return (
                    o.pop(),
                    e.next
                      ? (o.push(e.next), (this.next = o[o.length - 1]))
                      : (this.next = o.length > 1 ? o[o.length - 1] : o.pop()),
                    e.token
                  );
                },
              }
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      o.inherits(s, r), (t.CsoundScoreHighlightRules = s);
    }
  ),
  ace.define(
  ...
  ace.require(["ace/mode/csound_score"], function (e) {
