ace.define(
  ...
  function (e, t, n) {
    ...
    r.inherits(p, o), (t.CssHighlightRules = p);
  }
),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(m, o), (t.RubyHighlightRules = m);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(i, o), (t.HtmlRubyHighlightRules = i);
    }
  ),
  ace.define(
      ...
      var s = function () {
        this.add("string_dquotes", "insertion", function (e, t, n, r, o) {
          if ('"' == o || "'" == o) {
            ...
            var p = !u || u.match(/\s/);
            if (
              (i(d, "attribute-equals") && (p || ">" == u)) ||
              (i(d, "decl-attribute-equals") && (p || "?" == u))
            )
          ...
          this.add("autoclosing", "insertion", function (e, t, n, r, o) {
            if (">" == o) {
              ...
              var d = l.getCurrentTokenRow(),
                p = l.getCurrentTokenColumn();
              if (i(l.stepBackward(), "end-tag-open")) return;
              var m = c.value;
              if (
                (d == s.row && (m = m.substring(0, s.column - p)),
              ...
              if (c && -1 !== c.type.indexOf("tag-close")) {
                ...
                if (this.voidElements && !this.voidElements[u]) {
                  var d = r.getTokenAt(i.row, i.column + 1),
                    p = ((s = r.getLine(g)), this.$getIndent(s)),
                    m = p + r.getTabString();
                  return d && "</" === d.value
                    ? {
                        text: "\n" + m + "\n" + p,
      ...
      var r = e("../lib/oop"),
        ...
        h = function (e) {
          (this.fragmentContext = e && e.fragmentContext),
            ...
            (this.foldingRules = new u(this.voidElements, o.arrayToMap(m)));
        };
      r.inherits(h, a),
        function () {
          (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
            (this.voidElements = o.arrayToMap(p)),
            (this.getNextLineIndent = function (e, t, n) {
            ...
            (this.rubyBlock = function (e, t, n, r) {
              ...
              if (s && ("keyword" == s.type || "comment.multiline" == s.type)) {
                ...
                if (u) {
                  ...
                  if (!s) return null;
                  if (r) return m.push(o.getCurrentTokenRange()), m;
                  t = o.getCurrentTokenRow();
                  if (-1 === u) {
                    if ("comment.multiline" === s.type) var k = 6;
                    else k = e.getLine(t).length;
                    return new a(t, k, p - 1, d);
                  }
                  return new a(p, d, t - 1, e.getLine(t - 1).length);
                }
              }
            });
        }.call(s.prototype);
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var r = e("../lib/oop"),
        o = e("./html_ruby_highlight_rules").HtmlRubyHighlightRules,
        a = e("./html").Mode,
        i = e("./javascript").Mode,
        s = e("./css").Mode,
        l = e("./ruby").Mode,
        c = function () {
          a.call(this),
            ...
            this.createModeDelegates({ "js-": i, "css-": s, "ruby-": l });
        };
      r.inherits(c, a),
        function () {
  ...
  ace.require(["ace/mode/html_ruby"], function (e) {
