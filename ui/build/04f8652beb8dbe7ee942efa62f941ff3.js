ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(o, a),
        ...
        (t.JsDocCommentHighlightRules = o);
    }
  ),
  ace.define(
      ...
      var r = e("../lib/oop"),
        ...
        c = function e() {
          s.call(this),
            ...
            this.embedTagRules(o, "css-", "style"),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var i = (t.constantNumericHex = {
        ...
        g = (t.constantNumericRational = {
          token: "constant.numeric",
          regex: /\b([\d]+(?:[./][\d]+)?ri?)\b/,
        }),
        u = (t.constantNumericComplex = {
          token: "constant.numeric",
          regex: /\b([\d]i)\b/,
        }),
      ...
      r.inherits(x, a), (t.RubyHighlightRules = x);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        o = e("./ruby_highlight_rules"),
        i = o.RubyHighlightRules,
        s = function () {
          a.call(this),
            (this.$rules = {
              start: [
                ...
                o.constantNumericHex,
                o.constantNumericFloat,
      ...
      r.inherits(i, a),
        function () {
          (this.getFoldWidgetRange = function (e, t, n) {
            ...
            if (-1 != s && "#" == i[s]) {
              for (
                var l = i.length, c = e.getLength(), g = n, u = n;
                ++n < c;

              ) {
                var d = (i = e.getLine(n)).search(a);
                if (-1 != d) {
                  if ("#" != i[d]) break;
                  u = n;
                }
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        a = e("./text").Mode,
        o = e("./haml_highlight_rules").HamlHighlightRules,
  ...
  ace.require(["ace/mode/haml"], function (e) {
