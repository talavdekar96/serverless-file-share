ace.define(
  ...
  function (e, t, n) {
      ...
      s = function () {
        ...
        (this.$rules = {
          start: [
            ...
            { token: "support.function", regex: i },
    ...
    r.inherits(s, i), (t.ShHighlightRules = s);
  }
),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        i = e("./text_highlight_rules").TextHighlightRules,
        o = e("./sh_highlight_rules"),
        a = function () {
          var e = this.createKeywordMapper(
            {
              keyword: o.reservedKeywords,
              "support.function.builtin": o.languageConstructs,
              "invalid.deprecated": "debugger",
            },
            "string"
          );
      ...
      r.inherits(a, i), (t.MakefileHighlightRules = a);
    }
  ),
  ace.define(
      ...
      r.inherits(a, i),
        function () {
          (this.getFoldWidgetRange = function (e, t, n) {
            ...
            if (-1 != s && "#" == a[s]) {
              for (
                var l = a.length, d = e.getLength(), g = n, u = n;
                ++n < d;

              ) {
                var c = (a = e.getLine(n)).search(i);
                if (-1 != c) {
                  if ("#" != a[c]) break;
                  u = n;
                }
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              return (
                (e.foldWidgets[n - 1] = -1 != s && s < i ? "start" : ""),
                i < l ? "start" : ""
              );
            });
        }.call(a.prototype);
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        i = e("./text").Mode,
        o = e("./makefile_highlight_rules").MakefileHighlightRules,
  ...
  ace.require(["ace/mode/makefile"], function (e) {
