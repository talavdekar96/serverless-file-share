ace.define(
  ...
  function (e, t, a) {
    ...
    var n = e("../lib/oop"),
      ...
      r = function () {
        var e = { token: "constant.numeric", regex: "0x[0-9a-fA-F]+\\b" },
          t = {
            ...
            token: this.createKeywordMapper(
              {
                ...
                "constant.language": "pi|Inf|tau|time",
                "support.function":
          ...
          i = { token: "variable.language", regex: "\\$[/|!]?|@\\$/" },
          s = {
        ...
        this.$rules = {
          start: [
            ...
            { token: "string.quoted.single", regex: "[<](?:[a-zA-Z0-9 ])*[>]" },
            {
              token: ["keyword", "text", "variable.module"],
              regex: "(use)(\\s+)((?:[a-zA-Z_][a-zA-Z_0-9:-]*\\b\\.?)*)",
            },
            e,
            t,
            a,
    ...
    n.inherits(r, o), (t.RakuHighlightRules = r);
  }
),
  ace.define(
      ...
      (function () {
        (this.checkOutdent = function (e, t) {
          ...
          (this.autoOutdent = function (e, t) {
            var a = e.getLine(t).match(/^(\s*\})/);
            if (!a) return 0;
            var o = a[1].length,
              r = e.findMatchingBracket({ row: t, column: o });
            if (!r || r.row == t) return 0;
            var i = this.$getIndent(e.getLine(r.row));
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, t, a) {
              ...
              if (
                ...
                return "";
              var o = this._getFoldWidgetBase(e, t, a);
              return !o && this.startRegionRe.test(n) ? "start" : o;
            }),
            (this.getFoldWidgetRange = function (e, t, a, n) {
              var o,
                r = e.getLine(a);
              if (this.startRegionRe.test(r))
                return this.getCommentRegionBlock(e, r, a);
              if ((o = r.match(this.foldingStartMarker))) {
                var i = o.index;
                if (o[1]) return this.openingBracketBlock(e, o[1], a, i);
                var s = e.getCommentFoldRange(a, i + o[0].length, 1);
                return (
                  s &&
                    !s.isMultiLine() &&
                    (n
                      ? (s = this.getSectionRange(e, a))
                      : "all" != t && (s = null)),
                  s
                );
              }
              if ("markbegin" !== t && (o = r.match(this.foldingStopMarker))) {
                ...
                return o[1]
                  ? this.closingBracketBlock(e, o[1], a, i)
                  : e.getCommentFoldRange(a, i, -1);
              }
            }),
            (this.getSectionRange = function (e, t) {
              ...
              return new o(r, i, s, e.getLine(s).length);
            }),
            (this.getCommentRegionBlock = function (e, t, a) {
              ...
              if (a > i) return new o(i, n, a, t.length);
            });
        }.call(i.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, a) {
      ...
      var n = e("../lib/oop"),
        o = e("./text").Mode,
        r = e("./raku_highlight_rules").RakuHighlightRules,
      ...
      n.inherits(l, o),
        function () {
          (this.lineCommentStart = "#"),
            ...
            (this.getNextLineIndent = function (e, t, a) {
              var n = this.$getIndent(t),
                o = this.getTokenizer().getLineTokens(t, e).tokens;
              if (o.length && "comment" == o[o.length - 1].type) return n;
              "start" == e && t.match(/^.*[\{\(\[:]\s*$/) && (n += a);
              return n;
            }),
            (this.checkOutdent = function (e, t, a) {
              return this.$outdent.checkOutdent(t, a);
            }),
            (this.autoOutdent = function (e, t, a) {
              this.$outdent.autoOutdent(t, a);
            }),
  ...
  ace.require(["ace/mode/raku"], function (e) {
