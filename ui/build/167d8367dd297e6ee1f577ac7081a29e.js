ace.define(
    ...
    o.inherits(a, r),
      function () {
        (this.getFoldWidgetRange = function (e, t, i) {
          var o = this.indentationBlock(e, i);
          if (o) return o;
          var r = /\S/,
            a = e.getLine(i),
            l = a.search(r);
          if (-1 != l && "#" == a[l]) {
            for (var s = a.length, d = e.getLength(), g = i, c = i; ++i < d; ) {
              var f = (a = e.getLine(i)).search(r);
              if (-1 != f) {
                if ("#" != a[f]) break;
                c = i;
              }
          ...
          (this.getFoldWidget = function (e, t, i) {
            ...
            if (-1 == r)
              return (
                (e.foldWidgets[i - 1] = -1 != l && l < s ? "start" : ""), ""
              );
            if (-1 == l) {
              if (r == s && "#" == o[r] && "#" == n[r])
                return (
              ...
              "#" == o[r] &&
              "#" == a[r] &&
              -1 == e.getLine(i - 2).search(/\S/)
            )
              return (
                (e.foldWidgets[i - 1] = "start"),
                (e.foldWidgets[i + 1] = ""),
                ""
              );
            return (
              (e.foldWidgets[i - 1] = -1 != l && l < r ? "start" : ""),
              r < s ? "start" : ""
            );
          });
      }.call(a.prototype);
  ...
  ace.define(
    ...
    function (e, t, i) {
      ...
      o.inherits(n, r), (t.SpaceHighlightRules = n);
    }
  ),
  ace.define(
    "ace/mode/space",
    ...
    function (e, t, i) {
      ...
      var o = e("../lib/oop"),
        r = e("./text").Mode,
        n = e("./folding/coffee").FoldMode,
        a = e("./space_highlight_rules").SpaceHighlightRules,
        l = function () {
  ...
  ace.require(["ace/mode/space"], function (e) {
