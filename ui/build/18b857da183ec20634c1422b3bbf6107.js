ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        (this.$rules.handlebars = [
          {
            ...
            regex: "{{!--",
            push: [
              { token: "comment.end", regex: "--}}", next: a },
              { defaultToken: "comment" },
            ],
          },
          {
          ...
          },
          {
            ...
            regex: "{{{",
            push: [
              { token: "support.function", regex: "}}}", next: a },
              {
          ...
          },
          {
            ...
            regex: "{{[#\\^/&]?",
            push: [
              { token: "storage.type.end", regex: "}}", next: a },
              {
                token: "variable.parameter",
                regex: "[a-zA-Z_$][a-zA-Z0-9_$]*",
              },
      ...
      o.inherits(i, r), (t.HandlebarsHighlightRules = i);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      o.inherits(a, r), (t.HtmlBehaviour = a);
    }
  ),
  ace.define(
    "ace/mode/handlebars",
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./html").Mode,
        a = e("./handlebars_highlight_rules").HandlebarsHighlightRules,
        i = e("./behaviour/html").HtmlBehaviour,
        s =
          (e("./folding/html").FoldMode,
          function () {
            r.call(this),
              (this.HighlightRules = a),
  ...
  ace.require(["ace/mode/handlebars"], function (e) {
