ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        s = function () {
          ...
          function t(e, t) {
            var n = t.nestable || t.interpolation,
              i = (t.interpolation && t.interpolation.nextState) || "start",
              r = {
                regex: e + (t.multiline ? "" : "(?=.)"),
                token: "string.start",
              },
            ...
            if ((n ? (r.push = a) : (r.next = a), !t.interpolation)) return r;
            var s = t.interpolation.open,
              l = t.interpolation.close;
            return [
              {
                regex: "[" + o.escapeRegExp(s + l) + "]",
                onMatch: function (e, t, n) {
                  return (
                    (this.next = e == s ? this.nextState : ""),
                    e == s && n.length
      ...
      i.inherits(s, a), (t.HighlightRules = s);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var i = e("../lib/oop"),
        o = e("./text").Mode,
        r = e("./swift_highlight_rules").HighlightRules,
  ...
  ace.require(["ace/mode/swift"], function (e) {
