ace.define(
  ...
  function (e, t, n) {
      ...
      o = function () {
        this.$rules = {
          start: [
            ...
            {
              token: ["text", "keyword"],
              regex: "(^\\s*)(clearinfo|endSendPraat)$",
            },
            {
    ...
    r.inherits(o, i), (t.PraatHighlightRules = o);
  }
),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        i = e("./text").Mode,
        o = e("./praat_highlight_rules").PraatHighlightRules,
  ...
  ace.require(["ace/mode/praat"], function (e) {
