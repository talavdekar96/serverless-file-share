        ...
        (t.Mode = o =
          (function (t) {
            var n,
              o = (function (e, t) {
                ...
                (n.prototype = (e.superclass = t).prototype),
                  ...
                  "function" == typeof t.extended && t.extended(e);
                return e;
              })(
                (((function (e, t) {
                  ...
                  return e;
                })(i, t).displayName = "LiveScriptMode"),
                i),
                t
              ).prototype;
            function i() {
              var t;
              (this.$tokenizer = new (e("../tokenizer").Tokenizer)(i.Rules)),
                (t = e("../mode/matching_brace_outdent")) &&
            ...
            return (
              ...
              (o.getNextLineIndent = function (e, t, r) {
                var o, i;
                return (
                  (o = this.$getIndent(t)),
                  ((i = this.$tokenizer.getLineTokens(t, e).tokens).length &&
                    "comment" === i[i.length - 1].type) ||
                    ("start" === e && n.test(t) && (o += r)),
                  o
                );
              }),
              (o.lineCommentStart = "#"),
              (o.blockComment = { start: "###", end: "###" }),
              (o.checkOutdent = function (e, t, n) {
                var r;
                return null != (r = this.$outdent)
                  ? r.checkOutdent(t, n)
                  : void 0;
              }),
              (o.autoOutdent = function (e, t, n) {
                var r;
                return null != (r = this.$outdent)
                  ? r.autoOutdent(t, n)
                  : void 0;
        ...
        (o.Rules = {
          start: [
            ...
            },
            {
              ...
              regex: "(?:true|false|yes|no|on|off|null|void|undefined)" + i,
            },
            {
            ...
            },
            {
              ...
              regex: "(?:t(?:hat|il|o)|f(?:rom|allthrough)|it|by|e)" + i,
            },
          ...
          qdoc: [{ token: "string", regex: ".*?'''", next: "key" }, a],
          qqdoc: [{ token: "string", regex: '.*?"""', next: "key" }, a],
          qstring: [
            {
              token: "string",
              regex: "[^\\\\']*(?:\\\\.[^\\\\']*)*'",
          ...
          words: [{ token: "string", regex: ".*?\\]>", next: "key" }, a],
        });
    }
  ),
  ace.require(["ace/mode/livescript"], function (e) {
