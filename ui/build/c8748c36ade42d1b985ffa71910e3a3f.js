ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      o.inherits(g, i), (t.MarkdownHighlightRules = g);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        a =
          ...
          e("./scss_highlight_rules").ScssHighlightRules,
          e("./less_highlight_rules").LessHighlightRules,
          e("./coffee_highlight_rules").CoffeeHighlightRules,
      ...
      r.inherits(s, o), (t.JadeHighlightRules = s);
    }
  ),
  ace.define(
      ...
      r.inherits(i, o),
        function () {
          (this.getFoldWidgetRange = function (e, t, n) {
            ...
            if (-1 != s && "#" == i[s]) {
              for (
                var l = i.length, g = e.getLength(), u = n, c = n;
                ++n < g;

              ) {
                var p = (i = e.getLine(n)).search(o);
                if (-1 != p) {
                  if ("#" != i[p]) break;
                  c = n;
                }
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./jade_highlight_rules").JadeHighlightRules,
  ...
  ace.require(["ace/mode/jade"], function (e) {
