ace.define(
  ...
  function (s, e, t) {
    "use strict";
    var d = s("../lib/oop"),
      p = s("./text_highlight_rules").TextHighlightRules,
      n = function () {
        (this.$rules = {
          start: [
            {
      ...
      d.inherits(i, p),
        function () {
          (this.getFoldWidgetRange = function (s, e, t) {
            ...
            if (-1 != a && "#" == i[a]) {
              for (
                var o = i.length, r = s.getLength(), c = t, m = t;
                ++t < r;

              ) {
                var l = (i = s.getLine(t)).search(p);
                if (-1 != l) {
                  if ("#" != i[l]) break;
                  m = t;
                }
              ...
              if (m > c) {
                var f = s.getLine(m).length;
                return new n(c, o, m, f);
              }
            }
          }),
            (this.getFoldWidget = function (s, e, t) {
              ...
              if (-1 == p)
                return (
                  (s.foldWidgets[t - 1] = -1 != a && a < o ? "start" : ""), ""
                );
              if (-1 == a) {
                if (p == o && "#" == d[p] && "#" == n[p])
                  return (
                ...
                return (
                  (s.foldWidgets[t - 1] = "start"),
                  (s.foldWidgets[t + 1] = ""),
                  ""
                );
              return (
                (s.foldWidgets[t - 1] = -1 != a && a < p ? "start" : ""),
                p < o ? "start" : ""
              );
            });
        }.call(i.prototype);
  ...
  ace.define(
    ...
    function (s, e, t) {
      ...
      var d = s("../lib/oop"),
        p = s("./text").Mode,
        n = s("./assembly_x86_highlight_rules").AssemblyX86HighlightRules,
        i = s("./folding/coffee").FoldMode,
        a = function () {
  ...
  ace.require(["ace/mode/assembly_x86"], function (s) {
