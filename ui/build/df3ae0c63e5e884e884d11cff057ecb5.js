ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        i = function (e, t) {
          ...
          this.embedRules(new a({ jsx: !1 }).getRules(), "ejs-", [
            { token: "markup.list.meta.tag", regex: "-?" + t, next: "pop" },
            { token: "comment", regex: "//.*?" + t, next: "pop" },
          ]),
            this.normalizeRules();
        };
      r.inherits(i, o), (t.EjsHighlightRules = i);
      r = e("../lib/oop");
      var s = e("./html").Mode,
        l = e("./javascript").Mode,
        c = e("./css").Mode,
        u =
          ...
          function () {
            s.call(this),
              ...
              this.createModeDelegates({ "js-": l, "css-": c, "ejs-": l });
          });
      r.inherits(u, s),
        function () {
  ...
  ace.require(["ace/mode/ejs"], function (e) {
