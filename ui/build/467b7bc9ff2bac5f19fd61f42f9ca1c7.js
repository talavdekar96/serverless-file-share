ace.define(
  ...
  ace.define(
    ...
    function (e, t, r) {
      "use strict";
      var o = e("../lib/oop"),
        n = e("./doc_comment_highlight_rules").DocCommentHighlightRules,
        ...
        a = function () {
          ...
          (this.$rules = {
            ...
            this.embedRules(n, "doc-", [n.getEndRule("start")]),
            this.normalizeRules();
        };
      o.inherits(a, i), (t.JavaHighlightRules = a);
    }
  ),
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../lib/oop"),
        ...
        l = "[a-zA-Z\\$_\xa1-\uffff][a-zA-Z\\d\\$_\xa1-\uffff]*",
        s = "[a-zA-Z\\$_\xa1-\uffff][\\.a-zA-Z\\d\\$_\xa1-\uffff]*",
        c = function () {
          var e,
            t = this.createKeywordMapper(
              {
                "variable.language": "this",
                keyword:
      ...
      o.inherits(c, n), (t.DroolsHighlightRules = c);
    }
  ),
  ace.define(
        ...
        function () {
          (this.foldingStartMarker = /\b(rule|declare|query|when|then)\b/),
            ...
            (this.getFoldWidgetRange = function (e, t, r) {
              var o = e.getLine(r),
                i = o.match(this.foldingStartMarker);
              if (i) {
                i.index;
                if (i[1]) {
                  var l = { row: r, column: o.length },
                    s = new a(e, l.row, l.column),
                    c = "end",
                    d = s.getCurrentToken();
                  for ("when" == d.value && (c = "then"); d; ) {
                    if (d.value == c)
                      return n.fromPoints(l, {
                        row: s.getCurrentTokenRow(),
                        column: s.getCurrentTokenColumn(),
                      });
                    d = s.stepForward();
                  }
                }
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../lib/oop"),
        n = e("./text").Mode,
        i = e("./drools_highlight_rules").DroolsHighlightRules,
        a = e("./folding/drools").FoldMode,
        l = function () {
  ...
  ace.require(["ace/mode/drools"], function (e) {
