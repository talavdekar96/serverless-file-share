ace.define(
      ...
      var o = e("../lib/oop"),
        ...
        i = function () {
            ...
            (this.$rules.tag[2].token = function (e, t) {
              return [
                "meta.tag.punctuation." +
                  ("<" == e ? "" : "end-") +
                  "tag-open.xml",
                ("cf" == t.slice(0, 2) ? "keyword" : "meta.tag") +
                  ".tag-name.xml",
              ];
            });
          ...
          this.embedRules(
            {
              cfmlComment: [
                ...
                { regex: "---\x3e", token: "comment.end", next: "pop" },
                { defaultToken: "comment" },
              ],
            },
            "",
          ...
          e.forEach(function (e) {
            ...
            this.embedTagRules(
              new r({ jsx: !1 }).getRules(),
              "cfjs-",
              "cfscript"
            ),
            this.normalizeRules();
        };
      o.inherits(i, a), (t.ColdfusionHighlightRules = i);
    }
  ),
  ace.define(
    "ace/mode/coldfusion",
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("../lib/lang"),
        a = e("./html").Mode,
        i = e("./coldfusion_highlight_rules").ColdfusionHighlightRules,
        s =
        ...
        l = function () {
          a.call(this), (this.HighlightRules = i);
        };
      o.inherits(l, a),
        function () {
          (this.voidElements = o.mixin(r.arrayToMap(s), this.voidElements)),
            (this.getNextLineIndent = function (e, t, n) {
              return this.$getIndent(t);
            }),
  ...
  ace.require(["ace/mode/coldfusion"], function (e) {
