ace.define(
  ...
  function (e, t, o) {
    ...
    r.inherits(p, n), (t.CssHighlightRules = p);
  }
),
  ace.define(
    ...
    function (e, t, o) {
      ...
      var r = e("../lib/oop"),
        ...
        a = function () {
          var e =
            ...
            t = e.split("|"),
            o = i.supportType.split("|"),
            r = this.createKeywordMapper(
              {
                "support.constant": i.supportConstant,
                keyword: e,
                "support.constant.color": i.supportConstantColor,
                "support.constant.fonts": i.supportConstantFonts,
              },
              "identifier",
              !0
            ),
          ...
          (this.$rules = {
            start: [
              ...
              {
                token: function (e, t) {
                  return o.indexOf(e.toLowerCase()) > -1
      ...
      r.inherits(a, n), (t.LessHighlightRules = a);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, o) {
      ...
      var r = e("../../lib/oop"),
        ...
        a = function () {
          this.inherit(n),
            this.add("colon", "insertion", function (e, t, o, r, n) {
              if (":" === n && o.selection.isEmpty()) {
                var a = o.getCursorPosition(),
                  s = new i(r, a.row, a.column),
                  l = s.getCurrentToken();
                if (
                  (l && l.value.match(/\s+/) && (l = s.stepBackward()),
                  l && "support.type" === l.type)
                ) {
                  var d = r.doc.getLine(a.row);
                  if (":" === d.substring(a.column, a.column + 1))
                    return { text: "", selection: [1, 1] };
                  if (/^(\s+[^;]|\s*$)/.test(d.substring(a.column)))
                    return { text: ":;", selection: [1, 1] };
                }
              }
            }),
            this.add("colon", "deletion", function (e, t, o, r, n) {
              var a = r.doc.getTextRange(n);
              if (!n.isMultiLine() && ":" === a) {
                var s = o.getCursorPosition(),
                  l = new i(r, s.row, s.column),
                  d = l.getCurrentToken();
                if (
                  (d && d.value.match(/\s+/) && (d = l.stepBackward()),
                  d && "support.type" === d.type)
                )
                  if (
                    ";" ===
                    r.doc
            ...
            this.add("semicolon", "insertion", function (e, t, o, r, n) {
              if (";" === n && o.selection.isEmpty()) {
            ...
            this.add("!important", "insertion", function (e, t, o, r, n) {
              if ("!" === n && o.selection.isEmpty()) {
                var i = o.getCursorPosition(),
                  a = r.doc.getLine(i.row);
                if (/^\s*(;|}|$)/.test(a.substring(i.column)))
                  return { text: "!important", selection: [10, 10] };
              }
            });
        };
      r.inherits(a, n), (t.CssBehaviour = a);
    }
  ),
  ace.define(
        ...
        (this.completionsDefined = !1),
            ...
            if (document) {
              ...
              for (var t in e)
                if ("string" === typeof e[t]) {
                  var o = t.replace(/[A-Z]/g, function (e) {
          ...
          (this.getCompletions = function (e, t, o, r) {
            if (
              ...
              var n = t.getLine(o.row).substr(0, o.column),
                i = /\([^)]*$/.test(n);
              return (
                ...
                /:[^;]+$/.test(n)
                  ...
                  : this.getPropertyCompletions(e, t, o, r, i)
              );
            }
            return [];
          }),
          (this.getPropertyCompletions = function (e, t, o, n, i) {
            return (
              (i = i || !1),
          ...
          (this.getPropertyValueCompletions = function (e, t, o, n) {
            var i = t.getLine(o.row).substr(0, o.column),
              a = (/([\w\-]+):[^:]*$/.exec(i) || {})[1];
            if (!a) return [];
            var s = [];
            return (
              a in r && "object" === typeof r[a] && (s = Object.keys(r[a])),
              s.map(function (e) {
                return {
                  caption: e,
                  snippet: e,
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, o, r) {
              ...
              if ((n = i.match(this.foldingStartMarker))) {
                ...
                var s = e.getCommentFoldRange(o, a + n[0].length, 1);
                return (
                  s &&
                    !s.isMultiLine() &&
                    (r
                      ? (s = this.getSectionRange(e, o))
                      : "all" != t && (s = null)),
                  s
                );
              }
            ...
            (this.getCommentRegionBlock = function (e, t, o) {
              for (
                ...
                t = e.getLine(o);
                var d = s.exec(t);
                if (d && (d[1] ? l-- : l++, !l)) break;
              }
              if (o > a) return new n(a, r, o, t.length);
            });
        }.call(a.prototype);
    }
  ),
      ...
      r.inherits(c, n),
        function () {
          (this.lineCommentStart = "//"),
            ...
            (this.getCompletions = function (e, t, o, r) {
              return this.$completer.getCompletions("ruleset", t, o, r);
            }),
  ...
  ace.require(["ace/mode/less"], function (e) {
