ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        ...
        s = function () {
          i.call(this);
          var e = r.arrayToMap("true|false|null".split("|")),
            t = r.arrayToMap(
            ...
            n = r.arrayToMap("$contentRoot|$foreach".split("|")),
            o = r.arrayToMap(
              "#set|#macro|#include|#parse|#if|#elseif|#else|#foreach|#break|#end|#stop".split(
                "|"
              )
            );
          for (var a in (this.$rules.start.push(
            { token: "comment", regex: "##.*$" },
            ...
            { token: "constant.language.boolean", regex: "(?:true|false)\\b" },
            {
              token: function (r) {
                return o.hasOwnProperty(r)
                  ...
                  : n.hasOwnProperty(r)
                  ? "variable.language"
                  : t.hasOwnProperty(r) || t.hasOwnProperty(r.substring(1))
                  ? "support.function"
                  : "debugger" == r
                  ? "invalid.deprecated"
                  : r.match(/^(\$[a-zA-Z_][a-zA-Z0-9_]*)$/)
                  ? "variable"
                  : "identifier";
              },
          ...
          (this.$rules.vm_comment = [
            { token: "comment", regex: "\\*#|--\x3e", next: "start" },
            { defaultToken: "comment" },
          ]),
          (this.$rules.vm_start = [
      ...
      o.inherits(s, a), (t.VelocityHighlightRules = s);
    }
  ),
  ace.define(
      ...
      o.inherits(i, r),
        function () {
          (this.getFoldWidgetRange = function (e, t, n) {
            ...
            if (-1 != s && "##" == i[s]) {
              for (
                var l = i.length, c = e.getLength(), u = n, d = n;
                ++n < c;

              ) {
                var g = (i = e.getLine(n)).search(r);
                if (-1 != g) {
                  if ("##" != i[g]) break;
                  d = n;
                }
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./html").Mode,
        a = e("./velocity_highlight_rules").VelocityHighlightRules,
        i = e("./folding/velocity").FoldMode,
        s = function () {
          r.call(this),
            (this.HighlightRules = a),
  ...
  ace.require(["ace/mode/velocity"], function (e) {
