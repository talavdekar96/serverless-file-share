ace.define(
  ...
  ace.define(
    ...
    function (a, r, e) {
      (r.isDark = !0),
        (r.cssClass = "ace-gruvbox-dark-hard"),
        (r.cssText = a("./gruvbox_dark_hard-css")),
        a("../lib/dom").importCssString(r.cssText, r.cssClass);
    }
  ),
  ace.require(["ace/theme/gruvbox_dark_hard"], function (a) {
