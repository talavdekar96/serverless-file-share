ace.define(
      ...
      n.inherits(a, o),
        function () {
          (this.getFoldWidgetRange = function (e, i, t) {
            ...
            if (-1 != l && "#" == a[l]) {
              for (
                var d = a.length, c = e.getLength(), u = t, s = t;
                ++t < c;

              ) {
                var x = (a = e.getLine(t)).search(o);
                if (-1 != x) {
                  if ("#" != a[x]) break;
                  s = t;
                }
              ...
              if (s > u) {
                var p = e.getLine(s).length;
                return new r(u, d, s, p);
              }
            }
          }),
            (this.getFoldWidget = function (e, i, t) {
              ...
              if (-1 == o)
                return (
                  (e.foldWidgets[t - 1] = -1 != l && l < d ? "start" : ""), ""
                );
              if (-1 == l) {
                if (o == d && "#" == n[o] && "#" == r[o])
                  return (
              ...
              return (
                (e.foldWidgets[t - 1] = -1 != l && l < o ? "start" : ""),
                o < d ? "start" : ""
              );
            });
        }.call(a.prototype);
  ...
  ace.define(
    ...
    function (e, i, t) {
      ...
      var n = e("../lib/oop"),
        o = e("./text").Mode,
        r = e("./elixir_highlight_rules").ElixirHighlightRules,
  ...
  ace.require(["ace/mode/elixir"], function (e) {
