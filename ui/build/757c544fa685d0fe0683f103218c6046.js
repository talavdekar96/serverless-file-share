ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
            ...
            t = [
              {
                ...
                onMatch: function (e, t, n, r) {
                  ...
                  if (((this.next = ""), l && o[l])) {
                    var u = o[l].getTokenizer().getLineTokens(e, a.slice(0));
      ...
      r.inherits(c, i), (t.MarkdownHighlightRules = c);
    }
  ),
  ace.define(
        ...
        this.add("string_dquotes", "insertion", function (e, t, n, o, r) {
          if ('"' == r || "'" == r) {
            ...
            var c = n.getCursorPosition(),
              ...
              d = new a(o, c.row, c.column),
              g = d.getCurrentToken();
            if (u == s && (i(g, "attribute-value") || i(g, "string")))
              return { text: "", selection: [1, 1] };
            ...
            var p = !u || u.match(/\s/);
            if (
              (i(g, "attribute-equals") && (p || ">" == u)) ||
              (i(g, "decl-attribute-equals") && (p || "?" == u))
            )
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        s = function () {
          ...
          (this.$rules = {
            start: [
              ...
              { token: "support.function", regex: r },
      ...
      o.inherits(s, r), (t.ShHighlightRules = s);
    }
  ),
  ace.define(
    "ace/mode/sh",
    ...
    function (e, t, n) {
      ...
      o.inherits(l, r),
        function () {
          ...
          (this.checkOutdent = function (t, n, o) {
            if ("\r\n" !== o && "\r" !== o && "\n" !== o) return !1;
            ...
            (this.autoOutdent = function (e, t, n) {
              ...
              var o = this.$getIndent(t.getLine(n)),
                r = t.getTabString();
              o.slice(-r.length) == r &&
                t.remove(new i(n, o.length - r.length, n, o.length));
            }),
            (this.$id = "ace/mode/sh"),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      o.inherits(u, a),
        function () {
          (this.voidElements = r.arrayToMap([])),
            (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
            (this.createWorker = function (e) {
          ...
          (this.type = "text"),
            ...
            (this.getNextLineIndent = function (e, t, n) {
              if ("listblock" == e) {
                ...
                if (!o) return "";
                var r = o[2];
                return r || (r = parseInt(o[3], 10) + 1 + "."), o[1] + r + o[4];
              }
              return this.$getIndent(t);
            }),
  ...
  ace.require(["ace/mode/markdown"], function (e) {
