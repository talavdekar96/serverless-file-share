ace.define(
  ...
  function (e, t, i) {
    ...
    (r.metaData = { name: "Prisma", scopeName: "source.prisma" }),
      n.inherits(r, o),
      (t.PrismaHighlightRules = r);
  }
),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, i) {
      ...
      var n = e("../lib/oop"),
        o = e("./text").Mode,
        r = e("./prisma_highlight_rules").PrismaHighlightRules,
  ...
  ace.require(["ace/mode/prisma"], function (e) {
