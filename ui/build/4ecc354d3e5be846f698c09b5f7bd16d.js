ace.define(
    ...
    r.inherits(i, a),
      function () {
        (this.pushRule = function (e) {
          ...
          return {
            regex: e.regex,
            onMatch: function (t, n, r, a) {
              if ((0 === r.length && r.push(n), Array.isArray(e.next)))
                for (var i = 0; i < e.next.length; i++) r.push(e.next[i]);
              else r.push(e.next);
      ...
      (t.CsoundPreprocessorHighlightRules = i);
  }
),
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(i, a), (t.CsoundScoreHighlightRules = i);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(i, a), (t.LuaHighlightRules = i);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/lang"),
        ...
        c = function (e) {
          ...
          a.splice(1, 0, {
            ...
            a.push(
              ...
              { token: "support.variable.csound", regex: /\bp\d+\b/ },
              {
                ...
                onMatch: function (e, r, a, i) {
                  var o,
                    s = e.split(this.splitRegex),
                    l = s[1];
                  return (
                    t.hasOwnProperty(l)
                      ? (o = "support.function.csound")
                      : n.hasOwnProperty(l) &&
                        (o = "invalid.deprecated.csound"),
                    o
                      ? s[2]
                        ? [
                            { type: o, value: l },
          ...
          this.embedRules(c.getRules(), c.embeddedRulePrefix, p),
            this.embedRules(l, "python-", p),
            this.embedRules(s, "lua-", p),
            this.normalizeRules();
        };
      a.inherits(c, i), (t.CsoundOrchestraHighlightRules = c);
    }
  ),
  ace.define(
  ...
  ace.require(["ace/mode/csound_orchestra"], function (e) {
