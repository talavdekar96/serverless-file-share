ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        a = function (e) {
          var t = new o({ jsx: 1 == (e && e.jsx) }).getRules();
          (t.no_regex = [
            {
              token: ["storage.type", "text", "entity.name.function.ts"],
              regex:
                "(function)(\\s+)([a-zA-Z0-9$_\xa1-\uffff][a-zA-Z0-9d$_\xa1-\uffff]*)",
            },
            {
              token: "keyword",
              regex:
      ...
      r.inherits(a, o), (t.TypeScriptHighlightRules = a);
    }
  ),
  ace.define(
    "ace/mode/typescript",
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./javascript").Mode,
        a = e("./typescript_highlight_rules").TypeScriptHighlightRules,
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./typescript").Mode,
        a = function () {
          o.call(this), (this.$highlightRuleConfig = { jsx: !0 });
        };
      r.inherits(a, o),
        function () {
  ...
  ace.require(["ace/mode/tsx"], function (e) {
