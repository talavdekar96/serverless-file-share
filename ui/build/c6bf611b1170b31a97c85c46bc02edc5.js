ace.define(
  ...
  function (e, t, n) {
    ...
    i.inherits(o, r), (t.AdaHighlightRules = o);
  }
),
  ace.define(
    "ace/mode/ada",
    ...
    function (e, t, n) {
      ...
      var i = e("../lib/oop"),
        r = e("./text").Mode,
        o = e("./ada_highlight_rules").AdaHighlightRules,
        a = e("../range").Range,
        s = function () {
        ...
        function () {
          (this.lineCommentStart = "--"),
            (this.getNextLineIndent = function (e, t, n) {
              ...
              "start" == e &&
                t.match(/^.*(begin|loop|then|is|do)\s*$/) &&
                (i += n);
              return i;
            }),
            (this.checkOutdent = function (e, t, n) {
              return !!(t + n).match(/^\s*(begin|end)$/);
            }),
            (this.autoOutdent = function (e, t, n) {
              var i = t.getLine(n),
                r = t.getLine(n - 1),
                o = this.$getIndent(r).length;
              this.$getIndent(i).length <= o ||
                t.outdentRows(new a(n, 0, n + 2, 0));
            }),
  ...
  ace.require(["ace/mode/ada"], function (e) {
