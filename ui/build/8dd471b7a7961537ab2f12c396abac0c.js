ace.define(
  ...
  function (e, t, n) {
    "use strict";
    var c = e("../keyboard/hash_handler").HashHandler;
    function i(e, t, n) {
      var c = e.selection,
        i = c.lead.row,
        r = c.lead.column,
        l = e.session.getLine(i);
      if (!l[r + t]) {
        var a =
      ...
      for (-1 == t && r--; l[r]; ) {
        ...
        if (/w[s_oW]|_[sWo]|o[s_wW]|s[W]|W[so]/.test(o)) break;
      }
      function d(e) {
        return e
          ? /\s/.test(e)
      ...
      -1 == t && r++,
        n ? e.selection.moveCursorTo(i, r) : e.selection.moveTo(i, r);
    }
    (t.handler = new c()),
      t.handler.addCommands([
        ...
        },
        {
          ...
          exec: function (e) {
            var t = e.selection.getCursor();
            e.session.remove({ start: t, end: { row: t.row, column: 1 / 0 } });
          },
          multiSelectAction: "forEach",
          scrollIntoView: "cursor",
        },
