ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              if (
                ...
                return "";
              var a = this._getFoldWidgetBase(e, t, n);
              return !a && this.startRegionRe.test(o) ? "start" : a;
            }),
            (this.getFoldWidgetRange = function (e, t, n, o) {
              var a,
                l = e.getLine(n);
              if (this.startRegionRe.test(l))
                return this.getCommentRegionBlock(e, l, n);
              if ((a = l.match(this.foldingStartMarker))) {
                var r = a.index;
                if (a[1]) return this.openingBracketBlock(e, a[1], n, r);
                var i = e.getCommentFoldRange(n, r + a[0].length, 1);
                return (
                  i &&
                    !i.isMultiLine() &&
                    (o
                      ? (i = this.getSectionRange(e, n))
                      : "all" != t && (i = null)),
                  i
                );
              }
              if ("markbegin" !== t && (a = l.match(this.foldingStopMarker))) {
                r = a.index + a[0].length;
                return a[1]
                  ? this.closingBracketBlock(e, a[1], n, r)
            ...
            (this.getSectionRange = function (e, t) {
              for (
                ...
                var h = (n = e.getLine(t)).search(/\S/);
                if (-1 !== h) {
                  if (o > h) break;
                  var c = this.getFoldWidgetRange(e, "all", t);
                  if (c) {
                    if (c.start.row <= l) break;
              ...
              return new a(l, r, i, e.getLine(i).length);
            }),
            (this.getCommentRegionBlock = function (e, t, n) {
              ...
              if (n > r) return new a(r, o, n, t.length);
            });
        }.call(r.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        a = e("./text").Mode,
        l = e("./haskell_highlight_rules").HaskellHighlightRules,
  ...
  ace.require(["ace/mode/haskell"], function (e) {
