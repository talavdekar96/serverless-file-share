ace.define(
  ...
  function (e, t, i) {
    ...
    o.inherits(n, r), (t.AppleScriptHighlightRules = n);
  }
),
  ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, i, o) {
              ...
              if (this.startRegionRe.test(n))
                return this.getCommentRegionBlock(e, n, i);
              ...
              if ("markbegin" !== t && (r = n.match(this.foldingStopMarker))) {
                ...
                return r[1]
                  ? this.closingBracketBlock(e, r[1], i, a)
            ...
            (this.getCommentRegionBlock = function (e, t, i) {
              ...
              if (i > a) return new r(a, o, i, t.length);
            });
        }.call(a.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, i) {
      ...
      var o = e("../lib/oop"),
        r = e("./text").Mode,
        n = e("./applescript_highlight_rules").AppleScriptHighlightRules,
  ...
  ace.require(["ace/mode/applescript"], function (e) {
