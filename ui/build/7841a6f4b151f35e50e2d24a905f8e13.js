ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, o, r) {
              ...
              if (this.startRegionRe.test(a))
                return this.getCommentRegionBlock(e, a, o);
              if ((n = a.match(this.foldingStartMarker))) {
                var i = n.index;
                if (n[1]) return this.openingBracketBlock(e, n[1], o, i);
                var s = e.getCommentFoldRange(o, i + n[0].length, 1);
                return (
                  s &&
                    !s.isMultiLine() &&
                    (r
              ...
              if ("markbegin" !== t && (n = a.match(this.foldingStopMarker))) {
                i = n.index + n[0].length;
                return n[1]
                  ? this.closingBracketBlock(e, n[1], o, i)
                  : e.getCommentFoldRange(o, i, -1);
              }
            }),
            (this.getSectionRange = function (e, t) {
              ...
              return new n(a, i, s, e.getLine(s).length);
            }),
            (this.getCommentRegionBlock = function (e, t, o) {
              ...
              if (o > i) return new n(i, r, o, t.length);
            });
        }.call(i.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, o) {
      ...
      var r = e("../lib/oop"),
        n = e("./text").Mode,
        a = e("./zeek_highlight_rules").ZeekHighlightRules,
        i = e("./folding/cstyle").FoldMode,
        s = function () {
          (this.HighlightRules = a), (this.foldingRules = new i());
        };
      r.inherits(s, n),
        function () {
  ...
  ace.require(["ace/mode/zeek"], function (e) {
