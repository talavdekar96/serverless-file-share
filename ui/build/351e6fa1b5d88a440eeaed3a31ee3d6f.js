ace.define(
  ...
  ace.define(
    ...
    function (e, t, r) {
      var n = e("../lib/oop"),
        ...
        a = e("./tex_highlight_rules").TexHighlightRules,
        s = function () {
          var e = o.arrayToMap(
          ...
          for (
            var r = new a("comment").getRules(), n = 0;
            n < r.start.length;
            n++
          )
            r.start[n].token += ".virtual-comment";
          this.addRules(r, "rd-"),
  ...
  ace.define(
    ...
    function (e, t, r) {
      "use strict";
      var n = e("../unicode"),
        o = (e("../range").Range, e("../lib/oop")),
        i = e("./text").Mode,
        a =
          (e("./text_highlight_rules").TextHighlightRules,
          e("./r_highlight_rules").RHighlightRules),
      ...
      o.inherits(g, i),
        function () {
          (this.lineCommentStart = "#"),
            (this.tokenRe = new RegExp("^[" + n.wordChars + "._]+", "g")),
  ...
  ace.require(["ace/mode/r"], function (e) {
