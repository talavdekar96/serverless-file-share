      ...
      N.inherits(O, T),
        function () {
          (this.getFoldWidgetRange = function (E, e, t) {
            ...
            if (-1 != R && "#" == O[R]) {
              for (
                var n = O.length, S = E.getLength(), r = t, o = t;
                ++t < S;

              ) {
                var i = (O = E.getLine(t)).search(T);
                if (-1 != i) {
                  if ("#" != O[i]) break;
                  o = t;
                }
              ...
              if (o > r) {
                var a = E.getLine(o).length;
                return new I(r, n, o, a);
              }
            }
          }),
            (this.getFoldWidget = function (E, e, t) {
              ...
              if (-1 == T)
                return (
                  (E.foldWidgets[t - 1] = -1 != R && R < n ? "start" : ""), ""
                );
              if (-1 == R) {
                if (T == n && "#" == N[T] && "#" == I[T])
                  return (
              ...
              return (
                (E.foldWidgets[t - 1] = -1 != R && R < T ? "start" : ""),
                T < n ? "start" : ""
              );
            });
        }.call(O.prototype);
