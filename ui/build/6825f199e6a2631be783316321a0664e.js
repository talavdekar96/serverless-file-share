ace.define(
  ...
  function (e, t, n) {
    ...
    i.inherits(o, r), (t.SchemeHighlightRules = o);
  }
),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var i = e("../lib/oop"),
        ...
        s = e("./matching_parens_outdent").MatchingParensOutdent,
        a = function () {
        ...
        function () {
          (this.lineCommentStart = ";"),
            ...
            (this.$calculateIndent = function (e, t) {
              for (
                var n, i, r = this.$getIndent(e), o = 0, s = e.length - 1;
                s >= 0 &&
                ("(" === (i = e[s])
                  ? (o--, (n = !0))
                  : "(" === i || "[" === i || "{" === i
              ...
              if (!(o < 0 && n))
                return o < 0 && !n
                  ? this.$toIndent(e.substring(0, s + 1))
                  : o > 0
                  ? (r = r.substring(0, r.length - t.length))
                  : r;
              for (var a = (s += 1), c = ""; ; ) {
                if (" " === (i = e[s]) || "\t" === i)
                  return -1 !== this.minorIndentFunctions.indexOf(c)
                    ? this.$toIndent(e.substring(0, a - 1) + t)
                    : this.$toIndent(e.substring(0, s + 1));
                if (void 0 === i)
                  return this.$toIndent(e.substring(0, a - 1) + t);
                (c += e[s]), s++;
              }
            }),
  ...
  ace.require(["ace/mode/scheme"], function (e) {
