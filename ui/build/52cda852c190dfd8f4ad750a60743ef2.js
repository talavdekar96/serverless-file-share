ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, o, n) {
              ...
              if ((r = i.match(this.foldingStartMarker))) {
                ...
                var l = e.getCommentFoldRange(o, a + r[0].length, 1);
                return (
                  l &&
                    !l.isMultiLine() &&
                    (n
            ...
            (this.getCommentRegionBlock = function (e, t, o) {
              for (
                ...
                t = e.getLine(o);
                var s = l.exec(t);
                if (s && (s[1] ? g-- : g++, !g)) break;
              }
              if (o > a) return new r(a, n, o, t.length);
            });
        }.call(a.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, o) {
      ...
      var n = e("../lib/oop"),
        r = e("./text").Mode,
        i = e("./prolog_highlight_rules").PrologHighlightRules,
  ...
  ace.require(["ace/mode/prolog"], function (e) {
