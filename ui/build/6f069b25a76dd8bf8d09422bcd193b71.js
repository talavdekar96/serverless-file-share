ace.define(
      ...
      r.inherits(i, o),
        function () {
          (this.getFoldWidgetRange = function (e, t, n) {
            ...
            if (-1 != s && "#" == i[s]) {
              for (
                var g = i.length, c = e.getLength(), u = n, f = n;
                ++n < c;

              ) {
                var l = (i = e.getLine(n)).search(o);
                if (-1 != l) {
                  if ("#" != i[l]) break;
                  f = n;
                }
              ...
              if (f > u) {
                var d = e.getLine(f).length;
                return new a(u, g, f, d);
              }
            }
          }),
  ...
  ace.require(["ace/mode/coffee"], function (e) {
