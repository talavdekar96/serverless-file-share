ace.define(
  ...
  function (e, t, i) {
    ...
    n.inherits(r, o), (t.SqlHighlightRules = r);
  }
),
  ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, i, n) {
              ...
              if ((o = r.match(this.foldingStartMarker))) {
                ...
                var l = e.getCommentFoldRange(i, s + o[0].length, 1);
                return (
                  l &&
                    !l.isMultiLine() &&
                    (n
              ...
              if ("markbegin" !== t && (o = r.match(this.foldingStopMarker))) {
                ...
                return o[1]
                  ? this.closingBracketBlock(e, o[1], i, s)
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new o(r, s, l, e.getLine(l).length);
            }),
            (this.getCommentRegionBlock = function (e, t, i) {
              ...
              if (i > s) return new o(s, n, i, t.length);
            });
        }.call(s.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, i) {
      ...
      n.inherits(r, o), function () {}.call(r.prototype);
    }
  ),
  ace.define(
    "ace/mode/sql",
    ...
    function (e, t, i) {
      ...
      var n = e("../lib/oop"),
        o = e("./text").Mode,
        r = e("./sql_highlight_rules").SqlHighlightRules,
        s = e("./folding/sql").FoldMode,
        l = function () {
  ...
  ace.require(["ace/mode/sql"], function (e) {
