ace.define(
        ...
        function () {
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, n, t) {
              ...
              return !a && this.startRegionRe.test(r) ? "start" : a;
            }),
            (this.getFoldWidgetRange = function (e, n, t, r) {
              var a,
                i = e.getLine(t);
              if (this.startRegionRe.test(i))
                return this.getCommentRegionBlock(e, i, t);
              if ((a = i.match(this.foldingStartMarker))) {
                var o = a.index;
                if (a[1]) return this.openingBracketBlock(e, a[1], t, o);
                var g = e.getCommentFoldRange(t, o + a[0].length, 1);
                return (
                  g &&
                    !g.isMultiLine() &&
                    (r
              ...
              if ("markbegin" !== n && (a = i.match(this.foldingStopMarker))) {
                o = a.index + a[0].length;
                return a[1]
                  ? this.closingBracketBlock(e, a[1], t, o)
            ...
            (this.getSectionRange = function (e, n) {
              for (
                ...
                var c = (t = e.getLine(n)).search(/\S/);
                if (-1 !== c) {
                  if (r > c) break;
                  var s = this.getFoldWidgetRange(e, "all", n);
                  if (s) {
                    if (s.start.row <= i) break;
                    if (s.isMultiLine()) n = s.end.row;
                    else if (r == c) break;
                  }
                  g = n;
                }
              }
              return new a(i, o, g, e.getLine(g).length);
            }),
            (this.getCommentRegionBlock = function (e, n, t) {
              ...
              if (t > o) return new a(o, r, t, n.length);
            });
        }.call(o.prototype);
    }
  ),
  ace.define(
    ...
    function (e, n, t) {
      ...
      var r = e("../lib/oop"),
        a = e("./text").Mode,
        i = e("./erlang_highlight_rules").ErlangHighlightRules,
  ...
  ace.require(["ace/mode/erlang"], function (e) {
