ace.define(
  ...
  ace.define(
    ...
    function (e, t, r) {
      var a = e("../lib/oop"),
        ...
        o = function () {
          var e = this.createKeywordMapper(
            {
              "support.function": [
                "rank|coalesce|ifnull|isnull|nvl",
      ...
      a.inherits(o, n), (t.MysqlHighlightRules = o);
    }
  ),
  ace.define(
    "ace/mode/mysql",
    ...
    function (e, t, r) {
      var a = e("../lib/oop"),
        i = e("../mode/text").Mode,
        n = e("./mysql_highlight_rules").MysqlHighlightRules,
        o = function () {
  ...
  ace.require(["ace/mode/mysql"], function (e) {
