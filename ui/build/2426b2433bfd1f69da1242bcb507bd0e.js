ace.define(
  ...
  function (e, t, n) {
    ...
    var o = e("../lib/oop"),
      ...
      i = function () {
        ...
        (this.$rules = {
          ...
          math: [
            { token: "constant.float", regex: l },
            { token: "constant.float", regex: s },
            { token: "constant.integer", regex: i },
          ],
    ...
    o.inherits(i, r), (t.NimHighlightRules = i);
  }
),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./text").Mode,
        i = e("./nim_highlight_rules").NimHighlightRules,
  ...
  ace.require(["ace/mode/nim"], function (e) {
