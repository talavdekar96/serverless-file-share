ace.define(
        ...
        function () {
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, t, o) {
              ...
              return !i && this.startRegionRe.test(a) ? "start" : i;
            }),
            (this.getFoldWidgetRange = function (e, t, o, a) {
              var i,
                r = e.getLine(o);
              ...
              if ((i = r.match(this.foldingStartMarker))) {
                var n = i.index;
                if (i[1]) return this.openingBracketBlock(e, i[1], o, n);
                var c = e.getCommentFoldRange(o, n + i[0].length, 1);
                return (
                  c &&
                    !c.isMultiLine() &&
                    (a
                      ? (c = this.getSectionRange(e, o))
                      : "all" != t && (c = null)),
                  c
                );
              }
              if ("markbegin" !== t && (i = r.match(this.foldingStopMarker))) {
                ...
                return i[1]
                  ? this.closingBracketBlock(e, i[1], o, n)
                  : e.getCommentFoldRange(o, n, -1);
              }
            }),
            (this.getSectionRange = function (e, t) {
              ...
              return new i(r, n, c, e.getLine(c).length);
            }),
            (this.getCommentRegionBlock = function (e, t, o) {
              ...
              if (o > n) return new i(n, a, o, t.length);
            });
        }.call(n.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, o) {
      ...
      var a = e("../lib/oop"),
        i = e("./text").Mode,
        r = e("./apache_conf_highlight_rules").ApacheConfHighlightRules,
  ...
  ace.require(["ace/mode/apache_conf"], function (e) {
