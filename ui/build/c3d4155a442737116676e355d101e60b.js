ace.define(
  ...
  ace.define(
    ...
    function (e, t, r) {
      "use strict";
      var o = e("../lib/oop"),
        n = (e("../lib/lang"), e("./scss_highlight_rules").ScssHighlightRules),
        i = function () {
          n.call(this);
            ...
            (this.$rules.comment = [
              {
                ...
                onMatch: function (e, t, r) {
                  return (
                    -1 === r[1] && (r[1] = Math.max(r[2], e.length - 1)),
                    e.length <= r[1]
                      ? (r.shift(),
                        r.shift(),
                        r.shift(),
      ...
      o.inherits(i, n), (t.SassHighlightRules = i);
    }
  ),
  ace.define(
      ...
      o.inherits(a, n),
        function () {
          (this.getFoldWidgetRange = function (e, t, r) {
            ...
            if (-1 != s && "#" == a[s]) {
              for (
                var l = a.length, d = e.getLength(), c = r, g = r;
                ++r < d;

              ) {
                var u = (a = e.getLine(r)).search(n);
                if (-1 != u) {
                  if ("#" != a[u]) break;
                  g = r;
                }
            ...
            (this.getFoldWidget = function (e, t, r) {
              ...
              if (-1 == n)
                return (
                  (e.foldWidgets[r - 1] = -1 != s && s < l ? "start" : ""), ""
                );
              if (-1 == s) {
                if (n == l && "#" == o[n] && "#" == i[n])
                  return (
              ...
              return (
                (e.foldWidgets[r - 1] = -1 != s && s < n ? "start" : ""),
                n < l ? "start" : ""
              );
            });
        }.call(a.prototype);
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../lib/oop"),
        n = e("./text").Mode,
        i = e("./sass_highlight_rules").SassHighlightRules,
  ...
  ace.require(["ace/mode/sass"], function (e) {
