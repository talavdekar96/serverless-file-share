ace.define(
  ...
  function (e, t, r) {
    ...
    o.inherits(a, i), (t.MELHighlightRules = a);
  }
),
  ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, t, r) {
              ...
              if (
                ...
                return "";
              var i = this._getFoldWidgetBase(e, t, r);
            ...
            (this.getFoldWidgetRange = function (e, t, r, o) {
              ...
              if ((i = a.match(this.foldingStartMarker))) {
                var n = i.index;
                if (i[1]) return this.openingBracketBlock(e, i[1], r, n);
                var l = e.getCommentFoldRange(r, n + i[0].length, 1);
                return (
                  l &&
                    !l.isMultiLine() &&
                    (o
                      ? (l = this.getSectionRange(e, r))
                      : "all" != t && (l = null)),
                  l
                );
              }
              if ("markbegin" !== t && (i = a.match(this.foldingStopMarker))) {
                ...
                return i[1]
                  ? this.closingBracketBlock(e, i[1], r, n)
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new i(a, n, l, e.getLine(l).length);
            }),
            (this.getCommentRegionBlock = function (e, t, r) {
              ...
              if (r > n) return new i(n, o, r, t.length);
            });
        }.call(n.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, r) {
      ...
      var o = e("../lib/oop"),
        i = e("./text").Mode,
        a = e("./mel_highlight_rules").MELHighlightRules,
  ...
  ace.require(["ace/mode/mel"], function (e) {
