ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(c, s), (t.c_cppHighlightRules = c);
    }
  ),
  ace.define(
      ...
      (function () {
        (this.checkOutdent = function (e, t) {
          ...
          (this.autoOutdent = function (e, t) {
            ...
            if (!n) return 0;
            var o = n[1].length,
              s = e.findMatchingBracket({ row: t, column: o });
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, n, r) {
              ...
              if ((o = s.match(this.foldingStartMarker))) {
                ...
                var c = e.getCommentFoldRange(n, i + o[0].length, 1);
                return (
                  c &&
                    !c.isMultiLine() &&
                    (r
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new o(s, i, c, e.getLine(c).length);
            }),
  ...
  ace.require(["ace/mode/c_cpp"], function (e) {
