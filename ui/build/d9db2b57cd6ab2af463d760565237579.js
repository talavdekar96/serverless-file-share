ace.define(
      ...
      var s = function () {
        this.add("string_dquotes", "insertion", function (e, t, n, o, r) {
          if ('"' == r || "'" == r) {
            ...
            var m = !u || u.match(/\s/);
            if (
              (i(g, "attribute-equals") && (m || ">" == u)) ||
              (i(g, "decl-attribute-equals") && (m || "?" == u))
            )
          ...
          this.add("autoclosing", "insertion", function (e, t, n, o, r) {
            if (">" == r) {
              ...
              var p = c.value;
              if (
                (g == s.row && (p = p.substring(0, s.column - m)),
              ...
              if (c && -1 !== c.type.indexOf("tag-close")) {
                ...
                if (this.voidElements && !this.voidElements[u]) {
                  var g = o.getTokenAt(i.row, i.column + 1),
                    m = ((s = o.getLine(d)), this.$getIndent(s)),
                    p = m + o.getTabString();
                  return g && "</" === g.value
                    ? {
                        text: "\n" + p + "\n" + m,
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      o.inherits(i, a), (t.CSharpHighlightRules = i);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        ...
        a =
          ...
          e("./html_highlight_rules").HtmlHighlightRules),
        i = e("./csharp_highlight_rules").CSharpHighlightRules,
        s = function () {
          i.call(this);
          var e = "in-braces";
          this.$rules.start.unshift(
            {
              regex: "[\\[({]",
              onMatch: function (t, n, o) {
                var r = /razor-[^\-]+-/.exec(n)[0];
                return (
                  o.unshift(t),
                  o.unshift(r + e),
                  (this.next = r + e),
          ...
          var t = { "{": "}", "[": "]", "(": ")" };
          (this.$rules[e] = r.deepCopy(this.$rules.start)),
      ...
      var l = function () {
        ...
        this.embedRules(s, "razor-block-", [t], ["start"]),
          this.embedRules(
            s,
            "razor-short-",
            [{ token: "", regex: "(?=[^A-Za-z_\\.()\\[\\]])", next: "pop" }],
            ["start"]
          ),
          this.normalizeRules();
      };
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      e("../token_iterator").TokenIterator;
      var o = [
          "abstract",
          "as",
          "base",
        ...
        r = ["Html", "Model", "Url", "Layout"],
        a = function () {};
      (function () {
        (this.getCompletions = function (e, t, n, o) {
          return -1 == e.lastIndexOf("razor-short-start") &&
            -1 == e.lastIndexOf("razor-block-start")
            ? []
            : t.getTokenAt(n.row, n.column)
            ? -1 != e.lastIndexOf("razor-short-start")
              ? this.getShortStartCompletions(e, t, n, o)
              : -1 != e.lastIndexOf("razor-block-start")
              ? this.getKeywordCompletions(e, t, n, o)
              : void 0
            : [];
        }),
          (this.getShortStartCompletions = function (e, t, n, o) {
            return r.map(function (e) {
              return { value: e, meta: "keyword", score: 1e6 };
            });
          }),
          (this.getKeywordCompletions = function (e, t, n, a) {
            return r.concat(o).map(function (e) {
              return { value: e, meta: "keyword", score: 1e6 };
            });
          });
      }).call(a.prototype),
        (t.RazorCompletions = a);
    }
  ),
  ace.define(
    "ace/mode/razor",
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./html").Mode,
        a = e("./razor_highlight_rules").RazorHighlightRules,
        i = e("./razor_completions").RazorCompletions,
        s = e("./html_completions").HtmlCompletions,
        l = function () {
          r.call(this),
      ...
      o.inherits(l, r),
        function () {
          (this.getCompletions = function (e, t, n, o) {
            var r = this.$completer.getCompletions(e, t, n, o),
              a = this.$htmlCompleter.getCompletions(e, t, n, o);
            return r.concat(a);
          }),
            (this.createWorker = function (e) {
              return null;
  ...
  ace.require(["ace/mode/razor"], function (e) {
