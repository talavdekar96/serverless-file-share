ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(a, o), (t.JsonHighlightRules = a);
    }
  ),
  ace.define(
      ...
      var r = e("../lib/oop"),
        ...
        s = function () {
          ...
          (this.$rules = {
            ...
            this.embedRules(i, "json-", [
              { token: "string", regex: "\\$json\\$", next: "statement" },
            ]);
        };
      r.inherits(s, a), (t.RedshiftHighlightRules = s);
    }
  ),
  ace.define(
    "ace/mode/redshift",
    ...
    function (e, t, n) {
      var r = e("../lib/oop"),
        o = e("../mode/text").Mode,
        a = e("./redshift_highlight_rules").RedshiftHighlightRules,
        i = function () {
  ...
  ace.require(["ace/mode/redshift"], function (e) {
