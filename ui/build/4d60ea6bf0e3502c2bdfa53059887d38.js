ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        i = function () {
          var e = new o({ noES6: !0 }),
            ...
            r = function (e) {
              return {
                ...
                next: n(function (t, n) {
                  return (
                    0 === n.length && n.unshift(t), n.unshift(e.next), e.next
                  );
                }),
              };
            },
          ...
          for (var i = [], s = 0; s < this.$rules.no_regex.length; s++) {
            var g = this.$rules.no_regex[s];
            -1 != String(g.token).indexOf("paren") ||
              (g.next && !g.next.isContextAware) ||
              i.push(g);
          }
          (this.$rules.string_interp = [
            a({ token: "paren.rparen", regex: "\\}" }),
      ...
      r.inherits(i, a), (t.SJSHighlightRules = i);
    }
  ),
  ace.define(
    "ace/mode/sjs",
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./javascript").Mode,
        a = e("./sjs_highlight_rules").SJSHighlightRules,
        i = e("./matching_brace_outdent").MatchingBraceOutdent,
  ...
  ace.require(["ace/mode/sjs"], function (e) {
