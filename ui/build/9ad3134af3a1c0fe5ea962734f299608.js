ace.define(
  ...
  function (e, t, n) {
    ...
    r.inherits(i, o), (t.LuaHighlightRules = i);
  }
),
  ace.define(
        ...
        function () {
          (this.foldingStartMarker =
            ...
            (this.getFoldWidget = function (e, t, n) {
              var r = e.getLine(n),
                o = this.foldingStartMarker.test(r),
                i = this.foldingStopMarker.test(r);
              if (o && !i) {
                var a;
                if (
                  "then" == (a = r.match(this.foldingStartMarker))[1] &&
                  /\belseif\b/.test(r)
                )
                  return;
                if (a[1]) {
                  if ("keyword" === e.getTokenAt(n, a.index + 1).type)
                    return "start";
                } else {
                  if (!a[2]) return "start";
                  if (
                    "bracketedComment" ==
                      (l = e.bgTokenizer.getState(n) || "")[0] ||
                    "bracketedString" == l[0]
                  )
                    return "start";
                }
              }
              if ("markbeginend" != t || !i || (o && i)) return "";
              if ("end" === (a = r.match(this.foldingStopMarker))[0]) {
                if ("keyword" === e.getTokenAt(n, a.index + 1).type)
                  return "end";
              } else {
                if ("]" !== a[0][0]) return "end";
                ...
                if (
                  "bracketedComment" ==
                    (l = e.bgTokenizer.getState(n - 1) || "")[0] ||
                  "bracketedString" == l[0]
                )
                  return "end";
              }
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              ...
              return (r = this.foldingStartMarker.exec(o))
                ? r[1]
                  ? this.luaBlock(e, n, r.index + 1)
                  : r[2]
                  ? e.getCommentFoldRange(n, r.index + 1)
              ...
              if (s && "keyword" == s.type) {
                ...
                if (d) {
                  var c =
                    ...
                    h = t;
                  for (
                    o.step = -1 === d ? o.stepBackward : o.stepForward;
                    (s = o.step());
                    ...
                    if ("keyword" === s.type) {
                      ...
                      if (f > 0) g.unshift(s.value);
                        ...
                        if ((g.shift(), !g.length && "elseif" != s.value))
                          break;
                        0 === f && g.unshift(s.value);
                      }
                    }
                  if (!s) return null;
                  if (r) return o.getCurrentTokenRange();
                  t = o.getCurrentTokenRow();
                  return -1 === d
                    ? new i(t, e.getLine(t).length, h, c)
                    : new i(h, c, t, o.getCurrentTokenColumn());
                }
              }
            });
        }.call(l.prototype);
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        i = e("./lua_highlight_rules").LuaHighlightRules,
        a = e("./folding/lua").FoldMode,
        l = e("../range").Range,
        ...
        function () {
          ...
          (this.getNextLineIndent = function (t, n, r) {
              ...
              "start" == t &&
                (i = (function (t) {
                  for (var n = 0, r = 0; r < t.length; r++) {
                    var o = t[r];
                    "keyword" == o.type
                      ? o.value in e && (n += e[o.value])
                      : "paren.lparen" == o.type
                      ? (n += o.value.length)
                      : "paren.rparen" == o.type && (n -= o.value.length);
                  }
            ...
            (this.checkOutdent = function (e, n, r) {
              ...
              var o = this.getTokenizer().getLineTokens(n.trim(), e).tokens;
              return (
                !(!o || !o.length) &&
                "keyword" == o[0].type &&
                -1 != t.indexOf(o[0].value)
              );
            }),
            (this.getMatching = function (t, n, r) {
              if (void 0 == n) {
                var o = t.selection.lead;
                (r = o.column), (n = o.row);
              }
              var i = t.getTokenAt(n, r);
              if (i && i.value in e)
                return this.foldingRules.luaBlock(t, n, r, !0);
            }),
            (this.autoOutdent = function (e, t, n) {
              var r = t.getLine(n).match(/^\s*/)[0].length;
              if (r && n) {
                var o = this.getMatching(t, n, r + 1);
                if (o && o.start.row != n) {
                  var i = this.$getIndent(t.getLine(o.start.row));
                  i.length != r &&
                    (t.replace(new l(n, 0, n, r), i),
                    t.outdentRows(new l(n + 1, 0, n + 1, 0)));
                }
              }
            }),
            (this.createWorker = function (e) {
              var t = new s(["ace"], "ace/mode/lua_worker", "Worker");
              return (
  ...
  ace.require(["ace/mode/lua"], function (e) {
