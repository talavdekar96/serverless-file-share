ace.define(
              ...
              if (c && -1 !== c.type.indexOf("tag-close")) {
                ...
                if (this.voidElements && !this.voidElements[u]) {
                  var d = o.getTokenAt(i.row, i.column + 1),
                    p = ((s = o.getLine(g)), this.$getIndent(s)),
                    m = p + o.getTabString();
                  return d && "</" === d.value
                    ? {
                        text: "\n" + m + "\n" + p,
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        ...
        a = e("./text_highlight_rules").TextHighlightRules,
        i = function () {
          for (var e in (r.call(this), this.$rules))
      ...
      o.inherits(i, a), (t.LatteHighlightRules = i);
    }
  ),
  ace.define(
    "ace/mode/latte",
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./html").Mode,
        a = e("./latte_highlight_rules").LatteHighlightRules,
        i = e("./matching_brace_outdent").MatchingBraceOutdent,
        s = function () {
  ...
  ace.require(["ace/mode/latte"], function (e) {
