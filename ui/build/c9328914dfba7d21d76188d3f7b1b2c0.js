ace.define(
  ...
  function (e, _, s) {
    ...
    t.inherits(r, i), (_.NginxHighlightRules = r);
  }
),
  ace.define(
      ...
      t.inherits(a, r),
        function () {
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, _, s) {
              var t = e.getLine(s);
              if (
                this.singleLineBlockCommentRe.test(t) &&
                !this.startRegionRe.test(t) &&
                !this.tripleStarBlockCommentRe.test(t)
              )
                return "";
              var i = this._getFoldWidgetBase(e, _, s);
              return !i && this.startRegionRe.test(t) ? "start" : i;
            }),
            (this.getFoldWidgetRange = function (e, _, s, t) {
              var i,
                r = e.getLine(s);
              if (this.startRegionRe.test(r))
                return this.getCommentRegionBlock(e, r, s);
              if ((i = r.match(this.foldingStartMarker))) {
                var a = i.index;
                if (i[1]) return this.openingBracketBlock(e, i[1], s, a);
                var c = e.getCommentFoldRange(s, a + i[0].length, 1);
                return (
                  c &&
                    !c.isMultiLine() &&
                    (t
                      ? (c = this.getSectionRange(e, s))
                      : "all" != _ && (c = null)),
                  c
                );
              }
              if ("markbegin" !== _ && (i = r.match(this.foldingStopMarker))) {
                a = i.index + i[0].length;
                return i[1]
                  ? this.closingBracketBlock(e, i[1], s, a)
                  : e.getCommentFoldRange(s, a, -1);
              }
            }),
            (this.getSectionRange = function (e, _) {
              for (
                var s = e.getLine(_),
                  t = s.search(/\S/),
                  r = _,
                ...
                var n = (s = e.getLine(_)).search(/\S/);
                if (-1 !== n) {
                  if (t > n) break;
                  var l = this.getFoldWidgetRange(e, "all", _);
                  if (l) {
                    if (l.start.row <= r) break;
                    if (l.isMultiLine()) _ = l.end.row;
                    else if (t == n) break;
                  }
                  c = _;
                }
            ...
            (this.getCommentRegionBlock = function (e, _, s) {
              for (
                var t = _.search(/\s*$/),
                  r = e.getLength(),
                  a = s,
              ...
              if (s > a) return new i(a, t, s, _.length);
            });
        }.call(a.prototype);
    }
  ),
  ace.define(
    ...
    function (e, _, s) {
      ...
      var t = e("../lib/oop"),
        i = e("./text").Mode,
        r = e("./nginx_highlight_rules").NginxHighlightRules,
  ...
  ace.require(["ace/mode/nginx"], function (e) {
