ace.define(
  ...
  ace.define(
    ...
    function (n, a, e) {
      (a.isDark = !0),
        (a.cssClass = "ace-mono-industrial"),
        (a.cssText = n("./mono_industrial-css")),
        n("../lib/dom").importCssString(a.cssText, a.cssClass, !1);
    }
  ),
  ace.require(["ace/theme/mono_industrial"], function (n) {
