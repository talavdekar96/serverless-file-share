ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      o.inherits(a, r), (t.JsonHighlightRules = a);
    }
  ),
  ace.define(
    "ace/mode/json",
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./text").Mode,
        a = e("./json_highlight_rules").JsonHighlightRules,
        i = e("./matching_brace_outdent").MatchingBraceOutdent,
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        c = function () {
          function e(e) {
            ...
            return function (n) {
              var o = n.indexOf(e);
              return [
                { type: "meta.tag.punctuation.tag-open", value: "{%" },
                { type: "text", value: n.slice(2, o) },
                {
                  type: "keyword.tag" + e + ".tag-name",
                  value: n.slice(o, o + t),
                },
                { type: "text", value: n.slice(o + t, n.indexOf("%}")) },
                { type: "meta.tag.punctuation.tag-close", value: "%}" },
              ];
            };
          }
          for (var t in (i.call(this), this.$rules))
            this.$rules[t].unshift(
              {
                ...
                next: [
                  ...
                  { defaultToken: "comment", caseInsensitive: !1 },
                ],
              },
              {
                token: "comment.line",
          ...
          this.embedRules(s, "schema-", [
            ...
            this.embedRules(l, "javascript-", [
              {
                ...
                onMatch: e("endjavascript"),
              },
            ]),
            this.embedRules(a, "style-", [
              {
                token: "style-start",
                next: "pop",
            ...
            this.embedRules(a, "stylesheet-", [
              {
                token: "stylesheet-start",
                next: "pop",
                regex: /({%-?\s*\bendstylesheet\b\s*-?%})/,
                onMatch: e("endstylesheet"),
              },
            ]),
            this.addRules({
              "liquid-start": [
                ...
                { token: "support.function", regex: /\s*([a-zA-Z_]+\b)(?=:)/ },
                { token: "keyword.operator", regex: /(:)\s*(?=[a-zA-Z_])/ },
                {
                  token: [
                    "support.class",
                    "keyword.operator",
      ...
      o.inherits(c, r), (t.LiquidHighlightRules = c);
    }
  ),
  ace.define(
    "ace/mode/liquid",
    ...
    function (e, t, n) {
      var o = e("../lib/oop"),
        ...
        s = e("./json").Mode,
        l = e("./css").Mode,
        c = e("./liquid_highlight_rules").LiquidHighlightRules,
        u =
          (e("./matching_brace_outdent").MatchingBraceOutdent,
          e("./folding/cstyle").FoldMode),
        d = function () {
          s.call(this),
            a.call(this),
            l.call(this),
      ...
      o.inherits(d, r),
        function () {
          (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
            (this.voidElements = new a().voidElements),
            (this.getNextLineIndent = function (e, t, n) {
              var o = this.$getIndent(t),
                r = this.getTokenizer().getLineTokens(t, e),
                a = r.tokens;
  ...
  ace.require(["ace/mode/liquid"], function (e) {
