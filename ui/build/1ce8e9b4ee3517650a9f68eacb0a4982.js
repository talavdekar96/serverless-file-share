ace.define(
  ...
  function (e, t, o) {
      ...
      r = function () {
        ...
        this.$rules = {
          start: [
            ...
            {
              token: e,
              regex: "[a-zA-Z\\$_\xa1-\uffff][a-zA-Z\\d\\$_\xa1-\uffff]*\\b",
            },
            {
    ...
    i.inherits(r, n), (t.TomlHighlightRules = r);
  }
),
  ace.define(
            ...
            (this.getFoldWidgetRange = function (e, t, o) {
              ...
              if (l) {
                for (
                  ...
                  if (((r = e.getLine(o)), !/^\s*$/.test(r))) {
                    if ((l = r.match(i)) && 0 !== l[1].lastIndexOf(a, 0)) break;
                    u = o;
                  }
                if (u > d) {
                  var c = e.getLine(u).length;
                  return new n(d, g, u, c);
                }
              }
            });
        }.call(l.prototype);
  ...
  ace.define(
    ...
    function (e, t, o) {
      ...
      var i = e("../lib/oop"),
        n = e("./text").Mode,
        r = e("./toml_highlight_rules").TomlHighlightRules,
  ...
  ace.require(["ace/mode/toml"], function (e) {
