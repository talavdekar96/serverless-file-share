ace.define(
      ...
      i = function () {
        var e = this.createKeywordMapper(
            {
              ...
              "variable.language": "Current|Result",
              "keyword.operator": "and|implies|or|xor",
              keyword:
        ...
        this.$rules = {
          ...
          aligned_verbatim_string: [
            ...
            { token: "string", regex: t },
          ],
          "non-aligned_verbatim_string": [
            { token: "string.quoted.other", regex: /}"/, next: "start" },
            { token: "string.quoted.other", regex: t },
          ],
        };
      };
    n.inherits(i, o), (t.EiffelHighlightRules = i);
  }
),
  ace.define(
    "ace/mode/eiffel",
    ...
    function (e, t, r) {
      ...
      var n = e("../lib/oop"),
        o = e("./text").Mode,
        i = e("./eiffel_highlight_rules").EiffelHighlightRules,
        a = function () {
  ...
  ace.require(["ace/mode/eiffel"], function (e) {
