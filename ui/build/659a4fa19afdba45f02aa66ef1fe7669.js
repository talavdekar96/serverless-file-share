ace.define(
        ...
        this.add("string_dquotes", "insertion", function (e, t, r, i, s) {
          if ('"' == s || "'" == s) {
            ...
            var l = r.getCursorPosition(),
              ...
              m = new a(i, l.row, l.column),
              d = m.getCurrentToken();
            if (c == o && (n(d, "attribute-value") || n(d, "string")))
              return { text: "", selection: [1, 1] };
            if ((d || (d = m.stepBackward()), !d)) return;
            for (; n(d, "tag-whitespace") || n(d, "whitespace"); )
              d = m.stepBackward();
            var g = !c || c.match(/\s/);
            if (
              (n(d, "attribute-equals") && (g || ">" == c)) ||
              (n(d, "decl-attribute-equals") && (g || "?" == c))
            )
          ...
          this.add("autoclosing", "insertion", function (e, t, r, i, s) {
            if (">" == s) {
              ...
              if (n(l, "attribute-value")) {
                ...
                if (o.column == c) {
                  var m = _.stepForward();
                  if (m && n(m, "attribute-value")) return;
                  _.stepBackward();
                }
              }
          ...
          this.add("autoindent", "insertion", function (e, t, r, i, s) {
            if ("\n" == s) {
              ...
              if (l && -1 !== l.type.indexOf("tag-close")) {
                ...
                if (!l) return;
                var c = l.value,
                  m = _.getCurrentTokenRow();
                if (!(l = _.stepBackward()) || -1 !== l.type.indexOf("end-tag"))
                  return;
                if (this.voidElements && !this.voidElements[c]) {
                  var d = i.getTokenAt(n.row, n.column + 1),
                    g = ((o = i.getLine(m)), this.$getIndent(o)),
                    u = g + i.getTabString();
                  return d && "</" === d.value
                    ? {
                        text: "\n" + u + "\n" + g,
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      var i = e("../lib/oop"),
        ...
        m = e("./html_completions").HtmlCompletions,
  ...
  ace.define(
    ...
    function (e, t, r) {
      ...
      i.inherits(p, s),
        function () {
          (this.tokenRe = new RegExp("^[" + m.wordChars + "_]+", "g")),
  ...
  ace.require(["ace/mode/php"], function (e) {
