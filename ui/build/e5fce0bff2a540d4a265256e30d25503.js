ace.define(
  ...
  ace.define(
    ...
    function (n, e, r) {
      (e.isDark = !1),
        (e.cssText = n("./crimson_editor-css")),
        (e.cssClass = "ace-crimson-editor"),
        n("../lib/dom").importCssString(e.cssText, e.cssClass, !1);
    }
  ),
  ace.require(["ace/theme/crimson_editor"], function (n) {
