ace.define(
  ...
  ace.define(
    ...
    function (e, t, _) {
          ...
          t = {
            onMatch: function (e, t, _) {
              ...
              return (
                1 == n
                  ? (t != this.nextState
                      ? _.unshift(this.next, this.nextState, 0)
                      : _.unshift(this.next),
                    _[2]++)
                  : 2 == n &&
                    t == this.nextState &&
                    (_[1]--, (!_[1] || _[1] < 0) && (_.shift(), _.shift())),
                [
                  {
                    type:
          ...
          (this.$rules.jsxAttributes = [
            {
              ...
              onMatch: function (e, t, _) {
                return (
                  t == _[0] && _.shift(),
                  2 == e.length &&
                    (_[0] == this.nextState && _[1]--,
                    (!_[1] || _[1] < 0) && _.splice(0, 2)),
                  (this.next = _[0] || "start"),
      ...
      n.inherits(s, r), (t.JavaScriptHighlightRules = s);
    }
  ),
  ace.define(
      ...
      n.inherits(a, r),
        function () {
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, t, _) {
              var n = e.getLine(_);
              if (
                ...
                return "";
              var o = this._getFoldWidgetBase(e, t, _);
              return !o && this.startRegionRe.test(n) ? "start" : o;
            }),
            (this.getFoldWidgetRange = function (e, t, _, n) {
              var o,
                r = e.getLine(_);
              if (this.startRegionRe.test(r))
                return this.getCommentRegionBlock(e, r, _);
              if ((o = r.match(this.foldingStartMarker))) {
                var a = o.index;
                if (o[1]) return this.openingBracketBlock(e, o[1], _, a);
                var s = e.getCommentFoldRange(_, a + o[0].length, 1);
                return (
                  s &&
                    !s.isMultiLine() &&
                    (n
                      ? (s = this.getSectionRange(e, _))
                      : "all" != t && (s = null)),
                  s
                );
              }
              if ("markbegin" !== t && (o = r.match(this.foldingStopMarker))) {
                ...
                return o[1]
                  ? this.closingBracketBlock(e, o[1], _, a)
                  : e.getCommentFoldRange(_, a, -1);
              }
            }),
            ...
            (this.getCommentRegionBlock = function (e, t, _) {
              for (
                var n = t.search(/\s*$/),
                  r = e.getLength(),
                  a = _,
                ...
                t = e.getLine(_);
                var T = s.exec(t);
                if (T && (T[1] ? i-- : i++, !i)) break;
              }
              if (_ > a) return new o(a, n, _, t.length);
            });
        }.call(a.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, _) {
      ...
      var n = e("../lib/oop"),
        ...
        i = e("./behaviour/cstyle").CstyleBehaviour,
        T = e("./folding/cstyle").FoldMode,
        c = function () {
      ...
      n.inherits(c, o),
        function () {
          (this.lineCommentStart = "//"),
            ...
            (this.getNextLineIndent = function (e, t, _) {
            ...
            (this.checkOutdent = function (e, t, _) {
              return this.$outdent.checkOutdent(t, _);
            }),
            (this.autoOutdent = function (e, t, _) {
              this.$outdent.autoOutdent(t, _);
            }),
  ...
  ace.define(
    ...
    function (e, t, _) {
      ...
      var n = e("../lib/oop"),
        o = e("./text_highlight_rules").TextHighlightRules,
        r = function () {
          var e = "program|procedure|function|interactive|return|let",
            t = "type|is|variant|record|field|case",
            _ = {
              repetitions: "repeat|while|foreach|in",
              alternatives: "if|elseif|else|switch",
            },
            n = { alternatives: "choose|when|otherwise|matching|select|on" },
            o = {
            ...
            r = {
              ...
              expressions:
                "nroBolitas|hayBolitas|puedeMover|siguiente|previo|opuesto|minBool|maxBool|minDir|maxDir|minColor|maxColor|primero|sinElPrimero|esVac\xeda|boom",
          ...
          this.$rules = {
            start: [
              ...
              { token: "constant.numeric.gobstones", regex: o.numbers },
              { token: "string.quoted.double.gobstones", regex: o.strings },
              { token: "keyword.operator.other.gobstones", regex: a.other },
              { token: "keyword.operator.numeric.gobstones", regex: a.numeric },
              {
                token: "keyword.operator.compare.gobstones",
                regex: a.comparison,
              },
              { token: "keyword.operator.boolean.gobstones", regex: a.boolean },
              {
                token: this.createKeywordMapper(
                  {
                    "storage.type.definitions.gobstones": e,
                    "storage.type.types.gobstones": t,
                    ...
                    "keyword.control.expressions.alternatives.gobstones":
                      n.alternatives,
                    "constant.language.colors.gobstones": o.colors,
                    "constant.language.cardinals.gobstones": o.cardinals,
                    "constant.language.boolean.gobstones": o.booleans,
      ...
      n.inherits(r, o), (t.GobstonesHighlightRules = r);
    }
  ),
  ace.define(
    "ace/mode/gobstones",
    ...
    function (e, t, _) {
      ...
      var n = e("../lib/oop"),
        o = e("./javascript").Mode,
        r = e("./gobstones_highlight_rules").GobstonesHighlightRules,
        a = function () {
          o.call(this),
            (this.HighlightRules = r),
  ...
  ace.require(["ace/mode/gobstones"], function (e) {
