  ...
  function (e, t, n) {
    ...
    var g = (function () {
      ...
      return (
        ...
        (e.prototype.getVariableValue = function (e, t, n) {
          ...
          return (
            "function" == typeof r && (r = this.variables[t](e, t, n)),
            null == r ? "" : r
          );
        }),
        (e.prototype.tmStrFormat = function (e, t, n) {
          ...
          var o =
            ...
            a = e.replace(i, function () {
              ...
              for (
                var t = s.resolveVariables(o, n), r = "E", i = 0;
                i < t.length;
                i++
              ) {
                var a = t[i];
                  ...
                  if (((t[i] = ""), a.changeCase && a.local)) {
                    ...
                    c &&
                      ...
                      ("u" == a.changeCase
                        ...
                        : (t[i] = c[0].toLowerCase()),
                      (t[i + 1] = c.substr(1)));
                  } else a.changeCase && (r = a.changeCase);
                else
                  "U" == r
                    ? (t[i] = a.toUpperCase())
                    : "L" == r && (t[i] = a.toLowerCase());
              }
        ...
        (e.prototype.resolveVariables = function (e, t) {
          for (var n = [], r = "", i = !0, o = 0; o < e.length; o++) {
            ...
            if ("string" != typeof s) {
              if (s) {
                if (((i = !1), s.fmtString)) {
                  var a = e.indexOf(s, o + 1);
                  -1 == a && (a = e.length),
                    (s.fmt = e.slice(o + 1, a)),
                    (o = a);
                }
                if (s.text) {
                  var c = this.getVariableValue(t, s.text, r) + "";
        ...
        (e.prototype.insertSnippetForSelection = function (e, t, n) {
          ...
          var o = e.session.replace(i, r.text),
            s = new m(e),
            a = e.inVirtualSelectionMode && e.selection.index;
          s.addTabstops(r.tabstops, i.start, o, a);
        }),
        ...
        (e.prototype.$getScope = function (e) {
          ...
          if ("html" === (t = t.split("/").pop()) || "php" === t) {
            ...
            "object" === typeof r && (r = r[0]),
              r.substring &&
                ("js-" == r.substring(0, 3)
                  ? (t = "javascript")
                  : "css-" == r.substring(0, 4)
                  ? (t = "css")
                  : "php-" == r.substring(0, 4) && (t = "php"));
          }
          return t;
        }),
        ...
        (e.prototype.expandSnippetForSelection = function (e, t) {
          var n,
            ...
            o = i.substring(0, r.column),
            s = i.substr(r.column),
            a = this.snippetMap;
          return (
            this.getActiveScopes(e).some(function (e) {
              var t = a[e];
              return t && (n = this.findMatchingSnippet(t, o, s)), !!n;
            }, this),
            !!n &&
              ((t && t.dryRun) ||
                (e.session.doc.removeInLine(
                  r.row,
                  r.column - n.replaceBefore.length,
                  r.column + n.replaceAfter.length
                ),
        ...
        (e.prototype.parseSnippetFile = function (e) {
          ...
          for (
            ...
            if (t[4])
              (r.content = t[4].replace(/^\t/gm, "")), n.push(r), (r = {});
            else {
              var o = t[2],
                s = t[3];
              if ("regex" == o) {
                var a = /\/((?:[^\/\\]|\\.)*)|$/g;
                (r.guard = a.exec(s)[1]),
                  (r.trigger = a.exec(s)[1]),
                  (r.endTrigger = a.exec(s)[1]),
                  (r.endGuard = a.exec(s)[1]);
              } else
                "snippet" == o
    ...
    var f = function (e, t, n) {
        ...
        var r = e.getCursorPosition(),
          ...
          s = i.match(/^\s*/)[0];
        r.column < s.length && (s = s.slice(0, r.column)),
          (t = t.replace(/\r/g, ""));
        ...
        a.forEach(function (e, t) {
          if ("object" == typeof e) {
            ...
            if (
              (r ||
                (((r = c[n] = []).index = n), (r.value = ""), (r.parents = {})),
              -1 === r.indexOf(e))
            ) {
        ...
        function u(e) {
          for (var t = [], n = 0; n < e.length; n++) {
            var r = e[n];
            if ("object" == typeof r) {
              if (p[r.tabstopId]) continue;
              r = t[e.lastIndexOf(r, n - 1)] || { tabstopId: r.tabstopId };
            }
            t[n] = r;
          }
          return t;
          ...
          if ("object" == typeof h) {
            ...
            if (p[d])
              ...
              "string" !== typeof m
                ...
                a.splice.apply(a, [l + 1, Math.max(0, f - l)].concat(m, h)),
        ...
        return (
          ...
          (e.prototype.onChange = function (e) {
            for (
              ...
              if (
                ...
                p = p < 0 ? -p - 1 : p + 1;
                var u = s.rangeList.pointIndex(e.end, c);
                u = u < 0 ? -u - 1 : u - 1;
                for (
                  var l = s.rangeList.ranges.slice(p, u), h = 0;
                  h < l.length;
                  h++
                )
                  this.removeRange(l[h]);
              }
          ...
          (e.prototype.updateLinkedFields = function () {
            ...
            if (e && e.hasLinkedRanges && e.firstNonLinked) {
              ...
              for (
                ...
                if (o.linked) {
                  var s = o.original,
                    a = t.snippetManager.tmStrFormat(r, s, this.editor);
                  n.replace(o, a);
                }
              }
              this.$inChange = !1;
              ...
              for (
                ...
                if (!this.ranges[r].linked) {
                  var i = this.ranges[r].contains(e.row, e.column),
                    o = n || this.ranges[r].contains(t.row, t.column);
                  if (i && o) return;
                }
              this.detach();
            }
          ...
          (e.prototype.addTabstops = function (e, t, n) {
            ...
            e.forEach(function (e, n) {
              for (
                var i = this.$openTabstops[n] || e, p = 0;
                p < e.length;
                p++
              ) {
                var u = e[p],
                  l = a.fromPoints(u.start, u.end || u.start);
                b(l.start, t),
                  b(l.end, t),
                  (l.original = u),
                  (l.tabstop = i),
                  s.push(l),
                  i != e ? i.unshift(l) : (i[p] = l),
                  u.fmtString || (i.firstNonLinked && r)
                    ? ((l.linked = !0), (i.hasLinkedRanges = !0))
                    : i.firstNonLinked || (i.firstNonLinked = l);
              }
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r,
          ...
          return (
            (e.prototype.setupContext = function (e) {
              (this.ace = e),
                ...
                r || (r = window.emmet),
                (r.resources || r.require("resources")).setVariable(
                  "indentation",
                  this.indentation
                ),
                (this.$syntax = null),
            ...
            (e.prototype.replaceContent = function (e, t, n, r) {
              null == n && (n = null == t ? this.getContent().length : t),
                null == t && (t = 0);
              var i = this.ace,
                o = i.session.doc,
                s = c.fromPoints(o.indexToPosition(t), o.indexToPosition(n));
              i.session.remove(s),
                (s.end = s.start),
            ...
            (e.prototype.getProfileName = function () {
              var e = r.resources || r.require("resources");
            ...
            (e.prototype.$updateTabstops = function (e) {
              var t = 0,
                n = null,
                i = r.tabStops || r.require("tabStops"),
                o = (r.resources || r.require("resources")).getVocabulary(
                  "user"
                ),
                s = {
                  tabstop: function (e) {
                    var r = parseInt(e.group, 10),
                      o = 0 === r;
                    o ? (r = ++t) : (r += 1e3);
                    var a = e.placeholder;
                    a && (a = i.processText(a, s));
                    var c = "${" + r + (a ? ":" + a : "") + "}";
                    return o && (n = [e.start, c]), c;
                  },
                  escape: function (e) {
                    return "$" == e ? "\\$" : "\\" == e ? "\\\\" : e;
                  },
              ...
              if (
                ...
                e = (
                  r.utils ? r.utils.common : r.require("utils")
                ).replaceSubstring(e, "${0}", n[0], n[1]);
              }
              return e;
            }),
            e
        ...
        h = new u();
      for (var d in ((t.commands = new o()),
      (t.runEmmetCommand = function e(n) {
        if ("expand_abbreviation_with_tab" == this.action) {
          if (!n.selection.isEmpty()) return !1;
          var i = n.selection.lead,
            o = n.session.getTokenAt(i.row, i.column);
          if (o && /\btag\b/.test(o.type)) return !1;
        }
        try {
          h.setupContext(n);
          var s = r.actions || r.require("actions");
          if ("wrap_with_abbreviation" == this.action)
            return setTimeout(function () {
              s.run("wrap_with_abbreviation", h);
            }, 0);
          var a = s.run(this.action, h);
        } catch (u) {
          if (!r) {
            var c = t.load(e.bind(this, n));
            return "expand_abbreviation_with_tab" != this.action && c;
          }
          n._signal("changeStatus", "string" == typeof u ? u : u.message),
            p.warn(u),
            (a = !1);
        }
        return a;
      ...
      (t.load = function (e) {
        return "string" !== typeof i
          ? (p.warn("script for emmet-core is not loaded"), !1)
          : (p.loadModule(i, function () {
              (i = null), e && e();
            }),
            !0);
      }),
        (t.AceEmmetEditor = u),
        p.defineOptions(s.prototype, "editor", {
          enableEmmet: {
            set: function (e) {
              this[e ? "on" : "removeListener"]("changeMode", g),
                g({ enableEmmet: !!e }, this);
            },
            value: !0,
          },
        }),
        (t.setCore = function (e) {
          "string" == typeof e ? (i = e) : (r = e);
        });
    }
  ),
  ace.require(["ace/ext/emmet"], function (e) {
