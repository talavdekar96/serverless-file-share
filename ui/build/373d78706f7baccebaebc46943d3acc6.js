ace.define(
        ...
        this.add("string_dquotes", "insertion", function (e, t, n, r, o) {
          if ('"' == o || "'" == o) {
            ...
            var u = n.getCursorPosition(),
              g = r.doc.getLine(u.row).substring(u.column, u.column + 1),
              c = new a(r, u.row, u.column),
              d = c.getCurrentToken();
            if (g == s && (i(d, "attribute-value") || i(d, "string")))
              return { text: "", selection: [1, 1] };
            if ((d || (d = c.stepBackward()), !d)) return;
            for (; i(d, "tag-whitespace") || i(d, "whitespace"); )
              d = c.stepBackward();
            var x = !g || g.match(/\s/);
            if (
              (i(d, "attribute-equals") && (x || ">" == g)) ||
              (i(d, "decl-attribute-equals") && (x || "?" == g))
            )
          ...
          this.add("autoclosing", "insertion", function (e, t, n, r, o) {
            if (">" == o) {
              ...
              if (i(u, "attribute-value")) {
                var g = l.getCurrentTokenColumn() + u.value.length;
                if (s.column < g) return;
                if (s.column == g) {
                  var c = l.stepForward();
              ...
              var d = l.getCurrentTokenRow(),
                x = l.getCurrentTokenColumn();
              if (i(l.stepBackward(), "end-tag-open")) return;
              var m = u.value;
              if (
                (d == s.row && (m = m.substring(0, s.column - x)),
        ...
        function () {
          (this.voidElements = o.arrayToMap([])),
            ...
            (this.createWorker = function (e) {
              var t = new u(["ace"], "ace/mode/xml_worker", "Worker");
              return (
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(i, a), (t.SvgHighlightRules = i);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./xml").Mode,
        a = e("./javascript").Mode,
        i = e("./svg_highlight_rules").SvgHighlightRules,
        s = e("./folding/mixed").FoldMode,
        l = e("./folding/xml").FoldMode,
        u = e("./folding/cstyle").FoldMode,
        g = function () {
          o.call(this),
            (this.HighlightRules = i),
            this.createModeDelegates({ "js-": a }),
            (this.foldingRules = new s(new l(), { "js-": new u() }));
        };
      r.inherits(g, o),
        function () {
          (this.getNextLineIndent = function (e, t, n) {
  ...
  ace.require(["ace/mode/svg"], function (e) {
