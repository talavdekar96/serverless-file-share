ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, n, o) {
              ...
              if ((a = i.match(this.foldingStartMarker))) {
                ...
                var l = e.getCommentFoldRange(n, r + a[0].length, 1);
                return (
                  l &&
                    !l.isMultiLine() &&
                    (o
              ...
              if ("markbegin" !== t && (a = i.match(this.foldingStopMarker))) {
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new a(i, r, l, e.getLine(l).length);
            }),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        a = e("./text").Mode,
        i = e("./alda_highlight_rules").AldaHighlightRules,
  ...
  ace.require(["ace/mode/alda"], function (e) {
