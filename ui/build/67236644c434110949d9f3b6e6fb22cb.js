ace.define(
  ...
  ace.define(
    ...
    function (e, t, a) {
      "use strict";
      var o = e("../../lib/dom"),
        n = e("./settings_menu.css");
      o.importCssString(n, "settings_menu.css", !1),
        (a.exports.overlayPage = function (e, t, a) {
    ...
    function (e, t, a) {
      ...
      a.exports = {
        getModeForPath: function (e) {
          for (
            var t = s.text, a = e.split(/[\/\\]/).pop(), n = 0;
            n < o.length;
            n++
          )
            if (o[n].supportsFile(a)) {
              t = o[n];
              break;
            }
          return t;
    ...
    function (e, t, a) {
      ...
      (t.themesByName = {}),
        (t.themes = [
          ...
          var a = e[1] || e[0].replace(/ /g, "_").toLowerCase(),
            o = {
              caption: e[0],
              theme: "ace/theme/" + a,
              isDark: "dark" == e[2],
  ...
  ace.define(
    ...
    function (e, t, a) {
      ...
      var o = e("../lib/dom"),
        ...
        c = e("./themelist"),
        p = { Bright: [], Dark: [] };
      c.themes.forEach(function (e) {
        p[e.isDark ? "Dark" : "Bright"].push({
          caption: e.caption,
          value: e.theme,
        });
      });
      var u = {
          Main: {
            Mode: {
              path: "mode",
              type: "select",
              items: l.modes.map(function (e) {
                return { caption: e.caption, value: e.mode };
              }),
            },
            Theme: { path: "theme", type: "select", items: p },
            Keybinding: {
              type: "buttonBar",
        ...
        d = (function () {
          ...
          return (
            (e.prototype.add = function (e) {
              e.Main && n.mixin(u.Main, e.Main),
                e.More && n.mixin(u.More, e.More);
            }),
                ...
                s(
                  [
                    ...
                    [
                      "tr",
                      null,
                      ["td", { colspan: 2 }, "version " + r.version],
                    ],
                  ],
                  this.container
                );
            }),
            (e.prototype.renderOptionGroup = function (e) {
              return Object.keys(e)
                .map(function (t, a) {
                  var o = e[t];
                  return (
                    o.position || (o.position = a / 1e4),
                    o.label || (o.label = t),
                    o
                  );
                })
            ...
            (e.prototype.renderOptionControl = function (e, t) {
              var a,
                o = this;
              if (Array.isArray(t))
                return t.map(function (t) {
                  return o.renderOptionControl(e, t);
                });
              var n = o.getOption(t);
              if (
                (t.values &&
                  "checkbox" != t.type &&
                  ("string" == typeof t.values &&
                    (t.values = t.values.split("|")),
                ...
                a = [
                  ...
                  t.items.map(function (e) {
                    return [
                      ...
                      {
                        value: e.value,
                        ace_selected_button: n == e.value,
                        "aria-pressed": n == e.value,
                        onclick: function () {
                          o.setOption(t, e.value);
                          for (
                            var a = this.parentNode.querySelectorAll(
                                "[ace_selected_button]"
                              ),
                              n = 0;
                            n < a.length;
                            ...
                            a[n].removeAttribute("ace_selected_button"),
                              a[n].setAttribute("aria-pressed", !1);
                ...
                (a = [
                  ...
                  {
                    type: "number",
                    value: n || t.defaultValue,
                    style: "width:3em",
                    oninput: function () {
                      o.setOption(t, parseInt(this.value));
                    },
                  },
                ]),
                  t.ariaLabel
                    ? (a[1]["aria-label"] = t.ariaLabel)
                    : (a[1].id = e),
                  t.defaults &&
                    (a = [
                      a,
                ...
                var r = function (e) {
                  ...
                  i = Array.isArray(t.items)
                    ? r(t.items)
                    : Object.keys(t.items).map(function (e) {
                        return ["optgroup", { label: e }, r(t.items[e])];
                      });
                a = [
                  "select",
                  {
                    ...
                    value: n,
                    onchange: function () {
                      o.setOption(t, this.value);
                    },
                  },
                  i,
                ];
              } else
                "string" == typeof t.values && (t.values = t.values.split("|")),
                  t.values && (n = n == t.values[1]),
                  (a = [
                    "input",
                    {
                      type: "checkbox",
                  ...
                  "checkedNumber" == t.type && (a = [a, []]);
              return a;
            }),
            (e.prototype.renderOption = function (e, t) {
              if (!t.path || t.onchange || this.editor.$options[t.path]) {
                ...
                return [
                  ...
                  ["td", ["label", { for: o, id: a + "-label" }, e]],
                  ["td", this.renderOptionControl(o, t)],
                ];
              }
            }),
            (e.prototype.setOption = function (e, t) {
              "string" == typeof e && (e = this.options[e]),
                "false" == t && (t = !1),
                "true" == t && (t = !0),
                "null" == t && (t = null),
      ...
      n.implement(d.prototype, i), (t.OptionPanel = d);
    }
  ),
  ace.define(
    ...
    function (e, t, a) {
      "use strict";
      var o = e("./options").OptionPanel,
        n = e("./menu_tools/overlay_page").overlayPage;
      a.exports.init = function () {
        e("../editor").Editor.prototype.showSettingsMenu = function () {
          !(function (e) {
            if (!document.getElementById("ace_settingsmenu")) {
              ...
              t.render(),
                ...
                n(e, t.container),
                t.container
                  .querySelector("select,input,button,checkbox")
                  .focus();
            }
          })(this);
        };
  ...
  ace.require(["ace/ext/settings_menu"], function (e) {
