      ...
      s = function () {
        ...
        (this.$rules = {
          start: [
            ...
            { token: "string", regex: i + '"{3}', next: "rfqqstring3" },
            { token: "string", regex: i + '"(?=.)', next: "rfqqstring" },
            { token: "string", regex: i + "'{3}", next: "rfqstring3" },
            { token: "string", regex: i + "'(?=.)", next: "rfqstring" },
            {
          ...
          constants: [
            { token: "constant.numeric", regex: "(?:" + a + "|\\d+)[jJ]\\b" },
            { token: "constant.numeric", regex: a },
            { token: "constant.numeric", regex: s + "[lL]\\b" },
            { token: "constant.numeric", regex: s + "\\b" },
            {
      ...
      r.inherits(s, i),
        function () {
          this.getFoldWidgetRange = function (e, t, n) {
            ...
            if (r)
              return r[1]
                ? this.openingBracketBlock(e, r[1], n, r.index)
                : r[2]
                ? this.indentationBlock(e, n, r.index + r[2].length)
          ...
          (this.checkOutdent = function (t, n, r) {
            ...
            (this.autoOutdent = function (e, t, n) {
              ...
              var r = this.$getIndent(t.getLine(n)),
                i = t.getTabString();
              r.slice(-i.length) == i &&
                t.remove(new g(n, r.length - i.length, n, r.length));
            }),
