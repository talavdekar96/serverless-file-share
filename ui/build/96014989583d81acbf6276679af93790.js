  ...
  ace.define(
    ...
    function (e, n, t) {
      ...
      var i = e("../lib/dom"),
        ...
        r = e("../lib/keys"),
        h = e("../config").nls;
      i.importCssString(s, "ace_searchbox", !1);
      var l = (function () {
          function e(e, n, t) {
            ...
            i.buildDom(
              ...
              this.$init(),
              this.setEditor(e),
              i.importCssString(s, "ace_searchbox", e.container);
          }
          return (
            ...
            (e.prototype.$init = function () {
              ...
              o.addListener(e, "mousedown", function (e) {
                ...
                o.addListener(e, "click", function (e) {
                  ...
                  t && n[t]
                    ? n[t]()
                    : n.$searchBarKb.commands[t] &&
                      n.$searchBarKb.commands[t].exec(n),
                    o.stopPropagation(e);
                }),
                o.addCommandKeyListener(e, function (e, t, i) {
                  var c = r.keyCodeToString(i),
                    s = n.$searchBarKb.findKeyCommand(t, c);
                  s && s.exec && (s.exec(n), o.stopEvent(e));
                }),
                (this.$onChange = c.delayedCall(function () {
                  n.find(!1, !1);
                })),
                ...
                o.addListener(this.searchInput, "focus", function () {
                  (n.activeInput = n.searchInput),
                    n.searchInput.value && n.highlight();
                }),
                o.addListener(this.replaceInput, "focus", function () {
                  (n.activeInput = n.replaceInput),
                    n.searchInput.value && n.highlight();
                });
            }),
            ...
            (e.prototype.$syncOptions = function (e) {
              ...
              var n = this.editor.getReadOnly();
              (this.replaceOption.style.display = n ? "none" : ""),
                (this.replaceBox.style.display =
                  this.replaceOption.checked && !n ? "" : "none"),
                this.find(!1, !1, e);
            }),
            ...
            (e.prototype.find = function (e, n, t) {
              ...
              i.setCssClass(this.searchBox, "ace_nomatch", c),
                this.editor._emit("findSearchBox", { match: !c }),
                this.highlight(),
                this.updateCounter();
            }),
            (e.prototype.updateCounter = function () {
              var e = this.editor,
                n = e.$search.$options.re,
                t = 0,
                i = 0;
              if (n) {
                var c = this.searchRange
                    ? e.session.getTextRange(this.searchRange)
                    : e.getValue(),
                  o = e.session.doc.positionToIndex(e.selection.anchor);
                this.searchRange &&
                  (o -= e.session.doc.positionToIndex(this.searchRange.start));
                for (
                  var s, a = (n.lastIndex = 0);
                  (s = n.exec(c)) &&
                  (t++, (a = s.index) <= o && i++, !(t > 999)) &&
                  (s[0] || ((n.lastIndex = a += 1), !(a >= c.length)));

                );
              }
              this.searchCounter.textContent = h("$0 of $1", [
                i,
                t > 999 ? "999+" : t,
              ]);
            }),
            ...
            (e.prototype.findAll = function () {
              ...
              i.setCssClass(this.searchBox, "ace_nomatch", e),
                this.editor._emit("findSearchBox", { match: !e }),
                this.highlight(),
                this.hide();
            }),
      ...
      p.bindKeys({
        "Ctrl-f|Command-f": function (e) {
          var n = (e.isReplace = !e.isReplace);
          (e.replaceBox.style.display = n ? "" : "none"),
      ...
      (l.prototype.$searchBarKb = p),
        (l.prototype.$closeSearchBarKb = d),
        (n.SearchBox = l),
        (n.Search = function (e, n) {
          (e.searchBox || new l(e)).show(e.session.getTextRange(), n);
        });
    }
  ),
