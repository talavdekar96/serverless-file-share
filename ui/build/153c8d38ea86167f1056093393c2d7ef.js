!(function (t) {
  ...
  ace.define("ace/mode/json/json_parse", [], function (t, e, n) {
    "use strict";
    var r,
      i,
      o,
      ...
      c = function (t) {
        throw { name: "SyntaxError", message: t, at: r, text: o };
      },
      u = function (t) {
        return (
          t && t !== i && c("Expected '" + t + "' instead of '" + i + "'"),
          (i = o.charAt(r)),
          (r += 1),
          i
        );
                ...
                if (s && "object" === typeof s)
                  for (i in s)
                    Object.hasOwnProperty.call(s, i) &&
                      (void 0 !== (o = t(s, i)) ? (s[i] = o) : delete s[i]);
                return e.call(n, r, s);
              })({ "": n }, "")
            : n
        );
  ...
  ace.define("ace/mode/json_worker", [], function (t, e, n) {
    "use strict";
    var r = t("../lib/oop"),
      i = t("../worker/mirror").Mirror,
      o = t("./json/json_parse"),
      s = (e.JsonWorker = function (t) {
        i.call(this, t), this.setTimeout(200);
      });
    r.inherits(s, i),
      function () {
        this.onUpdate = function () {
          ...
          try {
            ...
            var n = this.doc.indexToPosition(r.at - 1);
            e.push({
              row: n.row,
              column: n.column,
              text: r.message,
