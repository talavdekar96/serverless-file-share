ace.define(
  ...
  function (e, t, o) {
    ...
    n.inherits(r, i), (t.LogtalkHighlightRules = r);
  }
),
  ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, o, n) {
              ...
              if ((i = r.match(this.foldingStartMarker))) {
                ...
                var l = e.getCommentFoldRange(o, a + i[0].length, 1);
                return (
                  l &&
                    !l.isMultiLine() &&
                    (n
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new i(r, a, l, e.getLine(l).length);
            }),
    ...
    function (e, t, o) {
      ...
      var n = e("../lib/oop"),
        ...
        r =
          ...
          e("./logtalk_highlight_rules").LogtalkHighlightRules),
  ...
  ace.require(["ace/mode/logtalk"], function (e) {
