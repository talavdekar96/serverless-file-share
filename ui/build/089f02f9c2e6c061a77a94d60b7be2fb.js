ace.define(
  ...
  function (e, t, n) {
          ...
          start: [
            ...
            { regex: "<<<", token: "keyword.operator" },
            {
              ...
              onMatch: function (e, t, n) {
                var i = "-" == e[2] ? "indentedHeredoc" : "heredoc",
            ...
            { include: "variables" },
            { token: "support.function", regex: g },
    ...
    i.inherits(a, r), (t.ShHighlightRules = a);
  }
),
  ace.define(
        ...
        function () {
          ...
          (this.checkOutdent = function (t, n, i) {
            ...
            (this.autoOutdent = function (e, t, n) {
              n += 1;
              var i = this.$getIndent(t.getLine(n)),
                r = t.getTabString();
              i.slice(-r.length) == r &&
                t.remove(new s(n, i.length - r.length, n, i.length));
            }),
            (this.$id = "ace/mode/sh"),
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var i = e("../lib/oop"),
        r = e("./sh_highlight_rules").ShHighlightRules,
        o = function () {
          r.call(this);
          for (var e = this.$rules.start, t = 0; t < e.length; t++)
            if ("variable.language" == e[t].token) {
              e.splice(t, 0, {
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var i = e("../lib/oop"),
        r = e("./sh").Mode,
        o = e("./dockerfile_highlight_rules").DockerfileHighlightRules,
  ...
  ace.require(["ace/mode/dockerfile"], function (e) {
