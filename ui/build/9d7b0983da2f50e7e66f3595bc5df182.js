ace.define(
  ...
  function (e, t, n) {
          ...
          start: [
            {
              ...
              onMatch: function (e, t, n, r) {
                ...
                return (
                  ...
                  n.unshift("language-embed", [], [o, a], t),
                  this.token
                );
              },
                ...
                },
                {
                  ...
                  onMatch: function (e, t, n, o) {
                    ...
                    if (r[i]) {
                      var l = r[i]
                        .getTokenizer()
                        .getLineTokens(o.slice(a.length), s.slice(0));
            ...
            },
            {
              ...
              onMatch: function (e, t, n, r) {
                ...
                return (
                  ...
                  n.length < 2 ? n.push(o.length) : (n[1] = o.length),
                  this.token
                );
              },
              next: "mlString",
    ...
    o.inherits(i, a), (t.SlimHighlightRules = i);
  }
),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(h, o), (t.CssHighlightRules = h);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        c = function () {
          ...
          var e = {
              ...
              onMatch: function (e, t, n, o) {
                ...
                return (
                  r[i] || (i = ""),
                  n.unshift("githubblock", [], [a[1], a[2], i], t),
                  this.token
                );
              },
              next: "githubblock",
            ...
            t = [
              {
                ...
                onMatch: function (e, t, n, o) {
                  ...
                  if (
                    c &&
                    c[1].length < i.length + 3 &&
                    c[2].length >= s.length &&
                    c[2][0] == s[0]
                  )
                    return n.splice(0, 3), (this.next = n.shift()), this.token;
                  if (((this.next = ""), l && r[l])) {
                    var u = r[l].getTokenizer().getLineTokens(e, a.slice(0));
      ...
      o.inherits(c, i), (t.MarkdownHighlightRules = c);
    }
  ),
  ace.define(
          ...
          (this.foldingStartMarker = /^(?:[=-]+\s*$|#{1,6} |`{3})/),
            (this.getFoldWidget = function (e, t, n) {
              ...
              return this.foldingStartMarker.test(r)
                ? "`" == r[0] && "start" == e.bgTokenizer.getState(n)
                  ? "end"
                  : "start"
                : "";
            }),
            (this.getFoldWidgetRange = function (e, t, n) {
              ...
              if (r.match(this.foldingStartMarker)) {
                ...
                if (h(n)) {
                  ...
                  if (
                    (l =
                      n - (c && -1 != ["=", "-"].indexOf(c.value[0]) ? 2 : 1)) >
                    s
                  )
                    for (; l > s && /^\s*$/.test(e.getLine(l)); ) l--;
                  if (l > s) {
                    var d = e.getLine(l).length;
                    return new a(s, o, l, d);
                  }
                }
              }
              function h(t) {
                return (
                  (c = e.getTokens(t)[0]) && 0 === c.type.lastIndexOf(u, 0)
                );
              }
              function p() {
                var e = c.value[0];
      ...
      (function () {
        (this.completionsDefined = !1),
          ...
          (this.getCompletions = function (e, t, n, r) {
            if (
              ...
              var o = t.getLine(n.row).substr(0, n.column),
                a = /\([^)]*$/.test(o);
              return (
                a && (o = o.substr(o.lastIndexOf("(") + 1)),
                /:[^;]+$/.test(o)
                  ? (/([\w\-]+):[^:]*$/.test(o),
                    this.getPropertyValueCompletions(e, t, n, r))
                  : this.getPropertyCompletions(e, t, n, r, a)
              );
            }
            return [];
          }),
          (this.getPropertyCompletions = function (e, t, n, o, a) {
            return (
              (a = a || !1),
          ...
          (this.getPropertyValueCompletions = function (e, t, n, o) {
            ...
            var s = [];
            return (
              i in r && "object" === typeof r[i] && (s = Object.keys(r[i])),
              s.map(function (e) {
                return {
                  caption: e,
                  snippet: e,
      ...
      var r = e("../../lib/oop"),
        ...
        i = function () {
          this.inherit(o),
            ...
            this.add("colon", "deletion", function (e, t, n, r, o) {
              var i = r.doc.getTextRange(o);
              if (!o.isMultiLine() && ":" === i) {
                var s = n.getCursorPosition(),
                  l = new a(r, s.row, s.column),
                  c = l.getCurrentToken();
                if (
            ...
            this.add("semicolon", "insertion", function (e, t, n, r, o) {
              if (";" === o && n.selection.isEmpty()) {
                var a = n.getCursorPosition();
                if (
                  ";" === r.doc.getLine(a.row).substring(a.column, a.column + 1)
                )
                  return { text: "", selection: [1, 1] };
              }
            }),
            this.add("!important", "insertion", function (e, t, n, r, o) {
              if ("!" === o && n.selection.isEmpty()) {
                var a = n.getCursorPosition(),
                  i = r.doc.getLine(a.row);
                if (/^\s*(;|}|$)/.test(i.substring(a.column)))
                  return { text: "!important", selection: [10, 10] };
              }
            });
        };
      r.inherits(i, o), (t.CssBehaviour = i);
    }
  ),
  ace.define(
    "ace/mode/css",
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var s = function () {
        this.add("string_dquotes", "insertion", function (e, t, n, r, o) {
          if ('"' == o || "'" == o) {
            ...
            var h = !u || u.match(/\s/);
            if (
              (i(d, "attribute-equals") && (h || ">" == u)) ||
              (i(d, "decl-attribute-equals") && (h || "?" == u))
            )
          ...
          this.add("autoclosing", "insertion", function (e, t, n, r, o) {
            if (">" == o) {
              ...
              var d = l.getCurrentTokenRow(),
                h = l.getCurrentTokenColumn();
              if (i(l.stepBackward(), "end-tag-open")) return;
              var p = c.value;
              if (
                (d == s.row && (p = p.substring(0, s.column - h)),
            ...
            if ("\n" == o) {
              ...
              if (c && -1 !== c.type.indexOf("tag-close")) {
                ...
                if (this.voidElements && !this.voidElements[u]) {
                  var d = r.getTokenAt(i.row, i.column + 1),
                    h = ((s = r.getLine(g)), this.$getIndent(s)),
                    p = h + r.getTabString();
                  return d && "</" === d.value
                    ? {
                        text: "\n" + p + "\n" + h,
      ...
      r.inherits(s, o), (t.XmlBehaviour = s);
    }
  ),
  ace.define(
        ...
        function () {
          (this.$getMode = function (e) {
            ...
            (this.$tryMode = function (e, t, n, r) {
              ...
              return o ? o.getFoldWidget(t, n, r) : "";
            }),
            (this.getFoldWidget = function (e, t, n) {
              return (
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              ...
              return (
                (r && r.getFoldWidget(e, t, n)) ||
                  (r = this.$getMode(e.getState(n))),
                (r && r.getFoldWidget(e, t, n)) || (r = this.defaultMode),
                r.getFoldWidgetRange(e, t, n)
              );
            });
        }.call(a.prototype);
    }
      ...
      (function () {
        (this.getFoldWidget = function (e, t, n) {
          ...
          (this._getFirstTagInLine = function (e, t) {
            for (
              var n = e.getTokens(t), r = new s(), o = 0;
              o < n.length;
              o++
            ) {
              var a = n[o];
    ...
    function (e, t, n) {
      ...
      var r = e("../../lib/oop"),
        ...
        s = (t.FoldMode = function (e, t) {
          o.call(this, new a(e, t), { "js-": new i(), "css-": new i() });
        });
      r.inherits(s, o);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      function l(e, t) {
        for (
          var n = new r(e, t.row, t.column), o = n.getCurrentToken();
          o && !s(o, "tag-name");
      ...
      (function () {
        (this.getCompletions = function (e, t, n, r) {
          ...
          if (!o) return [];
          if (s(o, "tag-name") || s(o, "tag-open") || s(o, "end-tag-open"))
            return this.getTagCompletions(e, t, n, r);
          if (s(o, "tag-whitespace") || s(o, "attribute-name"))
            return this.getAttributeCompletions(e, t, n, r);
          if (s(o, "attribute-value"))
      ...
      var r = e("../lib/oop"),
        ...
        m = function (e) {
          (this.fragmentContext = e && e.fragmentContext),
            ...
            (this.foldingRules = new u(this.voidElements, o.arrayToMap(p)));
        };
      r.inherits(m, a),
        function () {
          (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
            (this.voidElements = o.arrayToMap(h)),
            (this.getNextLineIndent = function (e, t, n) {
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        s = function () {
          ...
          (this.$rules = {
            start: [
              ...
              { regex: "<<<", token: "keyword.operator" },
              {
                ...
                onMatch: function (e, t, n) {
                  var r = "-" == e[2] ? "indentedHeredoc" : "heredoc",
                    o = e.split(this.splitRegex);
                  return (
                    n.push(r, o[4]),
                    [
                      { type: "constant", value: o[1] },
                      { type: "text", value: o[2] },
                      { type: "string", value: o[3] },
                      { type: "support.class", value: o[4] },
                      { type: "string", value: o[5] },
                    ]
                  );
                },
                rules: {
              ...
              { include: "variables" },
              { token: "support.function", regex: c },
              { token: "support.function", regex: o },
              { token: "string", start: "'", end: "'" },
              { token: "constant.numeric", regex: r },
              {
                token: "constant.numeric",
                regex: "(?:(?:[1-9]\\d*)|(?:0))\\b",
              },
      ...
      r.inherits(s, o), (t.ShHighlightRules = s);
    }
  ),
  ace.define(
    "ace/mode/sh",
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./sh_highlight_rules").ShHighlightRules,
        i = e("../range").Range,
        ...
        function () {
          ...
          (this.checkOutdent = function (t, n, r) {
            ...
            do {
              ...
              a &&
              ("comment" == a.type ||
                ("text" == a.type && a.value.match(/^\s+$/)))
            );
            return !!a && "keyword" == a.type && e[a.value];
          }),
            (this.autoOutdent = function (e, t, n) {
              n += 1;
              var r = this.$getIndent(t.getLine(n)),
                o = t.getTabString();
              r.slice(-o.length) == o &&
                t.remove(new i(n, r.length - o.length, n, r.length));
            }),
            (this.$id = "ace/mode/sh"),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        s = e("./behaviour/xml").XmlBehaviour,
        l = e("./folding/xml").FoldMode,
      ...
      r.inherits(u, a),
        function () {
          (this.voidElements = o.arrayToMap([])),
            (this.blockComment = { start: "\x3c!--", end: "--\x3e" }),
            (this.createWorker = function (e) {
              var t = new c(["ace"], "ace/mode/xml_worker", "Worker");
              return (
                t.attachToDocument(e.getDocument()),
                t.on("error", function (t) {
                  e.setAnnotations(t.data);
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        ...
        a = e("./text").Mode,
        i = e("./markdown_highlight_rules").MarkdownHighlightRules,
          ...
          (this.type = "text"),
            ...
            (this.getNextLineIndent = function (e, t, n) {
              if ("listblock" == e) {
                ...
                if (!r) return "";
                var o = r[2];
                return o || (o = parseInt(r[3], 10) + 1 + "."), r[1] + o + r[4];
              }
              return this.$getIndent(t);
            }),
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(a, o), (t.CoffeeHighlightRules = a);
    }
  ),
  ace.define(
      ...
      r.inherits(i, o),
        function () {
          (this.getFoldWidgetRange = function (e, t, n) {
            ...
            if (-1 != s && "#" == i[s]) {
              for (
                var l = i.length, c = e.getLength(), u = n, g = n;
                ++n < c;

              ) {
                var d = (i = e.getLine(n)).search(o);
                if (-1 != d) {
                  if ("#" != i[d]) break;
                  g = n;
                }
              ...
              if (g > u) {
                var h = e.getLine(g).length;
                return new a(u, l, g, h);
              }
            }
          }),
            (this.getFoldWidget = function (e, t, n) {
              ...
              if (-1 == o)
                return (
                  (e.foldWidgets[n - 1] = -1 != s && s < l ? "start" : ""), ""
                );
              if (-1 == s) {
                if (o == l && "#" == r[o] && "#" == a[o])
                  return (
        ...
        function () {
          ...
          (this.lineCommentStart = "#"),
            ...
            (this.getNextLineIndent = function (t, n, r) {
              var o = this.$getIndent(n),
                a = this.getTokenizer().getLineTokens(n, t).tokens;
              return (
                (a.length && "comment" === a[a.length - 1].type) ||
                  "start" !== t ||
                  !e.test(n) ||
                  (o += r),
                o
            ...
            (this.createWorker = function (e) {
              var t = new s(["ace"], "ace/mode/coffee_worker", "Worker");
              return (
                t.attachToDocument(e.getDocument()),
                t.on("annotate", function (t) {
                  e.setAnnotations(t.data);
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("../lib/lang"),
        a = e("./text_highlight_rules").TextHighlightRules,
        i = e("./css_highlight_rules"),
        s = function () {
          var e = o.arrayToMap(i.supportType.split("|")),
            t = o.arrayToMap(
            ...
            n = o.arrayToMap(i.supportConstant.split("|")),
            r = o.arrayToMap(i.supportConstantColor.split("|")),
            a = o.arrayToMap(
          ...
          this.$rules = {
            start: [
              ...
              { token: "constant.numeric", regex: "#[a-f0-9]{6}" },
              { token: "constant.numeric", regex: "#[a-f0-9]{3}" },
              { token: "constant.numeric", regex: l },
              {
              ...
              {
                token: function (o) {
                  return e.hasOwnProperty(o.toLowerCase())
                    ? "support.type"
                    : a.hasOwnProperty(o)
                    ? "keyword"
                    : n.hasOwnProperty(o)
                    ...
                    : t.hasOwnProperty(o)
                    ? "support.function"
                    : r.hasOwnProperty(o.toLowerCase())
                    ? "support.constant.color"
                    : s.hasOwnProperty(o.toLowerCase())
                    ? "variable.language"
                    : "text";
                },
                regex: "\\-?[@a-z_][@a-z0-9_\\-]*",
      ...
      r.inherits(s, a), (t.ScssHighlightRules = s);
    }
  ),
  ace.define(
    "ace/mode/scss",
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./scss_highlight_rules").ScssHighlightRules,
        i = e("./matching_brace_outdent").MatchingBraceOutdent,
  ...
  ace.define(
    ...
    function (e, t, n) {
      "use strict";
      var r = e("../lib/oop"),
        o = (e("../lib/lang"), e("./scss_highlight_rules").ScssHighlightRules),
        a = function () {
          o.call(this);
            ...
            (this.$rules.comment = [
              {
                ...
                onMatch: function (e, t, n) {
                  return (
                    -1 === n[1] && (n[1] = Math.max(n[2], e.length - 1)),
                    e.length <= n[1]
                      ? (n.shift(),
                        n.shift(),
                        n.shift(),
      ...
      r.inherits(a, o), (t.SassHighlightRules = a);
    }
  ),
  ace.define(
    "ace/mode/sass",
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./sass_highlight_rules").SassHighlightRules,
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./less_highlight_rules").LessHighlightRules,
        i = e("./matching_brace_outdent").MatchingBraceOutdent,
        s = e("./behaviour/css").CssBehaviour,
        l = e("./css_completions").CssCompletions,
        c = e("./folding/cstyle").FoldMode,
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var i = (t.constantNumericHex = {
          token: "constant.numeric",
          regex: "0[xX][0-9a-fA-F](?:[0-9a-fA-F]|_(?=[0-9a-fA-F]))*\\b",
        }),
        s = (t.constantNumericBinary = {
          token: "constant.numeric",
          regex: /\b(0[bB][01](?:[01]|_(?=[01]))*)\b/,
        }),
        l = (t.constantNumericDecimal = {
          token: "constant.numeric",
          regex: /\b(0[dD](?:[1-9](?:[\d]|_(?=[\d]))*|0))\b/,
        }),
        c = (t.constantNumericDecimal = {
          token: "constant.numeric",
          regex: /\b(0[oO]?(?:[1-7](?:[0-7]|_(?=[0-7]))*|0))\b/,
        }),
        u = (t.constantNumericRational = {
          token: "constant.numeric",
          regex: /\b([\d]+(?:[./][\d]+)?ri?)\b/,
        }),
        g = (t.constantNumericComplex = {
          token: "constant.numeric",
          regex: /\b([\d]i)\b/,
        }),
        d = (t.constantNumericFloat = {
          token: "constant.numeric",
          regex:
            "[+-]?\\d(?:\\d|_(?=\\d))*(?:(?:\\.\\d(?:\\d|_(?=\\d))*)?(?:[eE][+-]?\\d+)?)?i?\\b",
        }),
        h = (t.instanceVariable = {
        ...
        p = function () {
          ...
          (this.$rules = {
            start: [
              ...
              { token: "string.character", regex: "\\B\\?(?:" + t + "|\\S)" },
              { token: "punctuation.operator", regex: /\?(?=.+:)/ },
              u,
              g,
              a,
              ...
              { token: "punctuation.separator.key-value", regex: "=>" },
              {
                ...
                onMatch: function (e, t, n) {
                  ...
                  return (
                    ...
                    [
                      { type: "constant", value: o[1] },
                      { type: "string", value: o[2] },
                      { type: "support.class", value: o[3] },
                      { type: "string", value: o[4] },
                    ]
                  );
                },
                regex: "(<<[-~]?)(['\"`]?)([\\w]+)(['\"`]?)",
            ...
            qStateWithInterpolation: [
              ...
              { token: "paren.start", regex: /#{/, push: "start" },
              {
                ...
                onMatch: function (e, t, r) {
                  return r.length && e === n[r[0]]
                    ? (r.shift(), (this.next = r.shift()), this.token)
                    : ((this.next = ""), "string");
                },
              },
              { defaultToken: "string" },
      ...
      r.inherits(p, o), (t.RubyHighlightRules = p);
    }
  ),
  ace.define(
        ...
        function () {
          (this.indentKeywords = {
            ...
            (this.getFoldWidget = function (e, t, n) {
              var r,
                o = e.getLine(n),
                a = this.foldingStartMarker.test(o),
                i = this.foldingStopMarker.test(o);
              if (a && !i)
                if ((r = o.match(this.foldingStartMarker))[1]) {
                  if (
                    "if" == r[1] ||
                    "else" == r[1] ||
                    "while" == r[1] ||
                    ...
                    if ("else" == r[1] && !1 === /^\s*else\s*$/.test(o)) return;
                    if (!1 === /^\s*(?:if|else|while|until|unless)\s*/.test(o))
                      return;
                  }
                  if ("when" == r[1] && !0 === /\sthen\s/.test(o)) return;
                  if ("keyword" === e.getTokenAt(n, r.index + 2).type)
                    return "start";
                } else {
                  if (!r[3]) return "start";
                  if ("comment.multiline" === e.getTokenAt(n, r.index + 1).type)
                    return "start";
                }
              if ("markbeginend" != t || !i || (a && i)) return "";
              if ("end" === (r = o.match(this.foldingStopMarker))[3]) {
                if ("keyword" === e.getTokenAt(n, r.index + 1).type)
                  return "end";
              } else {
                if (!r[1]) return "end";
                if ("comment.multiline" === e.getTokenAt(n, r.index + 1).type)
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              var r,
                o = e.doc.getLine(n);
              return (r = this.foldingStartMarker.exec(o))
                ? r[1] || r[3]
                  ? this.rubyBlock(e, n, r.index + 2)
                  : this.openingBracketBlock(e, "{", n, r.index)
                : (r = this.foldingStopMarker.exec(o))
                ? ("end" === r[3] &&
                    "keyword" === e.getTokenAt(n, r.index + 1).type) ||
                  ("=end" === r[1] &&
                    "comment.multiline" === e.getTokenAt(n, r.index + 1).type)
                  ? this.rubyBlock(e, n, r.index + 1)
                  : this.closingBracketBlock(e, "}", n, r.index + r[0].length)
                : void 0;
            }),
            (this.rubyBlock = function (e, t, n, r) {
              var o = new i(e, t, n),
                s = o.getCurrentToken();
              if (s && ("keyword" == s.type || "comment.multiline" == s.type)) {
                var l = s.value,
                  c = e.getLine(t);
                switch (s.value) {
                  case "if":
                  ...
                  case "while":
                  case "until":
                    if (!new RegExp("^\\s*" + s.value).test(c)) return;
                    var u = this.indentKeywords[l];
                    break;
                  case "when":
                    if (/\sthen\s/.test(c)) return;
                  case "elsif":
                  case "rescue":
                  case "ensure":
                    u = 1;
                    break;
                  case "else":
                    if (!new RegExp("^\\s*" + s.value + "\\s*$").test(c))
                      return;
                    u = 1;
                    break;
                  default:
                    u = this.indentKeywords[l];
                }
                var g = [l];
                if (u) {
                  var d =
                      -1 === u ? e.getLine(t - 1).length : e.getLine(t).length,
                    h = t,
                    p = [];
                  if (
                    (p.push(o.getCurrentTokenRange()),
                    (o.step = -1 === u ? o.stepBackward : o.stepForward),
                    "comment.multiline" == s.type)
                  ) {
                    for (; (s = o.step()); )
                      if ("comment.multiline" === s.type)
                        if (1 == u) {
                          if (((d = 6), "=end" == s.value)) break;
                        } else if ("=begin" == s.value) break;
                  } else
                    for (; (s = o.step()); ) {
                      var m = !1;
                      if ("keyword" === s.type) {
                        var f = u * this.indentKeywords[s.value];
                        switch (
                          ((c = e.getLine(o.getCurrentTokenRow())), s.value)
                        ) {
                          case "do":
                            for (var x = o.$tokenIndex - 1; x >= 0; x--) {
                              var k = o.$rowTokens[x];
                              if (
                                k &&
                                ("while" == k.value ||
                          ...
                          case "while":
                          case "until":
                            new RegExp("^\\s*" + s.value).test(c) ||
                              ((f = 0), (m = !0));
                            break;
                          case "when":
                            (/\sthen\s/.test(c) || "case" == l) &&
                              ((f = 0), (m = !0));
                        }
                        if (f > 0) g.unshift(s.value);
                        else if (f <= 0 && !1 === m) {
                          if ((g.shift(), !g.length)) {
                            if (
                              ("while" == l || "until" == l || "for" == l) &&
                              "do" != s.value
                            )
                              break;
                            if ("do" == s.value && -1 == u && 0 != f) break;
                            if ("do" != s.value) break;
                          }
                          0 === f && g.unshift(s.value);
                        }
                      }
                    }
                  if (!s) return null;
                  if (r) return p.push(o.getCurrentTokenRange()), p;
                  t = o.getCurrentTokenRow();
                  if (-1 === u) {
                    if ("comment.multiline" === s.type) var b = 6;
                    else b = e.getLine(t).length;
                    return new a(t, b, h - 1, d);
                  }
                  return new a(h, d, t - 1, e.getLine(t - 1).length);
                }
              }
            });
        }.call(s.prototype);
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./ruby_highlight_rules").RubyHighlightRules,
        i = e("./matching_brace_outdent").MatchingBraceOutdent,
        s = e("../range").Range,
        l = e("./folding/ruby").FoldMode,
        c = function () {
          (this.HighlightRules = a),
            (this.$outdent = new i()),
            (this.$behaviour = this.$defaultBehaviour),
        ...
        function () {
          (this.lineCommentStart = "#"),
            (this.getNextLineIndent = function (e, t, n) {
              ...
              if ("start" == e) {
                var a = t.match(/^.*[\{\(\[]\s*$/),
                  i = t.match(/^\s*(class|def|module)\s.*$/),
                  s = t.match(/.*do(\s*|\s+\|.*\|\s*)$/),
                  l = t.match(
            ...
            (this.autoOutdent = function (e, t, n) {
              ...
              i.length <= o.length &&
                o.slice(-l.length) == l &&
                t.remove(new s(n, o.length - l.length, n, o.length));
            }),
            (this.getMatching = function (e, t, n) {
              ...
              if (o && o.value in this.indentKeywords)
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./slim_highlight_rules").SlimHighlightRules,
        i = function () {
          o.call(this),
            (this.HighlightRules = a),
            this.createModeDelegates({
  ...
  ace.require(["ace/mode/slim"], function (e) {
