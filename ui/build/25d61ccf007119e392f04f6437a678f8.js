ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
          ...
          var e = (this.$keywords = this.createKeywordMapper(
              {
                ...
                "storage.modifier": "inline|external|specialize",
                "keyword.operator": "step|width",
      ...
      o.inherits(s, i), (t.sacHighlightRules = s);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var o = e("../lib/oop"),
        r = e("./text").Mode,
        i = e("./sac_highlight_rules").sacHighlightRules,
  ...
  ace.require(["ace/mode/sac"], function (e) {
