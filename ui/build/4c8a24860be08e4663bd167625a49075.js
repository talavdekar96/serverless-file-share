ace.define(
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidget = function (e, t, n) {
              ...
              if (
                ...
                return "";
              var s = this._getFoldWidgetBase(e, t, n);
            ...
            (this.getFoldWidgetRange = function (e, t, n, i) {
              ...
              if ((s = o.match(this.foldingStartMarker))) {
                var r = s.index;
                if (s[1]) return this.openingBracketBlock(e, s[1], n, r);
                var a = e.getCommentFoldRange(n, r + s[0].length, 1);
                return (
                  a &&
                    !a.isMultiLine() &&
                    (i
              ...
              if ("markbegin" !== t && (s = o.match(this.foldingStopMarker))) {
                ...
                return s[1]
                  ? this.closingBracketBlock(e, s[1], n, r)
            ...
            (this.getCommentRegionBlock = function (e, t, n) {
              ...
              if (n > r) return new s(r, i, n, t.length);
            });
        }.call(r.prototype);
    }
  ),
  ace.define(
    ...
    function (e, t, n) {
      ...
      var i = e("../lib/oop"),
        s = e("./text").Mode,
        o = e("./nsis_highlight_rules").NSISHighlightRules,
  ...
  ace.require(["ace/mode/nsis"], function (e) {
