ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
        ...
        i = function () {
          ...
          var e = [
            ...
            t = [
              ...
              { token: "keyword", regex: "page|include|taglib" },
            ];
          for (var n in this.$rules)
            this.$rules[n].unshift.apply(this.$rules[n], e);
          this.embedRules(a, "jsp-", t, ["start"]),
            this.addRules({
              "jsp-dcomment": [
                { token: "comment", regex: ".*?--%>", next: "pop" },
              ],
      ...
      r.inherits(i, o), (t.JspHighlightRules = i);
    }
  ),
  ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./text").Mode,
        a = e("./jsp_highlight_rules").JspHighlightRules,
  ...
  ace.require(["ace/mode/jsp"], function (e) {
