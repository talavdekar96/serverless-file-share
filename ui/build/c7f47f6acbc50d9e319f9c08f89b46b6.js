ace.define(
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      r.inherits(i, a), (t.JavaHighlightRules = i);
    }
  ),
  ace.define(
          ...
          (this.importRegex = /^import /),
            ...
            (this.getFoldWidget = function (e, t, n) {
              if ("markbegin" === t) {
                var r = e.getLine(n);
                if (
                  this.importRegex.test(r) &&
                  (0 == n || !this.importRegex.test(e.getLine(n - 1)))
                )
                  return "start";
              }
            ...
            (this.getFoldWidgetRange = function (e, t, n, r) {
              var o = (g = e.getLine(n)).match(this.importRegex);
              if (!o || "markbegin" !== t)
                return this.getCstyleFoldWidgetRange(e, t, n, r);
              for (
                var i = o[0].length, s = e.getLength(), c = n, l = n;
                ++n < s;

              ) {
                var g;
                if (!(g = e.getLine(n)).match(/^\s*$/)) {
                  if (!g.match(this.importRegex)) break;
                  l = n;
                }
              }
              if (l > c) {
                var u = e.getLine(l).length;
                return new a(c, i, l, u);
              }
            });
        }.call(i.prototype);
    }
  ...
  ace.define(
    ...
    function (e, t, n) {
      ...
      var r = e("../lib/oop"),
        o = e("./javascript").Mode,
        a = e("./java_highlight_rules").JavaHighlightRules,
        i = e("./folding/java").FoldMode,
        s = function () {
          o.call(this),
            (this.HighlightRules = a),
  ...
  ace.require(["ace/mode/java"], function (e) {
