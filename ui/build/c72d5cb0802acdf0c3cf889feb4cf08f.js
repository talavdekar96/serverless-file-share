      ...
      (function () {
        (this.checkOutdent = function (e, t) {
          ...
          (this.autoOutdent = function (e, t) {
            ...
            if (!o) return 0;
            var i = o[1].length,
              n = e.findMatchingBracket({ row: t, column: i });
            if (!n || n.row == t) return 0;
            var a = this.$getIndent(e.getLine(n.row));
    ...
    function (e, t, o) {
      ...
      (function () {
        (this.completionsDefined = !1),
          ...
          (this.getPropertyCompletions = function (e, t, o, i, n) {
            return (
              (n = n || !1),
          ...
          (this.getPropertyValueCompletions = function (e, t, o, i) {
        ...
        a = function () {
          this.inherit(i),
            ...
            this.add("semicolon", "insertion", function (e, t, o, r, i) {
              if (";" === i && o.selection.isEmpty()) {
                var n = o.getCursorPosition();
                if (
                  ";" === r.doc.getLine(n.row).substring(n.column, n.column + 1)
                )
                  return { text: "", selection: [1, 1] };
              }
            }),
            this.add("!important", "insertion", function (e, t, o, r, i) {
              if ("!" === i && o.selection.isEmpty()) {
                var n = o.getCursorPosition(),
                  a = r.doc.getLine(n.row);
                if (/^\s*(;|}|$)/.test(a.substring(n.column)))
          ...
          (this.foldingStartMarker = /([\{\[\(])[^\}\]\)]*$|^\s*(\/\*)/),
            ...
            (this.getFoldWidgetRange = function (e, t, o, r) {
              ...
              if (this.startRegionRe.test(n))
                return this.getCommentRegionBlock(e, n, o);
              if ((i = n.match(this.foldingStartMarker))) {
                var a = i.index;
                if (i[1]) return this.openingBracketBlock(e, i[1], o, a);
                var s = e.getCommentFoldRange(o, a + i[0].length, 1);
                return (
                  s &&
                    !s.isMultiLine() &&
                    (r
              ...
              if ("markbegin" !== t && (i = n.match(this.foldingStopMarker))) {
                a = i.index + i[0].length;
                return i[1]
                  ? this.closingBracketBlock(e, i[1], o, a)
            ...
            (this.getSectionRange = function (e, t) {
              ...
              return new i(n, a, s, e.getLine(s).length);
            }),
            (this.getCommentRegionBlock = function (e, t, o) {
              ...
              if (o > a) return new i(a, r, o, t.length);
            });
        }.call(a.prototype);
    }
  ),
        ...
        function () {
          (this.foldingRules = "cStyle"),
            ...
            (this.getNextLineIndent = function (e, t, o) {
              ...
              return (
                (i.length && "comment" == i[i.length - 1].type) ||
                  (t.match(/^.*\{\s*$/) && (r += o)),
                r
              );
            }),
